...
foreign import pursuitSearchModulesImpl :: forall eff. EffFn2 eff (EffFn1 eff String (Promise (Array ModuleSearchResult))) (EffFn1 eff String Unit) Unit

pursuitSearchModules :: forall eff. (String -> Eff eff (Promise (Array ModuleSearchResult))) -> (String -> Eff eff Unit) -> Eff eff Unit
