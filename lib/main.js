...
(function(exports) {
  ...
  var abbrevType = (function () {
      var r = Data_String_Regex.regex("(?:\\w+\\.)+(\\w+)")((function () {
          var $43 = {};
          for (var $44 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($44)) {
                  $43[$44] = Data_String_Regex.noFlags[$44];
              };
          };
          $43.global = true;
          return $43;
      ...
      return function (modulePrefix) {
          return function (unqualModules) {
              return function (getQualifiedModule) {
                  ...
                  var conv = function (r) {
                      var $45 = Data_Array.head(Prelude.map(Prelude.functorArray)(convCompletion)(r));
                      if ($45 instanceof Data_Maybe.Just) {
                          return abbrevType($45.value0.type);
                      };
                      if ($45 instanceof Data_Maybe.Nothing) {
                          return "";
                      };
                      throw new Error("Failed pattern match at IdePurescript.PscIde line 78, column 14 - line 82, column 1: " + [ $45.constructor.name ]);
                  };
