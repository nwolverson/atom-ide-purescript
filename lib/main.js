...
(function(exports) {
  ...
  exports["executeCommand"] = $foreign.executeCommand;
  exports["onCustom"] = $foreign.onCustom;
})(PS["IdePurescript.Atom.Hooks.LanguageClient"] = PS["IdePurescript.Atom.Hooks.LanguageClient"] || {});
...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      ...
      return function ($20) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function["const"](Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($20));
      };
  })();
  var getActivePosInfo = function __do() {
      ...
      return Control_Bind.bind(Control_Monad_Eff.bindEff)(Atom_Workspace.getActiveTextEditor(v.workspace))(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Maybe.Nothing.value))(function (ed) {
          return function __do() {
              var v1 = IdePurescript_Atom_Editor.getLinePosition(ed)();
  ...
  var caseSplit = function (conn) {
      return Control_Bind.bind(Control_Monad_Eff.bindEff)(getActivePosInfo)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (v) {
          return launchAffAndRaise(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PromptPanel.addPromptPanel("Parameter type")(""))(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (typ) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Uncurried.runEffFn2(IdePurescript_Atom_Hooks_LanguageClient.executeCommand)(conn)({
  ...
  // isRight :: forall a b. Either a b -> b
  // isRight r = ?isRight
  // filenam
  var addClause = function (conn) {
      return Control_Bind.bind(Control_Monad_Eff.bindEff)(getActivePosInfo)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (v) {
          return Control_Monad_Eff_Uncurried.runEffFn2(IdePurescript_Atom_Hooks_LanguageClient.executeCommand)(conn)({
          ...
          return function __do() {
              ...
              var fwdCmd = function (name) {
                  return function (name$prime) {
                      return Atom_CommandRegistry.addCommand(v.commands)("atom-workspace")("ide-purescript:" + name)(Data_Function["const"](Control_Monad_Eff_Uncurried.runEffFn2(IdePurescript_Atom_Hooks_LanguageClient.executeCommand)(conn)({
              ...
              Control_Monad_Eff_Uncurried.runEffFn3(IdePurescript_Atom_Hooks_LanguageClient.onCustom)(conn)("textDocument/diagnosticsBegin")(Control_Monad_Eff_Uncurried.mkEffFn1(function (v2) {
                  return IdePurescript_Atom_BuildStatus.updateBuildStatus(v1)(IdePurescript_Atom_BuildStatus.Building.value);
              }))();
              return Control_Monad_Eff_Uncurried.runEffFn3(IdePurescript_Atom_Hooks_LanguageClient.onCustom)(conn)("textDocument/diagnosticsEnd")(Control_Monad_Eff_Uncurried.mkEffFn1(function (v2) {
