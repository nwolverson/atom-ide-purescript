...
(function(exports) {
  ...
  var encodePursuitType = new Data_Argonaut_Encode.EncodeJson(function ($108) {
      return Data_Argonaut_Encode.encodeJson(Data_Argonaut_Encode.encodeJsonJString)(Prelude.show(showPursuitType)($108));
  });
  ...
  var decodeMessage = new Data_Argonaut_Decode.DecodeJson(function (json) {
      return Data_Maybe.maybe(new Data_Either.Left("Message not string"))(function ($109) {
          return Data_Either.Right.create(Message($109));
