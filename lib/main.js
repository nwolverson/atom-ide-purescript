                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(getToken(v1.value0)(pos)))(function (v2) {
                          if (v2 instanceof Data_Maybe.Just) {
                              ...
                              return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getType(v2.value0.word)(prefix)(IdePurescript_Modules.getUnqualActiveModules(state))(Prelude.flip(IdePurescript_Modules.getQualModule)(state)))(function (v3) {
                                  return Prelude.pure(Control_Monad_Aff.applicativeAff)({
