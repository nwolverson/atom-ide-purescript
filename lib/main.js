...
(function(exports) {
  ...
  var opener = function (s) {
      var $37 = Data_String.indexOf("purescript://psci")(s);
      if ($37 instanceof Data_Maybe.Just && $37.value0 === 0) {
          return function __do() {
  ...
  var openPsci = Control_Monad_Aff.makeAff(function (err) {
      return function (cb) {
          return function __do() {
              ...
              return Atom_Workspace.open(v.workspace)("purescript://psci")((function () {
                  var $45 = {};
                  for (var $46 in Atom_Workspace.defaultOpenOptions) {
                      if (Atom_Workspace.defaultOpenOptions.hasOwnProperty($46)) {
                          $45[$46] = Atom_Workspace.defaultOpenOptions[$46];
                      };
                  };
                  $45.split = "right";
                  $45.activatePane = false;
                  return $45;
  ...
  var clearText = function (v) {
      ...
      return Control_Monad_Eff.whileE(DOM_Node_Node.hasChildNodes(node))(function __do() {
          ...
          return Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($100) {
              return Prelude["void"](Control_Monad_Eff.functorEff)(Prelude.flip(DOM_Node_Node.removeChild)(node)($100));
          })(v1)();
      });
  };
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(function __do() {
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.psciCommand"))))(function (v2) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Atom_LinterBuild.getProjectRoot))(function (v3) {
                              var command = Data_Either.either(Prelude["const"]([  ]))(function ($101) {
                                  return Data_String_Regex.split(Data_String_Regex.regex("\\s+")(Data_String_Regex.noFlags))(Data_String.trim($101));
                              })(v2);
                              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime((function () {
                                  var $67 = Data_Array.uncons(command);
                                  if (v3 instanceof Data_Maybe.Just && $67 instanceof Data_Maybe.Just) {
                                      return Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn($67.value0.head)($67.value0.tail)((function () {
                                          var $68 = {};
                                          for (var $69 in Node_ChildProcess.defaultSpawnOptions) {
                                              if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($69)) {
                                                  $68[$69] = Node_ChildProcess.defaultSpawnOptions[$69];
                                              };
                                          };
                                          $68.cwd = v3;
                                          return $68;
                                  ...
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($102) {
                                      return Control_Monad_Eff_Ref.writeRef(psciRef)(Data_Maybe.Just.create($102));
                                  })(v4)))(function () {
                                      return liftEff$prime$prime(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function (proc) {
                                          return Control_Monad_Eff_Exception.catchException(Prelude["const"](Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit)))(function __do() {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 178, column 5 - line 190, column 3: " + [ v5.constructor.name ]);
                                          });
                                      })(v4));
                                  });
                              });
          ...
          return function (name) {
              return function (action) {
                  var scope = (function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 228, column 23 - line 229, column 3: " + [ isEditor.constructor.name ]);
                  })();
