  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 77, column 3 - line 85, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var addImport = function (moduleName) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 212, column 7 - line 221, column 5: " + [ v7.constructor.name ]);
          };
      };
      ...
      var addExplicitImportCmd = Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v7) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 170, column 7 - line 178, column 5: " + [ v7.constructor.name ]);
      }));
      var addClause = function __do() {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 260, column 7 - line 268, column 5: " + [ v7.constructor.name ]);
      };
