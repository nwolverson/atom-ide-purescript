...
(function(exports) {
  ...
  var getSuggestions = function (v) {
      var suggestionTypeAtomValue = function (s) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 75, column 33 - line 81, column 5: " + [ s.constructor.name ]);
      };
              ...
              return function (v1) {
                  var suggestType = (function () {
                      ...
                      if (!$13) {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 107, column 16 - line 108, column 16: " + [ $14.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 106, column 11 - line 108, column 16: " + [ $13.constructor.name ]);
                  })();
                  return {
                      text: v1.identifier, 
                      ...
                      addImport: new Data_Maybe.Just({
                          ...
                          qualifier: (function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 102, column 55 - line 102, column 107: " + [ $16.constructor.name ]);
                          })()
                      })
                  };
              };
      ...
      if (parsed instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 57, column 7 - line 64, column 5: " + [ moduleCompletion.constructor.name ]);
      };
      if (parsed instanceof Data_Maybe.Nothing) {
          return Prelude["return"](Control_Monad_Aff.applicativeAff)([  ]);
      };
      throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 55, column 6 - line 65, column 3: " + [ parsed.constructor.name ]);
  };
...
(function(exports) {
  ...
  var getModuleName = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Modules line 37, column 1 - line 38, column 1: " + [ v.constructor.name ]);
  };
  ...
  var getUnqualActiveModules = function (v) {
      var isQualified = function (v1) {
          if (v1 instanceof Qualified) {
              return true;
          };
          return false;
      };
      return Prelude.map(Prelude.functorArray)(getModuleName)(Prelude["++"](Prelude.semigroupArray)(Data_Maybe.maybe([  ])(function ($109) {
          return Data_Array.singleton(Implicit.create($109));
      })(v.main))(Data_Array.filter(function ($110) {
          return !isQualified($110);
      })(v.modules)));
  };
  var getMainModule = function (text) {
      var regex = Data_String_Regex.regex("module\\s+([\\w.]+)")((function () {
          var $70 = {};
          for (var $71 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($71)) {
                  $70[$71] = Data_String_Regex.noFlags[$71];
              };
          };
          $70.multiline = true;
          return $70;
      })());
      var $72 = Data_String_Regex.match(regex)(text);
      if ($72 instanceof Data_Maybe.Just && ($72.value0.length === 2 && $72.value0[1] instanceof Data_Maybe.Just)) {
          return new Data_Maybe.Just(($72.value0[1]).value0);
      };
      return Data_Maybe.Nothing.value;
  };
  var getModulesForFile = function (file) {
      return function (fullText) {
          var mod = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Modules line 70, column 3 - line 71, column 3: " + [ v.constructor.name ]);
          };
  ...
  var elem = function (dictEq) {
      return function (x) {
          return function (l) {
              return Prelude["/="](Data_Maybe.eqMaybe(Prelude.eqInt))(Data_Array.elemIndex(dictEq)(x)(l))(Data_Maybe.Nothing.value);
          };
      };
  };
  var addModuleImport = function (state) {
      return function (fileName) {
          return function (text) {
              return function (moduleName) {
                  var shouldAdd = Prelude["/="](Data_Maybe.eqMaybe(Prelude.eqString))(state.main)(new Data_Maybe.Just(moduleName)) && elem(moduleEq)(new Implicit(moduleName))(state.modules);
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Modules line 123, column 3 - line 130, column 3: " + [ shouldAdd.constructor.name ]);
              };
          };
      };
  };
          ...
          return function (text) {
              return function (moduleName) {
                  return function (identifier) {
                      ...
                      var isIdent = Data_String_Regex.test(Data_String_Regex.regex("^[a-z_]\\S*$")(Data_String_Regex.noFlags));
                      var shouldAdd = !isThisModule && (!elem(Prelude.eqString)(identifier)(state.identifiers) && (isIdent(identifier) && Data_Maybe.maybe(true)(function (mn) {
                          return !elem(moduleEq)(new Implicit(mn))(state.modules);
                      })(moduleName)));
                              ...
                              var state$prime = (function () {
                                  if (v instanceof UpdatedImports) {
                                      ...
                                      for (var $107 in state) {
                                          if (state.hasOwnProperty($107)) {
                                              $106[$107] = state[$107];
                                          };
                                      };
                                      $106.identifiers = Data_Array[":"](identifier)(state.identifiers);
                                      return $106;
                                  };
                                  return state;
                              })();
  ...
  var getTooltips = function (state) {
      return function (pos) {
          ...
          return function __do() {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  var v2 = getToken(v1.value0)(pos)();
                  var word = Data_Maybe.maybe("")(function (v3) {
                      return v3.word;
                  })(v2);
                  return Control_Promise.fromAff(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getType(word)("")(IdePurescript_Modules.getUnqualActiveModules(state))(Prelude.flip(IdePurescript_Modules.getQualModule)(state)))(function (v3) {
                      return Prelude.pure(Control_Monad_Aff.applicativeAff)({
...
(function(exports) {
  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 70, column 3 - line 78, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  var getSuggestions = function (state) {
      return function (v) {
          return Control_Promise_1.fromAff((function () {
              var range = Atom_Range.mkRange(Atom_Point.mkPoint(Atom_Point.getRow(v.bufferPosition))(0))(v.bufferPosition);
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getLoadedModules)(function (v2) {
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($94.editor instanceof Data_Maybe.Just && ($94.linter instanceof Data_Maybe.Just && $94.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($94.editor.value0)($94.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      ...
      var doLint = function __do() {
          ...
          if ($116.root instanceof Data_Maybe.Just && ($116.linterIndie instanceof Data_Maybe.Just && $116.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($116.root.value0)($116.linterIndie.value0)($116.statusElt.value0))(function (v10) {
      ...
      var addImport = function (moduleName) {
          return function __do() {
              ...
              if (v7 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v8)(v10)(v9)(moduleName))(function (v11) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($203) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 205, column 7 - line 214, column 5: " + [ v7.constructor.name ]);
          };
      };
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getText(editor)))(function (v7) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getPath(editor)))(function (v8) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v2)))(function (v9) {
                              return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addExplicitImport(v9)(v8)(v7)(moduleName)(ident))(function (v10) {
      ...
      var addExplicitImportCmd = Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v7) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 163, column 7 - line 171, column 5: " + [ v7.constructor.name ]);
      }));
      var addClause = function __do() {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 253, column 7 - line 261, column 5: " + [ v7.constructor.name ]);
      };
          ...
          provideAutocomplete: function (v7) {
              return {
                  ...
                  onDidInsertSuggestion: Data_Function_Eff.mkEffFn1(function (x) {
                      return function __do() {
                          var v8 = Atom_Config.getConfig(v.config)("ide-purescript.importOnAutocomplete")();
