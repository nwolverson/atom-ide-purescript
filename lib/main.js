...
(function(exports) {
  ...
  var moduleRegex = Data_String_Regex.regex("(?:^|[^A-Za-z_.])(?:" + (modulePart + ("\\.)?" + (identPart + "?$"))))(Data_String_Regex_Flags.noFlags);
  ...
  var explicitImportRegex = Data_String_Regex.regex("^import\\s+" + (modulePart + ("\\s+\\([^)]*?" + (identPart + "$"))))(Data_String_Regex_Flags.noFlags);
  var getSuggestions = function (port) {
      return function (v) {
                  ...
                  return function (v1) {
                      var suggestType = (function () {
                          ...
                          if (!$14) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Completion line 88, column 16 - line 89, column 16: " + [ $15.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at IdePurescript.Completion line 87, column 11 - line 89, column 16: " + [ $14.constructor.name ]);
                      })();
          ...
          var parsed = (function () {
              var $19 = IdePurescript_Regex["match'"](moduleRegex)(v.line);
          ...
          if (!moduleExplicit) {
              if (parsed instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Completion line 60, column 9 - line 66, column 52: " + [ moduleCompletion.constructor.name ]);
              };
              if (parsed instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([  ]);
              };
              throw new Error("Failed pattern match at IdePurescript.Completion line 58, column 5 - line 67, column 25: " + [ parsed.constructor.name ]);
          };
          throw new Error("Failed pattern match at IdePurescript.Completion line 51, column 3 - line 67, column 25: " + [ moduleExplicit.constructor.name ]);
      };
  };
          ...
          var include = function (v1) {
              ...
              if (v1.importType instanceof PscIde_Command.Explicit) {
                  return Data_Maybe.maybe(false)(function (v2) {
                      return Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)(v2)(v1.importType.value0);
                  })(ident);
              };
          ...
          return function __do() {
              ...
              if ($18.before instanceof Data_Maybe.Just && ($18.before.value0.length === 1 && ($18.before.value0[0] instanceof Data_Maybe.Just && ($18.after instanceof Data_Maybe.Just && ($18.after.value0.length === 1 && $18.after.value0[0] instanceof Data_Maybe.Just))))) {
                  var qualifier = (function () {
                      var $19 = IdePurescript_Regex["match'"](moduleRegex)(Data_String.take(Data_String.length(v) - Data_String.length(($18.before.value0[0]).value0))(v));
                                          ...
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffM(Control_Monad_Eff_Ref.writeRef(modulesState)(v3.state)))(function () {
                                              return liftEffM((function () {
                                                  ...
                                                  if (v3.result instanceof IdePurescript_Modules.AmbiguousImport) {
                                                      return IdePurescript_Atom_SelectView.selectListViewStatic(view)(addImp)(new Data_Maybe.Just("identifier"))(Data_Functor.map(Data_Functor.functorArray)(runCompletion)(v3.result.value0));
                                                  };
...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      ...
      return function ($109) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function["const"](Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($109));
      };
  })();
                                  ...
                                  if (v3 instanceof Data_Maybe.Just && v3.value0.definedAt instanceof Data_Maybe.Just) {
                                      return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(liftEff$prime$prime(Atom_Workspace.open(v.workspace)(v3.value0.definedAt.value0.name)((function () {
                                          ...
                                          for (var $38 in Atom_Workspace.defaultOpenOptions) {
                                              if ({}.hasOwnProperty.call(Atom_Workspace.defaultOpenOptions, $38)) {
                                                  $37[$38] = Atom_Workspace.defaultOpenOptions[$38];
                                              };
                                          };
                                          $37.initialLine = v3.value0.definedAt.value0.start.line - 1;
                                          $37.initialColumn = v3.value0.definedAt.value0.start.column - 1;
                                          return $37;
                              ...
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(IdePurescript_PscIde.getTypeInfo(port)(v3.word)(v4.main)(v3.qualifier)(IdePurescript_Modules.getUnqualActiveModules(v4)(new Data_Maybe.Just(v3.word)))(Data_Function.flip(IdePurescript_Modules.getQualModule)(v4))))(function (v5) {
                                  if (v5 instanceof Data_Maybe.Just && v5.value0.definedAt instanceof Data_Maybe.Just) {
                                      return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(liftEff$prime$prime(Atom_Workspace.open(v.workspace)(v5.value0.definedAt.value0.name)((function () {
                                          var $56 = {};
                                          for (var $57 in Atom_Workspace.defaultOpenOptions) {
                                              if ({}.hasOwnProperty.call(Atom_Workspace.defaultOpenOptions, $57)) {
                                                  $56[$57] = Atom_Workspace.defaultOpenOptions[$57];
                                              };
                                          };
                                          $56.initialLine = v5.value0.definedAt.value0.start.line - 1;
                                          $56.initialColumn = v5.value0.definedAt.value0.start.column - 1;
                                          return $56;
                                      })())(Data_Function["const"](Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))));
                                  };
                                  return Control_Applicative.pure(Control_Monad_Maybe_Trans.applicativeMaybeT(Control_Monad_Aff.monadAff))(Data_Unit.unit);
...
(function(exports) {
  ...
  var startServer = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_ChildProcess.spawn(v.exe)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (p) {
          ...
          var $12 = {};
          for (var $13 in Node_ChildProcess.defaultSpawnOptions) {
              if ({}.hasOwnProperty.call(Node_ChildProcess.defaultSpawnOptions, $13)) {
                  $12[$13] = Node_ChildProcess.defaultSpawnOptions[$13];
              };
          };
          $12.cwd = v.cwd;
          $12.stdio = v.stdio;
  ...
  var getSavedPort = function (cwd) {
      return function __do() {
          ...
          return Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($44) {
              return Data_Int.fromNumber(Global.readInt(10)($44));
          })(v);
      };
  };
  var findBins$prime = function (v) {
      return function (exe) {
          var getVersion = function (exe2) {
              return Control_Monad_Aff.makeAff(function (err) {
                  return function (succ) {
                      return Node_ChildProcess.execFile(exe2)([ "--version" ])((function () {
                          var $34 = {};
                          for (var $35 in Node_ChildProcess.defaultExecOptions) {
                              if ({}.hasOwnProperty.call(Node_ChildProcess.defaultExecOptions, $35)) {
                                  $34[$35] = Node_ChildProcess.defaultExecOptions[$35];
                              };
                          };
                          $34.env = v.env;
                          return $34;
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Alt.alt(Control_Monad_Aff.altAff)(Node_Which["which'"]({
              path: v.path, 
              pathExt: v.pathExt
          })(exe))(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([  ])))(function (v1) {
              return Data_Traversable["for"](Control_Monad_Aff.applicativeAff)(Data_Traversable.traversableArray)(v1)(function (exe2) {
                  return Data_Functor.map(Control_Monad_Aff.functorAff)(Data_Functor.map(Data_Functor.functorFn)(Executable.create(exe2))(Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)))(Control_Monad_Aff.attempt(getVersion(exe2)));
              });
          });
      };
  }; 
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(IdePurescript_Exec.getPathVar(v.useNpmDir)(v.directory)))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v1)(v.command.value0))(function (v2) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                  var $15 = Data_Array.uncons(v2);
                  if ($15 instanceof Data_Maybe.Just) {
                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn($15.value0.head.value0)(v.command.value1)((function () {
                          var $16 = {};
                          for (var $17 in Node_ChildProcess.defaultSpawnOptions) {
                              if ({}.hasOwnProperty.call(Node_ChildProcess.defaultSpawnOptions, $17)) {
                                  $16[$17] = Node_ChildProcess.defaultSpawnOptions[$17];
                              };
                          };
                          $16.cwd = new Data_Maybe.Just(v.directory);
                          $16.env = new Data_Maybe.Just(Data_StrMap.fromFoldable(Data_List_Types.foldableList)(Data_List.singleton(Data_Tuple.Tuple.create("PATH")(Data_Either.either(Control_Category.id(Control_Category.categoryFn))(Control_Category.id(Control_Category.categoryFn))(v1)))));
                          return $16;
                      })()));
                  };
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Maybe.Nothing.value);
  ...
  var rebuild = function (port) {
      return function (file) {
          ...
          var onResult = function ($56) {
              ...
              })(Data_Bifunctor.bimap(Data_Either.bifunctorEither)(wrapError)(wrapError)($56));
          };
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(rebuild$prime(port)(file))(function (v) {
              return Data_Either.either(function ($57) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error($57));
              })(function ($58) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(onResult($58));
              })(v);
          });
      };
  };
              ...
              return function (succ) {
                  return function __do() {
                      ...
                      if (v1.cp instanceof Data_Maybe.Just) {
                          Node_ChildProcess.onError(v1.cp.value0)(function ($59) {
                              return err(Node_ChildProcess.toStandardError($59));
                          })();
                          ...
                          return Node_ChildProcess.onClose(v1.cp.value0)(function (exit) {
                              if (exit instanceof Node_ChildProcess.Normally && (exit.value0 === 0 || exit.value0 === 1)) {
                                  return function __do() {
                                      ...
                                      var $42 = Data_Functor.map(Data_Maybe.functorMaybe)(IdePurescript_PscErrors.parsePscOutput)(json);
                                      if ($42 instanceof Data_Maybe.Just && $42.value0 instanceof Data_Either.Left) {
                                          return err(Control_Monad_Eff_Exception.error($42.value0.value0))();
                                      };
                                      if ($42 instanceof Data_Maybe.Just && $42.value0 instanceof Data_Either.Right) {
                                          return succ({
                                              errors: $42.value0.value0, 
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.Build line 89, column 13 - line 93, column 11: " + [ $42.constructor.name ]);
                                  };
                              };
...
(function(exports) {
  ...
  var resultToString = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 36, column 1 - line 37, column 1: " + [ v.constructor.name ]);
  };
  ...
  var fixPosition = function (v) {
      if (v.startLine === v.endLine && v.startColumn === v.endColumn) {
          ...
          $16.endColumn = v.endColumn + 1 | 0;
          return $16;
      };
      if (Data_Boolean.otherwise) {
          return v;
      };
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 40, column 1 - line 42, column 20: " + [ v.constructor.name ]);
  };
  var toLintResult = function (res) {
      var range = function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 70, column 3 - line 70, column 21: " + [ v.constructor.name ]);
      };
              ...
              var replace = function (v1) {
                  if (v1 instanceof Data_Maybe.Just) {
                      return {
                          ...
                          hasSuggestion: true, 
                          range: range(Data_Maybe.maybe(Data_Functor.map(Data_Maybe.functorMaybe)(fixPosition)(v.position))(Data_Maybe.Just.create)(v1.value0.replaceRange))
                      };
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 90, column 5 - line 94, column 8: " + [ v1.constructor.name ]);
              };
              return {
                  type: errorType, 
                  text: v.message, 
                  ...
                  range: range(Data_Functor.map(Data_Maybe.functorMaybe)(fixPosition)(v.position)), 
                  multiline: true, 
      ...
      return {
          ...
          result: resultToString((function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 66, column 30 - line 66, column 69: " + [ res.success.constructor.name ]);
          })())
      };
  };
                          ...
                          var status = function (s) {
                              return function (msg) {
                                  return function __do() {
                                      ...
                                      return (function () {
                                          var $9 = Data_Eq.eq(IdePurescript_Atom_BuildStatus.eqBuildStatus)(s)(IdePurescript_Atom_BuildStatus.Failure.value);
                                          if ($9) {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 88, column 8 - line 88, column 43: " + [ $9.constructor.name ]);
                          ...
                          var doBuild = function (buildCmd) {
                              return Control_Monad_Error_Class.catchError(Control_Monad_Aff.monadErrorAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(status(IdePurescript_Atom_BuildStatus.Building.value)(Data_Maybe.Nothing.value)))(function () {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(IdePurescript_Atom_Build.toLintResult)(buildCmd))(function (v) {
                                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(function __do() {
                                          var v1 = Control_Monad_Eff_Class.liftEff(Control_Monad_Eff_Class.monadEffEff)(Atom_Config.getConfig(config)("ide-purescript.censorWarnings"))();
                                          ...
                                          var messages$prime = Data_Array.filter(function ($35) {
                                              return Data_Function.flip(Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString))(codes)((function (v2) {
                                                  return v2.errorCode;
                                              })($35));
                                          })(v.messages);
                                          IdePurescript_Atom_Hooks_Linter.deleteMessages(linter)();
                                          IdePurescript_Atom_Hooks_Linter.setMessages(linter)(messages$prime)();
                                          status((function () {
                                              var $13 = v.result === "success";
                                              if ($13) {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 73, column 19 - line 73, column 66: " + [ $13.constructor.name ]);
                                          })())(Data_Maybe.Nothing.value)();
                                          return messages$prime;
                                      }));
                                  });
                              }))(function (v) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(failure("Error running PureScript build command: " + Data_Show.show(Control_Monad_Eff_Exception.showError)(v))))(function () {
                                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
                                  });
                              });
                          };
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Atom.getAtom))(function (v) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Config.getConfig(config)("ide-purescript.buildCommand")))(function (v1) {
                                  var buildCommand = (function () {
                                      var $19 = Data_String_Regex.regex("\\s+")(Data_String_Regex_Flags.noFlags);
                                      var $20 = Control_Monad_Except.runExcept(Data_Foreign.readString(v1));
                                      if ($19 instanceof Data_Either.Right && $20 instanceof Data_Either.Right) {
                                          return Data_String_Regex.split($19.value0)(Data_String.trim($20.value0));
                                      };
                                      return [  ];
                                  })();
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(IdePurescript_Atom_Config.getFastRebuild))(function (v2) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function () {
                                          var $30 = Data_Array.uncons(buildCommand);
                                          ...
                                          if ($30 instanceof Data_Maybe.Just) {
                                              return doBuild(IdePurescript_Atom_Build.linterBuild({
                                                  command: $30.value0.head, 
                                                  args: $30.value0.tail, 
                                                  directory: projdir
                                              }));
                                          };
                                          if ($30 instanceof Data_Maybe.Nothing) {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(failure("Error parsing PureScript build command")))(function () {
                                                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
                                              });
                                          };
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 54, column 3 - line 59, column 20: " + [ fastBuild.constructor.name, $30.constructor.name ]);
                                      });
                                  });
                              });
                          });
...
(function(exports) {
  ...
  var opener = function (s) {
      var $58 = Data_String.indexOf(paneUri)(s);
      if ($58 instanceof Data_Maybe.Just && $58.value0 === 0) {
          return function __do() {
      ...
      return function (cb) {
          return function __do() {
              ...
              return Atom_Workspace.open(v.workspace)(paneUri)((function () {
                  var $66 = {};
                  for (var $67 in Atom_Workspace.defaultOpenOptions) {
                      if ({}.hasOwnProperty.call(Atom_Workspace.defaultOpenOptions, $67)) {
                          $66[$67] = Atom_Workspace.defaultOpenOptions[$67];
                      };
                  };
                  $66.split = "right";
                  $66.activatePane = false;
                  return $66;
  ...
  var replaceAnsiColor = function (text) {
      ...
      var colorCss = function (n) {
          return "color: " + Data_Maybe.maybe("black")(function ($145) {
              return renderRgbCss(xtermColor($145));
          })(colorForCode(n));
      };
      var colEscape = function (str) {
          var $70 = IdePurescript_Regex["match'"](Data_String_Regex.regex("\\x1b\\[([0-9]+)m")(Data_String_Regex_Flags.noFlags))(str);
          if ($70 instanceof Data_Maybe.Just && ($70.value0.length === 2 && $70.value0[1] instanceof Data_Maybe.Just)) {
              return Data_Int.fromNumber(Global.readInt(10)(($70.value0[1]).value0));
          };
          return Data_Maybe.Nothing.value;
      };
      var toNodes = function (v) {
          ...
          if (Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(2)))(new Data_Maybe.Just(0)) && Data_Maybe.isJust(Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(0)))) {
              var $76 = Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(0));
              var $77 = Data_Array.index(v)(1);
              if ($76 instanceof Data_Maybe.Just && $77 instanceof Data_Maybe.Just) {
                  return function __do() {
                      var v1 = createElement$prime("span")();
                      DOM_Node_Node.setTextContent($77.value0)(DOM_Node_Types.elementToNode(v1))();
                      DOM_Node_Element.setAttribute("style")(colorCss($76.value0))(v1)();
  ...
  var clearText = function (v) {
      ...
      return Control_Monad_Eff.whileE(DOM_Node_Node.hasChildNodes(node))(function __do() {
          ...
          return Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($146) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Function.flip(DOM_Node_Node.removeChild)(node)($146));
          })(v1)();
      });
  };
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(function __do() {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Functor.map(Data_Functor.functorFn)(Control_Monad_Except.runExcept)(Data_Foreign.readString))(Atom_Config.getConfig(v.config)("ide-purescript.psciCommand"))))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(getProjectRoot))(function (v3) {
                              var command = (function () {
                                  var $104 = Data_String_Regex.regex("\\s+")(Data_String_Regex_Flags.noFlags);
                                  if (v2 instanceof Data_Either.Right && $104 instanceof Data_Either.Right) {
                                      return Data_String_Regex.split($104.value0)(v2.value0);
                                  };
                                  return [  ];
                              })();
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime((function () {
                                  var $108 = Data_Array.uncons(command);
                                  if (v3 instanceof Data_Maybe.Just && $108 instanceof Data_Maybe.Just) {
                                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn($108.value0.head)($108.value0.tail)((function () {
                                          var $109 = {};
                                          for (var $110 in Node_ChildProcess.defaultSpawnOptions) {
                                              if ({}.hasOwnProperty.call(Node_ChildProcess.defaultSpawnOptions, $110)) {
                                                  $109[$110] = Node_ChildProcess.defaultSpawnOptions[$110];
                                              };
                                          };
                                          $109.cwd = v3;
                                          return $109;
                                  ...
                                  if ($108 instanceof Data_Maybe.Nothing) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 272, column 30 - line 276, column 91: " + [ v3.constructor.name, $108.constructor.name ]);
                              })()))(function (v4) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($147) {
                                      return Control_Monad_Eff_Ref.writeRef(psciRef)(Data_Maybe.Just.create($147));
                                  })(v4)))(function () {
                                      return liftEff$prime$prime(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (proc) {
                                          return Control_Monad_Eff_Exception.catchException(function (e) {
                                              ...
                                              Node_ChildProcess.onError(proc)(function ($148) {
                                                  return notifyErr(Data_Show.show(Control_Monad_Eff_Exception.showError)(Node_ChildProcess.toStandardError($148)));
                                              })();
...
(function(exports) {
  ...
  var parseVersion = function (s) {
      var $23 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Int.fromNumber)(Data_Functor.map(Data_Functor.functorArray)(Global.readInt(10))(Data_String.split(".")(s)));
      if ($23 instanceof Data_Maybe.Just && $23.value0.length === 3) {
          return Data_Maybe.Just.create(new Version($23.value0[0], $23.value0[1], $23.value0[2]));
      };
      return Data_Maybe.Nothing.value;
  };
  var liftEff$prime$prime = Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff);
              ...
              var launchServer = (function () {
                  var r = function (v) {
                      return function (v1) {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 134, column 7 - line 134, column 52: " + [ v.constructor.name, v1.constructor.name ]);
                      };
                  };
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(PscIde_Server.pickFreshPort))(function (v) {
              ...
              var gotPath = function (port) {
                  return function (workingDir) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 139, column 15 - line 146, column 43: " + [ $36.constructor.name ]);
                      })());
                  };
              };
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(PscIde_Server.getSavedPort(rootPath)))(function (v) {
                  if (v instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(IdePurescript_PscIde.cwd(v.value0)))(function (v1) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Control_Monad_Eff_Console.log("Found existing port from file: " + (Data_Show.show(Data_Show.showInt)(v.value0) + Data_Either.either(Data_Function["const"](""))(function (v2) {
                              return ", cwd: " + v2;
                          })(v1)))))(function () {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 119, column 3 - line 124, column 28: " + [ v.constructor.name ]);
              });
          };
      };
  };
  ...
  var startServer$prime = function (path) {
      return function (server) {
          return function (addNpmBin) {
              return function (glob) {
                  return function (cb) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Exec.getPathVar(addNpmBin)(path)))(function (v) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v)(server))(function (v1) {
                              var $59 = Data_Array.head(v1);
                              if ($59 instanceof Data_Maybe.Nothing) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(cb(Info.value)("Couldn't find psc-ide-server, check PATH. Looked for: " + (server + (" in PATH: " + Data_Either.either(Control_Category.id(Control_Category.categoryFn))(Control_Category.id(Control_Category.categoryFn))(v))))))(function () {
                                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)({
                              ...
                              if ($59 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Resolved psc-ide-server paths (1st is used):")))(function () {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v2) {
                                          ...
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v1) > 1)(cb(Warning.value)("Found multiple psc-ide-server executables; using " + $59.value0.value0))))(function () {
                                              var glob$prime = (function () {
                                                  var $63 = Data_Ord.greaterThanOrEq(Data_Maybe.ordMaybe(ordVersion))(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(parseVersion)(Data_String.trim))($59.value0.value1)))(new Data_Maybe.Just(new Version(0, 9, 2)));
                                                  if ($63) {
                                                      return glob;
                                                  };
                                                  if (!$63) {
                                                  ...
                                                  throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 94, column 19 - line 94, column 104: " + [ $63.constructor.name ]);
                                              })();
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer($59.value0.value0)(path)(glob$prime))(function (v2) {
                                                  var noRes = {
                                                      quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                                      port: Data_Maybe.Nothing.value
                                                  };
                                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 97, column 17 - line 110, column 142: " + [ v2.constructor.name ]);
                                                  })());
                                              });
                                          });
                                      });
                              ...
                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 84, column 3 - line 110, column 142: " + [ $59.constructor.name ]);
                          });
                      });
                  };
              };
...
(function(exports) {
  ...
  var notify = function (notifications) {
      return function (level) {
          if (level instanceof IdePurescript_PscIdeServer.Success) {
              return Atom_NotificationManager.addSuccess(notifications);
          };
          if (level instanceof IdePurescript_PscIdeServer.Info) {
              return Atom_NotificationManager.addInfo(notifications);
          };
          if (level instanceof IdePurescript_PscIdeServer.Warning) {
              return Atom_NotificationManager.addWarning(notifications);
          };
          if (level instanceof IdePurescript_PscIdeServer["Error"]) {
              return Atom_NotificationManager.addError(notifications);
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 42, column 30 - line 46, column 36: " + [ level.constructor.name ]);
      };
  };
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readArray)(Atom_Config.getConfig(v.config)("ide-purescript.pscSourceGlob"))))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readBoolean)(Atom_Config.getConfig(v.config)("ide-purescript.addNpmPath"))))(function (v3) {
                      var srcGlob$prime = Data_Bifunctor.rmap(Data_Either.bifunctorEither)(Data_Array.mapMaybe(function ($9) {
                          return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Control_Monad_Except.runExcept(Data_Foreign.readString($9)));
                      ...
                      return IdePurescript_PscIdeServer["startServer'"](path)(server)(addNpmPath$prime)(glob)(notify(v.notifications));
                  });
              });
          });
      });
              ...
              return function (linterMain) {
                  return function (messages) {
                          ...
                          return function (v1) {
                              if (v1.suggestion.hasSuggestion) {
                                  var getFix$prime = function (range1) {
                                      return new Data_Maybe.Just({
                                          title: IdePurescript_QuickFix.getTitle(v1.errorCode), 
                                          action: (function () {
                                              var trailingNewline = IdePurescript_Regex["test'"](Data_String_Regex.regex("\x0a\\s+$")(Data_String_Regex_Flags.noFlags))(v1.suggestion.replacement);
                                              return function __do() {
                                                  var v2 = Atom_Editor.getTextInRange(editor)(Atom_Range.mkRange(Atom_Range.getEnd(range1))(Atom_Point.mkPoint(Atom_Point.getRow(Atom_Range.getEnd(range1)))(10 + Atom_Point.getColumn(Atom_Range.getEnd(range1)) | 0)))();
                                                  var addNewline = trailingNewline && !Data_String["null"](v2);
                                                  var replacement$prime = Data_String.trim(IdePurescript_Regex["replace'"](Data_String_Regex.regex("\\s+\x0a")(Data_String_Regex_Flags.global))("\x0a")(v1.suggestion.replacement));
                                                  Atom_Editor.setTextInBufferRange(editor)(range1)(replacement$prime + (function () {
                                                      if (addNewline) {
                                                          return "\x0a";
                                                      };
                                                      if (!addNewline) {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.QuickFixes line 79, column 66 - line 79, column 97: " + [ addNewline.constructor.name ]);
                                                  })())();
                                  ...
                                  return function __do() {
                                      ...
                                      var markerRow = Data_Maybe.maybe(0)(function ($40) {
                                          return Atom_Point.getRow(Atom_Range.getStart($40));
                                      })(v2);
                              ...
                              if (IdePurescript_QuickFix.isUnknownToken(v1.errorCode)) {
                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Data_Maybe.Just({
                                      title: "Fix typo", 
                      ...
                      return function __do() {
                          ...
                          IdePurescript_Atom_SelectView.selectListViewStaticInline(view)(applyFix)(new Data_Maybe.Just("title"))(v4)();
                          return Data_Unit.unit;
                      };
                  };
              };
...
(function(exports) {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Atom.getAtom))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  var $78 = v.activatedManually || autoCompleteAllModules;
                                  if ($78) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 75, column 14 - line 75, column 136: " + [ $78.constructor.name ]);
                              })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var v7 = Control_Monad_Eff_Ref.newRef(Data_StrMap.empty)();
      var v8 = Control_Monad_Eff_Ref.newRef(Data_Maybe.Nothing.value)();
      var getVar = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v8)))(Data_Maybe.maybe(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar["makeVar'"](Data_Unit.unit))(function (v9) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.writeRef(v8)(new Data_Maybe.Just(v9))))(function () {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v9);
          });
      }))(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)));
      var getPort = function (file) {
          return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(Control_Monad_Eff_Ref.readRef(v7)))(function (v9) {
              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(PscIde_Project.getRoot(file)))(function (v10) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_StrMap.lookup(v10)(v9))))(function (v11) {
      ...
      var getPathActiveEditor = Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v9) {
          return Control_Monad_Maybe_Trans.MaybeT(Atom_Editor.getPath(v9));
      });
      var getPortActiveEditor = Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function (v9) {
          return Data_Functor.map(Control_Monad_Maybe_Trans.functorMaybeT(Control_Monad_Eff.functorEff))(function (v10) {
              return v10.port;
          })(Control_Monad_Maybe_Trans.MaybeT(getPort(v9)));
      }));
      var startPscIdeServer$prime = function (path) {
          var retry = function (a) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(a))(function (v9) {
                  if (v9 instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v9.value0);
                  };
                  if (v9 instanceof Data_Either.Left) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Retrying starting server after 500ms: " + Data_Show.show(Control_Monad_Eff_Exception.showError)(v9.value0))))(function () {
                          return Control_Monad_Aff["later'"](500)(a);
                      });
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 221, column 11 - line 225, column 27: " + [ v9.constructor.name ]);
              });
          };
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(getVar)(function (v9) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.takeVar(v9))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(PscIde_Project.getRoot(path)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                          if (v10 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
                          };
                          if (v10 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v7)))(function (v11) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.when(Control_Monad_Aff.applicativeAff)(Data_Maybe.isJust(Data_StrMap.lookup(v10.value0)(v11)))(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Not starting server - already started: " + path))))(function () {
                                      return Control_Applicative.unless(Control_Monad_Aff.applicativeAff)(Data_Maybe.isJust(Data_StrMap.lookup(v10.value0)(v11)))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer(v10.value0))(function (v12) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Loading modules: " + path)))(function () {
                                              return retry(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                                                  ...
                                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                      var v13 = Atom_Workspace.getActiveTextEditor(v.workspace)();
                                                      useEditor$prime(v2)(v12.port)(v13)();
                                                      IdePurescript_Atom_Tooltips.registerTooltips(getPortActiveEditor)(v2)();
                                                      if (v12.port instanceof Data_Maybe.Nothing) {
                                                          return Data_Unit.unit;
                                                      };
                                                      if (v12.port instanceof Data_Maybe.Just) {
                                                          return Control_Monad_Eff_Ref.modifyRef(v7)(Data_StrMap.insert(v10.value0)({
                                                              port: v12.port.value0, 
                                                              quit: v12.quit
                                                          }))();
                                                      };
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.Main line 212, column 17 - line 214, column 95: " + [ v12.port.constructor.name ]);
                                                  });
                                              }));
                                          });
                                      }));
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 198, column 7 - line 214, column 95: " + [ v10.constructor.name ]);
                      })())(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Finished initialising server: " + path)))(function () {
                              return Control_Monad_Aff_AVar.putVar(v9)(Data_Unit.unit);
                          });
                      });
                  });
              });
      ...
      var quickFix = function __do() {
          var v9 = Control_Monad_Eff_Ref.readRef(v3)();
          var v10 = Atom_Workspace.getActiveTextEditor(v.workspace)();
          var v11 = Control_Monad_Eff_Ref.readRef(v4)();
          var $117 = {
              editor: v10, 
              linter: v11, 
              n: Data_Array.length(v9)
          };
          if ($117.editor instanceof Data_Maybe.Just && ($117.linter instanceof Data_Maybe.Just && $117.n > 0)) {
              return withPort(function (port) {
                  return IdePurescript_Atom_QuickFixes.showQuickFixes(port)(v2)($117.editor.value0)($117.linter.value0)(v9);
              })();
          };
          return Data_Unit.unit;
      };
      ...
      var startPscIdeServer = Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function (v9) {
          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(Control_Monad_Eff_Console.log("Starting psc-ide-server for path: " + v9)))(function () {
              ...
              })(ignoreError)(startPscIdeServer$prime(v9))));
          });
      })));
      var doLint = function (file) {
          return function __do() {
              var v9 = Control_Monad_Eff_Ref.readRef(v1)();
              var v10 = Control_Monad_Eff_Ref.readRef(v5)();
              var v11 = Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Maybe.Nothing.value))(getPort)(file)();
              var v12 = (function () {
                  if (v11 instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Data_Maybe.Just(v11.value0.root));
                  };
                  if (v11 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function ($163) {
                          return Control_Monad_Maybe_Trans.MaybeT(PscIde_Project.getRoot($163));
                      }));
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 150, column 16 - line 152, column 74: " + [ v11.constructor.name ]);
              })()();
              if (v12 instanceof Data_Maybe.Just && (v9 instanceof Data_Maybe.Just && v10 instanceof Data_Maybe.Just)) {
                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(ignoreError)(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(Data_Functor.map(Data_Maybe.functorMaybe)(function (v13) {
                      return v13.port;
                  })(v11))(file)(v.config)(v12.value0)(v9.value0)(v10.value0))(function (v13) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(Control_Monad_Eff_Ref.writeRef(v3))(v13)))(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v14) {
                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(useEditor$prime(v2)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v15) {
                                  return v15.port;
                              })(v11))(v14));
                          });
                      });
      ...
      var deactivate = function __do() {
          ...
          Data_Traversable.sequence(Data_List_Types.traversableList)(Control_Monad_Eff.applicativeEff)(Data_Functor.map(Data_List_Types.functorList)(function (v10) {
              return v10.quit;
          })(Data_StrMap.values(v9)))();
          return Control_Monad_Eff_Ref.writeRef(v7)(Data_StrMap.empty)();
      };
      ...
      var activate = function __do() {
          ...
          Atom_Workspace.observeTextEditors(v.workspace)(function (editor) {
              return function __do() {
                  var v9 = Atom_Editor.getPath(editor)();
                  if (v9 instanceof Data_Maybe.Just && Data_String.contains(".purs")(v9.value0)) {
                      return Atom_Editor.onDidSave(editor)(function (v10) {
                          return function __do() {
                              var v11 = Atom_Config.getConfig(v.config)("ide-purescript.buildOnSave")();
                              var buildOnSaveEnabled = Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn))(Control_Monad_Except.runExcept(Data_Foreign.readBoolean(v11)));
                              return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(buildOnSaveEnabled)(doLint(v9))();
                          };
                      })();
                  };
                  return Data_Unit.unit;
          ...
          Atom_Workspace.onDidChangeActivePaneItem(v.workspace)(function (item) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Atom_Editor.toEditor(item))))(function (v9) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Atom_Editor.getPath(v9)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(getPort(v10)))(function (v11) {
                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))((function () {
                              if (v11 instanceof Data_Maybe.Just) {
                                  return function __do() {
                                      Control_Monad_Eff_Console.log("Switching to editor for file: " + v10)();
                                      return useEditor$prime(v2)(new Data_Maybe.Just(v11.value0.port))(Atom_Editor.toEditor(item))();
                                  };
                              };
                              if (v11 instanceof Data_Maybe.Nothing) {
                                  return startPscIdeServer;
                              };
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 282, column 19 - line 286, column 39: " + [ v11.constructor.name ]);
                          })());
                      });
                  });
              })));
          ...
          startPscIdeServer();
          IdePurescript_Atom_Psci.activate();
          return Control_Monad_Eff_Ref.writeRef(v6)(true)();
      };
      return Data_Foreign.toForeign({
          config: IdePurescript_Atom_Config.config, 
          activate: Data_Function_Eff.mkEffFn1(function (v9) {
              return activate;
          }), 
          deactivate: Data_Function_Eff.mkEffFn1(function (v9) {
              return deactivate;
          }), 
          consumeLinterIndie: Data_Function_Eff.mkEffFn1(function (registry) {
              return function __do() {
                  var v9 = IdePurescript_Atom_Hooks_Linter.register(registry)({
                      name: "PureScript"
                  })();
                  return Control_Monad_Eff_Ref.writeRef(v1)(new Data_Maybe.Just(v9))();
              };
          }), 
          ...
          consumeStatusBar: Data_Function_Eff.mkEffFn1(function (statusBar) {
              return function __do() {
                  var v9 = IdePurescript_Atom_BuildStatus.getBuildStatus();
                  Control_Monad_Eff_Ref.writeRef(v5)(new Data_Maybe.Just(v9))();
          ...
          provideAutocomplete: Data_Function_Eff.mkEffFn1(function (v9) {
              return function __do() {
                  var v10 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Either.either(Data_Function["const"](true))(Control_Category.id(Control_Category.categoryFn)))(Control_Monad_Except.runExcept))(Data_Foreign.readBoolean))(Atom_Config.getConfig(v.config)("ide-purescript.autocomplete.excludeLowerPriority"))();
                  return {
                      selector: ".source.purescript", 
                      disableForSelector: ".source.purescript .comment, .source.purescript .string", 
                      inclusionPriority: 1, 
                      excludeLowerPriority: v10, 
                      getSuggestions: Data_Function_Eff.mkEffFn1(function (x) {
                          return function __do() {
                              var v11 = Control_Monad_Eff_Ref.readRef(v2)();
                              return withPortDef(Control_Promise.fromAff(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([  ])))(function (p) {
                                  return getSuggestions(p)(v11)(x);
                              })();
                          };
                      }), 
                      onDidInsertSuggestion: Data_Function_Eff.mkEffFn1(function (x) {
                          return function __do() {
                              var v11 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(Control_Monad_Except.runExcept))(Data_Foreign.readBoolean))(Atom_Config.getConfig(v.config)("ide-purescript.autocomplete.addImport"))();
                              return withPort(function (port) {
                                  return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v11)(Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(ignoreError)(IdePurescript_Atom_Imports.addSuggestionImport(port)(v2)(x))));
                              })();
                          };
                      })
                  };
          ...
          provideHyperclick: function (v9) {
              return {
                  getSuggestion: Data_Function_Eff.mkEffFn2(function (editor) {
                      return function (pos) {
                          return function __do() {
                              var v10 = IdePurescript_Atom_Tooltips.getToken(editor)(pos)();
                              return Data_Nullable.toNullable((function (v11) {
                                  return Data_Functor.map(Data_Maybe.functorMaybe)(v11)(v10);
                              })(function (v11) {
                                  return {
                                      range: v11.range, 
