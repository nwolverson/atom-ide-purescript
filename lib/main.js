...
(function(exports) {
  ...
  var resultToString = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 57, column 1 - line 58, column 1: " + [ v.constructor.name ]);
  };
  ...
  var fixPosition = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 61, column 1 - line 63, column 20: " + [ v.constructor.name ]);
  };
              ...
              return function (port) {
                  return function (res) {
                      var range = function (v) {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 91, column 3 - line 91, column 54: " + [ v.constructor.name ]);
                      };
                      var result = function (errorType) {
                          return function (v) {
                              var fixes = function (v1) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 114, column 5 - line 114, column 137: " + [ v1.constructor.name ]);
                              };
                              ...
                              return function __do() {
                                  ...
                                  var editor$prime = (function () {
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 98, column 19 - line 98, column 60: " + [ v1.constructor.name ]);
                                  })();
                                  ...
                                  return {
                                      ...
                                      icon: Data_Nullable.toNullable((function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 110, column 28 - line 111, column 7: " + [ $53.constructor.name ]);
                                      })()), 
                                      solutions: solutions
                                  };
                              };
                      ...
                      return function __do() {
                          ...
                          return {
                              ...
                              result: resultToString((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 87, column 30 - line 87, column 69: " + [ res.success.constructor.name ]);
                              })())
                          };
                      };
                  };
