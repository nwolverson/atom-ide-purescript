...
(function(exports) {
  ...
  var encodePursuitType = new Data_Argonaut_Encode_Class.EncodeJson(function ($131) {
      return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Show.show(showPursuitType)($131));
  });
  ...
  var decodeMessage = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left("Message not string"))(function ($132) {
          return Data_Either.Right.create(Message($132));
