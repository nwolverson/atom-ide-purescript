...
(function(exports) {
  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 64, column 3 - line 72, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($51.editor instanceof Data_Maybe.Just && ($51.linter instanceof Data_Maybe.Just && $51.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($51.editor.value0)($51.linter.value0)(v6)();
          };
          return Prelude.unit;
      };
      var pursuitSearch = IdePurescript_Atom_Pursuit.pursuitSearch(function ($79) {
          return Control_Promise_1.fromAff(IdePurescript_PscIde.getPursuitCompletion($79));
      });
      var doLint = function __do() {
          ...
          if ($59.root instanceof Data_Maybe.Just && $59.linterIndie instanceof Data_Maybe.Just) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($59.root.value0)($59.linterIndie.value0))(function (v8) {
      ...
      var addImport = function (moduleName) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 126, column 7 - line 134, column 5: " + [ v6.constructor.name ]);
          };
      };
      ...
      var pursuitSearchModule = IdePurescript_Atom_Pursuit.pursuitSearchModules(function ($80) {
          return Control_Promise_1.fromAff(IdePurescript_PscIde.getPursuitModuleCompletion($80));
      })(addImport);
