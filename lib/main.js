...
(function(exports) {
  ...
  var applicativeParAff = applicativeAff;
...
(function(exports) {
  ...
  var moduleFilterModules = function (modulePrefix) {
      return function (unqualModules) {
          return function (getQualifiedModule) {
              var $14 = Data_String["null"](modulePrefix);
              if ($14) {
                  return unqualModules;
              };
              if (!$14) {
                  return getQualifiedModule(modulePrefix);
              };
              throw new Error("Failed pattern match at IdePurescript.PscIde line 61, column 3 - line 64, column 36: " + [ $14.constructor.name ]);
          };
      };
  };
  var eitherToErr = function (c) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(c)(function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.PscIde line 26, column 3 - line 28, column 26: " + [ v.constructor.name ]);
      });
  };
                          ...
                          return function (unqualModules) {
                              return function (getQualifiedModule) {
                                  var moduleFilters = (function () {
                                      ...
                                      if (!moduleCompletion) {
                                          return [ PscIde_Command.ModuleFilter.create(moduleFilterModules(modulePrefix)(unqualModules)(getQualifiedModule)) ];
                                      };
                                      throw new Error("Failed pattern match at IdePurescript.PscIde line 98, column 19 - line 98, column 138: " + [ moduleCompletion.constructor.name ]);
                                  })();
      ...
      return function (text) {
          return function (currentModule) {
              return function (modulePrefix) {
                  return function (unqualModules) {
                      return function (getQualifiedModule) {
                          var moduleFilters = [ PscIde_Command.ModuleFilter.create(moduleFilterModules(modulePrefix)(unqualModules)(getQualifiedModule)) ];
  ...
  var getSuggestions = function (port) {
      return function (v) {
          var suggestionTypeAtomValue = function (s) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 96, column 33 - line 102, column 5: " + [ s.constructor.name ]);
          };
          var result = function (qualifier) {
              return function (prefix) {
                  return function (v1) {
                      var suggestType = (function () {
                          var $15 = Data_String.contains("->")(v1["type'"]);
                          if ($15) {
                              return $$Function.value;
                          };
                          if (!$15) {
                              var $16 = IdePurescript_Regex["test'"](Data_String_Regex.regex("^[A-Z]")(Data_String_Regex_Flags.noFlags))(v1.identifier);
                              if ($16) {
                                  return Type.value;
                              };
                              if (!$16) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 133, column 16 - line 134, column 16: " + [ $16.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 132, column 11 - line 134, column 16: " + [ $15.constructor.name ]);
                      })();
                      return {
                          ...
                          addImport: new Data_Maybe.Just({
                              ...
                              qualifier: (function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 128, column 55 - line 128, column 106: " + [ $18.constructor.name ]);
                              })()
                          })
                      };
                  };
          ...
          var parsed = (function () {
              var matchRegex = (function () {
                  if (moduleExplicit) {
                      return explicitImportRegex;
                  };
                  if (!moduleExplicit) {
                      return moduleRegex;
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 94, column 22 - line 94, column 81: " + [ moduleExplicit.constructor.name ]);
              })();
              var $23 = IdePurescript_Regex["match'"](matchRegex)(v.line);
              if ($23 instanceof Data_Maybe.Just && ($23.value0.length === 3 && ($23.value0[0] instanceof Data_Maybe.Just && (Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqString))($23.value0[1])(Data_Maybe.Nothing.value) || Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqString))($23.value0[2])(Data_Maybe.Nothing.value))))) {
                  return new Data_Maybe.Just({
                      mod: Data_Maybe.fromMaybe("")($23.value0[1]), 
                      token: Data_Maybe.fromMaybe("")($23.value0[2])
                  });
              };
              return Data_Maybe.Nothing.value;
          })();
          ...
          if (parsed instanceof Data_Maybe.Just) {
              ...
              if (!moduleCompletion) {
                  if (moduleExplicit) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getCompletion(port)(parsed.value0.token)(v.moduleInfo.mainModule)("")(moduleCompletion)([ parsed.value0.mod ])(v.moduleInfo.getQualifiedModule))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 72, column 12 - line 77, column 50: " + [ moduleExplicit.constructor.name ]);
              };
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 68, column 7 - line 77, column 50: " + [ moduleCompletion.constructor.name ]);
          };
          if (parsed instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([  ]);
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 66, column 3 - line 78, column 23: " + [ parsed.constructor.name ]);
      };
  };
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(getToken(v1.value0)(pos)))(function (v2) {
                              if (v2 instanceof Data_Maybe.Just) {
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getType(port)(v2.value0.word)(state.main)(prefix)(IdePurescript_Modules.getUnqualActiveModules(state)(new Data_Maybe.Just(v2.value0.word)))(Data_Function.flip(IdePurescript_Modules.getQualModule)(state)))(function (v3) {
                                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)((function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.Tooltips line 78, column 18 - line 78, column 60: " + [ $36.constructor.name ]);
                                      })());
                                  });
                              };
                              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
          ...
          return IdePurescript_Atom_Util.launchAffAndRaise(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Atom.getAtom))(function (v) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(modulesState)))(function (v2) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Tooltips line 93, column 3 - line 98, column 21: " + [ v1.constructor.name ]);
                  });
              });
          }));
      };
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(liftEff$prime$prime(IdePurescript_Atom_Editor.getLinePosition(v1))))(function (v2) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Maybe_Trans.MaybeT(liftEff$prime$prime(IdePurescript_Atom_Tooltips.getToken(v1)(v2.pos))))(function (v3) {
                          ...
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(liftEff$prime$prime(Control_Monad_Eff_Ref.readRef(modulesState))))(function (v4) {
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(IdePurescript_PscIde.getTypeInfo(port)(v3.word)(v4.main)(prefix)(IdePurescript_Modules.getUnqualActiveModules(v4)(new Data_Maybe.Just(v3.word)))(Data_Function.flip(IdePurescript_Modules.getQualModule)(v4))))(function (v5) {
                                  if (v5 instanceof Data_Maybe.Just && v5.value0.definedAt instanceof Data_Maybe.Just) {
                                      return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(liftEff$prime$prime(Atom_Workspace.open(v.workspace)(v5.value0.definedAt.value0.name)((function () {
                                          ...
                                          for (var $57 in Atom_Workspace.defaultOpenOptions) {
                                              if (Atom_Workspace.defaultOpenOptions.hasOwnProperty($57)) {
                          ...
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Maybe_Trans.MaybeT(liftEff$prime$prime(IdePurescript_Atom_Tooltips.getToken(v1)(v2.pos))))(function (v3) {
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(liftEff$prime$prime(Control_Monad_Eff_Ref.readRef(modulesState))))(function (v4) {
                                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(IdePurescript_PscIde.eitherToErr(PscIde.suggestTypos(port)(v3.word)(2)(v4.main))))(function (v5) {
                                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Aff.monadEffAff))(IdePurescript_Atom_SelectView.selectListViewStatic(view)(replaceTypo(port)(v1)(v3.range))(Data_Maybe.Nothing.value)(Data_Functor.map(Data_Functor.functorArray)(runCompletion)(v5)));
                                  });
                              });
                          });
                      });
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Maybe_Trans.MaybeT(liftEff$prime$prime(IdePurescript_Atom_Tooltips.getToken(v1)(v2.pos))))(function (v3) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Maybe_Trans.MaybeT(IdePurescript_Atom_PromptPanel.addPromptPanel("Parameter type")("")))(function (v4) {
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(IdePurescript_PscIde.eitherToErr(PscIde.caseSplit(port)(v2.line)(Atom_Point.getColumn(Atom_Range.getStart(v3.range)))(Atom_Point.getColumn(Atom_Range.getEnd(v3.range)))(false)(v4))))(function (v5) {
                              return Control_Monad_Trans_Class.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(Data_Functor["void"](Control_Monad_Aff.functorAff)(liftEff$prime$prime(Atom_Editor.setTextInBufferRange(v1)(v2.range)(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\n")(v5)))));
                          });
                      });
                  });
              });
  ...
  var startServer = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_ChildProcess.spawn(v.exe)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (p) {
          ...
          for (var $13 in Node_ChildProcess.defaultSpawnOptions) {
              if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($13)) {
                  ...
                  return function (succ) {
                      return Node_ChildProcess.execFile(exe2)([ "--version" ])((function () {
                          ...
                          for (var $35 in Node_ChildProcess.defaultExecOptions) {
                              if (Node_ChildProcess.defaultExecOptions.hasOwnProperty($35)) {
                  ...
                  if ($15 instanceof Data_Maybe.Just) {
                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn($15.value0.head.value0)(v.command.value1)((function () {
                          ...
                          for (var $17 in Node_ChildProcess.defaultSpawnOptions) {
                              if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($17)) {
          ...
          return function __do() {
              ...
              return Atom_Workspace.open(v.workspace)(paneUri)((function () {
                  ...
                  for (var $67 in Atom_Workspace.defaultOpenOptions) {
                      if (Atom_Workspace.defaultOpenOptions.hasOwnProperty($67)) {
                                  ...
                                  if (v3 instanceof Data_Maybe.Just && $108 instanceof Data_Maybe.Just) {
                                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn($108.value0.head)($108.value0.tail)((function () {
                                          ...
                                          for (var $110 in Node_ChildProcess.defaultSpawnOptions) {
                                              if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($110)) {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                          ...
                          return Data_Functor.map(Control_Monad_Aff.functorAff)(r(v))(PscIde_Server.startServer((function () {
                              ...
                              for (var $34 in PscIde_Server.defaultServerArgs) {
                                  if (PscIde_Server.defaultServerArgs.hasOwnProperty($34)) {
                                              ...
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer($59.value0.value0)(path)(glob$prime))(function (v2) {
                                                  ...
                                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                      ...
                                                      if (v2 instanceof StartError) {
                                                          return Data_Functor.voidRight(Control_Monad_Eff.functorEff)(noRes)(cb($$Error.value)("Could not start psc-ide-server process. Check the configured port number is valid.\n" + v2.value0));
                                                      };
                                      ...
                                      return new Data_Maybe.Just({
                                          ...
                                          action: (function () {
                                              ...
                                              return function __do() {
                                                  ...
                                                  var replacement$prime = Data_String.trim(IdePurescript_Regex["replace'"](Data_String_Regex.regex("\\s+\n")(Data_String_Regex_Flags.global))("\n")(v1.suggestion.replacement));
          ...
          var search = function (text) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(modulesState)))(function (v) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getLoadedModules(port))(function (v1) {
                      ...
                      return IdePurescript_PscIde["getCompletion'"](Data_Maybe.Just.create(new PscIde_Command.Flex(text)))([  ])(port)(v.main)("")(false)(v1)(getQualifiedModule);
                  });
              });
          };
...
(function(exports) {
          ...
          return function (editor) {
              return function __do() {
                  ...
                  if (v instanceof Data_Maybe.Just && mainModule instanceof Data_Maybe.Just) {
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(logError)(ignoreError)(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.getModulesForFile(port)(v.value0)(v1))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.writeRef(modulesStateRef)(v2)))(function () {
                              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
                          });
                      })))();
                  };
      ...
      return function (state) {
          return function (v) {
              ...
              return Control_Promise.fromAff(Data_Function.flip(Control_Monad_Error_Class.catchError(Control_Monad_Aff.monadErrorAff))(raiseError$prime([  ]))((function () {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  var $82 = v.activatedManually || autoCompleteAllModules;
                                  if ($82) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 75, column 14 - line 75, column 136: " + [ $82.constructor.name ]);
                              })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var startPscIdeServer$prime = function (path) {
          var retry = function (a) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(a))(function (v9) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 227, column 11 - line 231, column 27: " + [ v9.constructor.name ]);
              });
          };
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.takeVar(v9))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(PscIde_Project.getRoot(path)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                          ...
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Loading modules: " + path)))(function () {
                                              return retry(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                                                  ...
                                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.Main line 218, column 17 - line 220, column 95: " + [ v12.port.constructor.name ]);
                                                  });
                                              }));
                                          });
                                      }));
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 204, column 7 - line 220, column 95: " + [ v10.constructor.name ]);
                      })())(function () {
      ...
      var quickFix = function __do() {
          ...
          if ($121.editor instanceof Data_Maybe.Just && ($121.linter instanceof Data_Maybe.Just && $121.n > 0)) {
              return withPort(function (port) {
                  return IdePurescript_Atom_QuickFixes.showQuickFixes(port)(v2)($121.editor.value0)($121.linter.value0)(v9);
              })();
          };
          return Data_Unit.unit;
      };
          ...
          return function __do() {
              ...
              var v12 = (function () {
                  ...
                  if (v11 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function ($167) {
                          return Control_Monad_Maybe_Trans.MaybeT(PscIde_Project.getRoot($167));
                      }));
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 156, column 16 - line 158, column 74: " + [ v11.constructor.name ]);
              })()();
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Atom_Editor.getPath(v9)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(getPort(v10)))(function (v11) {
                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))((function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 288, column 19 - line 292, column 39: " + [ v11.constructor.name ]);
                          })());
                      });
                  });
              })));
