...
(function(exports) {
  ...
  var toEditor = function (item) {
      var $1 = $foreign.isTextEditor(item);
      if ($1) {
      ...
      throw new Error("Failed pattern match at Atom.Editor line 62, column 3 - line 67, column 1: " + [ $1.constructor.name ]);
  };
          ...
          return function (text) {
              return function (v) {
                  var undo = (function () {
                      ...
                      throw new Error("Failed pattern match at Atom.Editor line 41, column 14 - line 42, column 3: " + [ v.skipUndo.constructor.name ]);
                  })();
  ...
  var setText = function ($9) {
      return Data_Function_Eff.runEffFn1($foreign.setTextImpl($9));
  };
  ...
  var getTextInRange = function ($10) {
      return Data_Function_Eff.runEffFn1($foreign.getTextInRangeImpl($10));
  };
  exports["onDidSave"] = onDidSave;
  exports["toEditor"] = toEditor;
  exports["setText"] = setText;
  exports["setTextInBufferRange'"] = setTextInBufferRange$prime;
...
(function(exports) {
  ...
  var encodeImportCommand = new Data_Argonaut_Encode.EncodeJson(function (v) {
      ...
      throw new Error("Failed pattern match at PscIde.Command line 149, column 3 - line 153, column 3: " + [ v.constructor.name ]);
  });
  ...
  var encodeCommand = new Data_Argonaut_Encode.EncodeJson(function (v) {
      ...
      if (v instanceof LoadAll) {
          return jsonSingletonObject$prime(Data_Argonaut_Encode.encodeJsonJString)("command")("load");
      };
...
(function(exports) {
  ...
  var Data_Maybe = PS["Data.Maybe"];
  var Data_String_1 = PS["Data.String"];
  var Data_String_1 = PS["Data.String"];
  var IdePurescript_Atom_Build = PS["IdePurescript.Atom.Build"];
  var IdePurescript_Atom_BuildStatus = PS["IdePurescript.Atom.BuildStatus"];
      ...
      return function (editor) {
          return function __do() {
              ...
              if (mainModule instanceof Data_Maybe.Just) {
                  return Control_Monad_Aff.runAff(logError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.getModulesForFile(v)(v1))(function (v2) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 80, column 3 - line 87, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($105.editor instanceof Data_Maybe.Just && ($105.linter instanceof Data_Maybe.Just && $105.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($105.editor.value0)($105.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      ...
      var fudgeInsertSuggestion = function (v7) {
          if (v7.suggestion.addImport instanceof Data_Maybe.Just) {
              var start = Atom_Point.getColumn(v7.triggerPosition) - Data_String_1.length(v7.suggestion.replacementPrefix);
              var row = Atom_Point.getRow(v7.triggerPosition);
              var startPt = Atom_Point.mkPoint(row)(start);
              var end = start + (Data_String_1.length(v7.suggestion.text) - Data_String_1.length(v7.suggestion.addImport.value0.identifier)) | 0;
              var endPt = Atom_Point.mkPoint(row)(end);
              return Prelude["void"](Control_Monad_Eff.functorEff)(Atom_Editor["setTextInBufferRange'"](v7.editor)(Atom_Range.mkRange(startPt)(endPt))("")({
                  normalizeLineEndings: true, 
                  skipUndo: true
              }));
          };
      ...
      var doLint = function __do() {
          ...
          if ($136.root instanceof Data_Maybe.Just && ($136.linterIndie instanceof Data_Maybe.Just && $136.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($136.root.value0)($136.linterIndie.value0)($136.statusElt.value0))(function (v10) {
          ...
          return function __do() {
              ...
              if (v7 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v8)(v10)(v9)(moduleName))(function (v11) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($245) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 227, column 7 - line 236, column 5: " + [ v7.constructor.name ]);
          };
      };
      ...
      var addExplicitImportCmd = Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v7) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 173, column 7 - line 181, column 5: " + [ v7.constructor.name ]);
      }));
      var addClause = function __do() {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 275, column 7 - line 283, column 5: " + [ v7.constructor.name ]);
      };
          ...
          return function __do() {
              ...
              Atom_Workspace.observeTextEditors(v.workspace)(function (editor) {
                  return function __do() {
                      ...
                      return Control_Monad.when(Control_Monad_Eff.monadEff)(Data_String_1.contains(".purs")(v7))(function __do() {
                          useEditor(v2)(editor)();
