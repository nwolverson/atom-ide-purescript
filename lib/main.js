...
(function(exports) {
  ...
  var toLintResult = function (res) {
      var range = function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
              return [ [ v.value0.startLine - 1 | 0, v.value0.startColumn - 1 | 0 ], [ v.value0.endLine - 1 | 0, v.value0.endColumn - 1 | 0 ] ];
          };
                              ...
                              if (v1.suggestion.hasSuggestion) {
                                  ...
                                  return function __do() {
                                      ...
                                      if (v1.suggestion.range.length === 2 && (v1["suggestion"]["range"][0].length === 2 && v1["suggestion"]["range"][1].length === 2)) {
                                          var rowDiff = markerRow - v1["suggestion"]["range"][0][0] | 0;
...
(function(exports) {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Atom.getAtom))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  var $76 = v.activatedManually || autoCompleteAllModules;
                                  if ($76) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 75, column 14 - line 75, column 136: " + [ $76.constructor.name ]);
                              })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var v6 = Control_Monad_Eff_Ref.newRef(Data_StrMap.empty)();
      var v7 = Control_Monad_Eff_Ref.newRef(Data_Maybe.Nothing.value)();
      var getVar = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v7)))(Data_Maybe.maybe(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar["makeVar'"](Data_Unit.unit))(function (v8) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.writeRef(v7)(new Data_Maybe.Just(v8))))(function () {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v8);
          });
      }))(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)));
      var getPort = function (file) {
          return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(Control_Monad_Eff_Ref.readRef(v6)))(function (v8) {
              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(PscIde_Project.getRoot(file)))(function (v9) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_StrMap.lookup(v9)(v8))))(function (v10) {
      ...
      var getPathActiveEditor = Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v8) {
          return Control_Monad_Maybe_Trans.MaybeT(Atom_Editor.getPath(v8));
      });
      var getPortActiveEditor = Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function (v8) {
          return Data_Functor.map(Control_Monad_Maybe_Trans.functorMaybeT(Control_Monad_Eff.functorEff))(function (v9) {
              return v9.port;
          })(Control_Monad_Maybe_Trans.MaybeT(getPort(v8)));
      }));
      var startPscIdeServer$prime = function (path) {
          var retry = function (a) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(a))(function (v8) {
                  if (v8 instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v8.value0);
                  };
                  if (v8 instanceof Data_Either.Left) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Retrying starting server after 500ms: " + Data_Show.show(Control_Monad_Eff_Exception.showError)(v8.value0))))(function () {
                          return Control_Monad_Aff["later'"](500)(a);
                      });
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 224, column 11 - line 228, column 27: " + [ v8.constructor.name ]);
              });
          };
          return Control_Applicative.when(Control_Monad_Aff.applicativeAff)(isPursFile(path))(Control_Bind.bind(Control_Monad_Aff.bindAff)(getVar)(function (v8) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.takeVar(v8))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(PscIde_Project.getRoot(path)))(function (v9) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                          if (v9 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
                          };
                          if (v9 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v6)))(function (v10) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.when(Control_Monad_Aff.applicativeAff)(Data_Maybe.isJust(Data_StrMap.lookup(v9.value0)(v10)))(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Not starting server - already started: " + path))))(function () {
                                      return Control_Applicative.unless(Control_Monad_Aff.applicativeAff)(Data_Maybe.isJust(Data_StrMap.lookup(v9.value0)(v10)))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer(v9.value0))(function (v11) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Loading modules: " + path)))(function () {
                                              return retry(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                                                  ...
                                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                      var v12 = Atom_Workspace.getActiveTextEditor(v.workspace)();
                                                      useEditor$prime(v2)(v11.port)(v12)();
                                                      IdePurescript_Atom_Tooltips.registerTooltips(getPortActiveEditor)(v2)();
                                                      if (v11.port instanceof Data_Maybe.Nothing) {
                                                          return Data_Unit.unit;
                                                      };
                                                      if (v11.port instanceof Data_Maybe.Just) {
                                                          return Control_Monad_Eff_Ref.modifyRef(v6)(Data_StrMap.insert(v9.value0)({
                                                              port: v11.port.value0, 
                                                              quit: v11.quit
                                                          }))();
                                                      };
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.Main line 215, column 17 - line 217, column 95: " + [ v11.port.constructor.name ]);
                                                  });
                                              }));
                                          });
                                      }));
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 201, column 7 - line 217, column 95: " + [ v9.constructor.name ]);
                      })())(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Finished initialising server: " + path)))(function () {
                              return Control_Monad_Aff_AVar.putVar(v8)(Data_Unit.unit);
                          });
                      });
                  });
              });
      ...
      var quickFix = function __do() {
          ...
          if ($114.editor instanceof Data_Maybe.Just && ($114.linter instanceof Data_Maybe.Just && $114.n > 0)) {
              return withPort(function (port) {
                  return IdePurescript_Atom_QuickFixes.showQuickFixes(port)(v2)($114.editor.value0)($114.linter.value0)(v8);
              })();
          };
          return Data_Unit.unit;
      };
      ...
      var startPscIdeServer = Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function (v8) {
          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(Control_Monad_Eff_Console.log("Starting psc-ide-server for path: " + v8)))(function () {
          ...
          return function __do() {
              ...
              var v11 = (function () {
                  if (v10 instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Data_Maybe.Just(v10.value0.root));
                  };
                  if (v10 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function ($158) {
                          return Control_Monad_Maybe_Trans.MaybeT(PscIde_Project.getRoot($158));
                      }));
                  };
              ...
              if (v11 instanceof Data_Maybe.Just && (v8 instanceof Data_Maybe.Just && v9 instanceof Data_Maybe.Just)) {
                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(ignoreError)(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(Data_Functor.map(Data_Maybe.functorMaybe)(function (v12) {
                      return v12.port;
                  })(v10))(file)(v.config)(v11.value0)(v8.value0)(v9.value0))(function (v12) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(Control_Monad_Eff_Ref.writeRef(v3))(v12)))(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v13) {
                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(useEditor$prime(v2)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v14) {
                                  return v14.port;
                              })(v10))(v13));
                          });
                      });
      ...
      var deactivate = function __do() {
          ...
          Data_Traversable.sequence(Data_List_Types.traversableList)(Control_Monad_Eff.applicativeEff)(Data_Functor.map(Data_List_Types.functorList)(function (v9) {
              return v9.quit;
          })(Data_StrMap.values(v8)))();
          return Control_Monad_Eff_Ref.writeRef(v6)(Data_StrMap.empty)();
      };
      ...
      var activate = function __do() {
          ...
          Atom_Workspace.observeTextEditors(v.workspace)(function (editor) {
              return Atom_Editor.onDidSave(editor)(Data_Function["const"](function __do() {
                  ...
                  if (v8 instanceof Data_Maybe.Just && isPursFile(v8.value0)) {
                      var v9 = Atom_Config.getConfig(v.config)("ide-purescript.buildOnSave")();
                      var buildOnSaveEnabled = Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn))(Control_Monad_Except.runExcept(Data_Foreign.readBoolean(v9)));
                      return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(buildOnSaveEnabled)(doLint(new Data_Maybe.Just(v8.value0)))();
                  };
                  return Data_Unit.unit;
              }));
          })();
          Atom_Workspace.onDidChangeActivePaneItem(v.workspace)(function (item) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Atom_Editor.toEditor(item))))(function (v8) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Atom_Editor.getPath(v8)))(function (v9) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(getPort(v9)))(function (v10) {
                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))((function () {
                              if (v10 instanceof Data_Maybe.Just) {
                                  return function __do() {
                                      Control_Monad_Eff_Console.log("Switching to editor for file: " + v9)();
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 282, column 19 - line 286, column 39: " + [ v10.constructor.name ]);
                          })());
                      });
                  });
              })));
      ...
      return Data_Foreign.toForeign({
          ...
          consumeLinterIndie: Data_Function_Eff.mkEffFn1(function (registry) {
              return function __do() {
                  ...
                  return Control_Monad_Eff_Ref.writeRef(v1)(new Data_Maybe.Just(v8))();
              };
          }), 
          ...
          consumeStatusBar: Data_Function_Eff.mkEffFn1(function (statusBar) {
              return function __do() {
                  ...
                  Control_Monad_Eff_Ref.writeRef(v5)(new Data_Maybe.Just(v8))();
          ...
          provideAutocomplete: Data_Function_Eff.mkEffFn1(function (v8) {
              return function __do() {
                  var v9 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Either.either(Data_Function["const"](true))(Control_Category.id(Control_Category.categoryFn)))(Control_Monad_Except.runExcept))(Data_Foreign.readBoolean))(Atom_Config.getConfig(v.config)("ide-purescript.autocomplete.excludeLowerPriority"))();
                  return {
                      selector: ".source.purescript", 
                      disableForSelector: ".source.purescript .comment, .source.purescript .string", 
                      inclusionPriority: 1, 
                      excludeLowerPriority: v9, 
                      getSuggestions: Data_Function_Eff.mkEffFn1(function (x) {
                          return function __do() {
                              var v10 = Control_Monad_Eff_Ref.readRef(v2)();
                              return withPortDef(Control_Promise.fromAff(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([  ])))(function (p) {
                                  return getSuggestions(p)(v10)(x);
                              })();
                          };
                      }), 
                      onDidInsertSuggestion: Data_Function_Eff.mkEffFn1(function (x) {
                          return function __do() {
                              var v10 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(Control_Monad_Except.runExcept))(Data_Foreign.readBoolean))(Atom_Config.getConfig(v.config)("ide-purescript.autocomplete.addImport"))();
                              return withPort(function (port) {
                                  return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v10)(Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(ignoreError)(IdePurescript_Atom_Imports.addSuggestionImport(port)(v2)(x))));
                              })();
                          };
                      })
                  };
                  ...
                  getSuggestion: Data_Function_Eff.mkEffFn2(function (editor) {
                      return function (pos) {
                          return function __do() {
                              ...
                              return Data_Nullable.toNullable((function (v10) {
