...
(function(exports) {
  ...
  var toLintResult = function (res) {
      var range = function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 72, column 3 - line 72, column 21: " + [ v.constructor.name ]);
      };
      var result = function (errorType) {
          return function (v) {
              var replace = function (v1) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 93, column 5 - line 97, column 8: " + [ v1.constructor.name ]);
              };
              return {
                  type: errorType, 
                  text: v.message, 
      ...
      return {
          ...
          result: resultToString((function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 68, column 30 - line 68, column 69: " + [ res.success.constructor.name ]);
          })())
      };
  };
