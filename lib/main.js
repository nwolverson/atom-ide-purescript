...
(function(exports) {
  ...
  var parseVersion = function (s) {
      var $18 = Data_Function.apply(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Int.fromNumber))(Data_Functor.map(Data_Functor.functorArray)(Global.readInt(10))(Data_String.split(".")(s)));
      if ($18 instanceof Data_Maybe.Just && $18.value0.length === 3) {
          return Data_Function.apply(Data_Maybe.Just.create)(new Version($18.value0[0], $18.value0[1], $18.value0[2]));
      };
      return Data_Maybe.Nothing.value;
  };
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffS(Atom_Atom.getAtom))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readArray)(Atom_Config.getConfig(v.config)("ide-purescript.pscSourceGlob"))))(function (v2) {
                  var srcGlob$prime = Data_Bifunctor.rmap(Data_Either.bifunctorEither)(Data_Function.apply(Data_Array.mapMaybe)(function ($64) {
                      return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Data_Foreign.readString($64));
                  }))(v2);
                  ...
                  if (v1 instanceof Data_Either.Right) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_Server.findBins(v1.value0))(function (v3) {
                          ...
                          if ($44 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Resolved psc-ide-server paths (1st is used):")))(function () {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v4) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v3) > 1))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Found multiple psc-ide-server executables; using " + $44.value0.value0))))(function () {
                                          var glob$prime = (function () {
                                              var $49 = Data_Ord.greaterThanOrEq(Data_Maybe.ordMaybe(ordVersion))(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(parseVersion)(Data_String.trim))($44.value0.value1)))(new Data_Maybe.Just(new Version(0, 9, 5)));
                                              if ($49) {
                                                  return glob;
                                              };
                                              if (!$49) {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 88, column 25 - line 88, column 110: " + [ $49.constructor.name ]);
                                          })();
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($44.value0.value0)(path)(glob$prime))(function (v4) {
                                              var noRes = {
                                                  quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                                  port: Data_Maybe.Nothing.value
                                              };
                                              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                                                  ...
                                                  throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 91, column 13 - line 104, column 169: " + [ v4.constructor.name ]);
                                              })());
                                          });
                                      });
                                  });
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 77, column 9 - line 104, column 169: " + [ $44.constructor.name ]);
                      });
                  };
