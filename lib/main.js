...
(function(exports) {
  ...
  var toLintResult = function (res) {
      var range = function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 55, column 3 - line 56, column 3: " + [ v.constructor.name ]);
      };
              ...
              var replace = function (v1) {
                  if (v1 instanceof Data_Maybe.Just) {
                      return {
                          ...
                          hasSuggestion: true, 
                          range: range(Data_Maybe.maybe(v.position)(Data_Maybe.Just.create)(v1.value0.replaceRange))
                      };
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 76, column 5 - line 81, column 5: " + [ v1.constructor.name ]);
              };
              return {
                  type: errorType, 
                  text: v.message, 
      ...
      return {
          ...
          result: resultToString((function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 51, column 13 - line 52, column 3: " + [ res.success.constructor.name ]);
          })())
      };
  };
