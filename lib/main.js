...
(function(exports) {
  ...
  var encodePursuitType = new Data_Argonaut_Encode_Class.EncodeJson(function ($110) {
      return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Show.show(showPursuitType)($110));
  });
  ...
  var encodeImportCommand = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      ...
      throw new Error("Failed pattern match at PscIde.Command line 155, column 3 - line 158, column 23: " + [ v.constructor.name ]);
  });
  ...
  var decodeMessage = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left("Message not string"))(function ($111) {
          return Data_Either.Right.create(Message($111));
...
(function(exports) {
  ...
  var type$prime = function (port) {
      return function (s) {
          return function (fs) {
              return function (mod) {
                  return sendCommand(PscIde_Command.encodeCommand)(Data_Argonaut_Decode_Class.decodeArray(PscIde_Command.decodeCompletion))(port)(new PscIde_Command.Type(s, fs, mod));
              };
          };
      };
  };
...
(function(exports) {
  ...
  var test$prime = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Regex line 19, column 1 - line 19, column 29: " + [ v.constructor.name ]);
  };
  var replace$prime = function (v) {
      return function (v1) {
          return function (s) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Regex line 11, column 1 - line 11, column 26: " + [ v.constructor.name, v1.constructor.name, s.constructor.name ]);
          };
      };
  };
  var match$prime = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Regex line 15, column 1 - line 15, column 32: " + [ v.constructor.name ]);
  };
...
(function(exports) {
          ...
          return function (getQualifiedModule) {
              ...
              if (!$16) {
                  ...
                  if (!$17) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIde line 64, column 5 - line 67, column 11: " + [ $18.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at IdePurescript.PscIde line 60, column 8 - line 67, column 11: " + [ $17.constructor.name ]);
              };
              throw new Error("Failed pattern match at IdePurescript.PscIde line 58, column 3 - line 67, column 11: " + [ $16.constructor.name ]);
          };
      };
  };
  var eitherToErr = function (c) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(c)(function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.PscIde line 23, column 3 - line 25, column 26: " + [ v.constructor.name ]);
      });
  };
  ...
  var loadDeps = function (port) {
      return function (main) {
          return Data_Function.apply(result(runMsg))(PscIde.load(port)([  ])([ main ]));
      };
  };
                      ...
                      return function (unqualModules) {
                          return function (getQualifiedModule) {
                              var mods = (function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.PscIde line 95, column 10 - line 95, column 108: " + [ moduleCompletion.constructor.name ]);
                              })();
                              var conv = Data_Functor.map(Data_Functor.functorArray)(convCompletion);
                              return Data_Functor.map(Control_Monad_Aff.functorAff)(conv)(Data_Function.apply(eitherToErr)(PscIde.complete(port)(Data_Array.cons(new PscIde_Command.PrefixFilter(prefix))(moduleFilters(mods)))(Data_Maybe.Nothing.value)(currentModule)));
                          };
                      };
                  };
              };
  ...
  var abbrevType = (function () {
      var r = Data_Function.apply(Data_String_Regex.regex("(?:\\w+\\.)+(\\w+)"))((function () {
          var $46 = {};
      ...
      return IdePurescript_Regex["replace'"](r)("$1");
  })();
              ...
              return function (modulePrefix) {
                  return function (unqualModules) {
                      return function (getQualifiedModule) {
                          ...
                          var conv = function (r) {
                              var $48 = Data_Function.apply(Data_Array.head)(Data_Functor.map(Data_Functor.functorArray)(convCompletion)(r));
                              ...
                              throw new Error("Failed pattern match at IdePurescript.PscIde line 84, column 14 - line 88, column 1: " + [ $48.constructor.name ]);
                          };
              ...
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))((function () {
                  ...
                  if ($11.before instanceof Data_Maybe.Just && ($11.before.value0.length === 1 && ($11.before.value0[0] instanceof Data_Maybe.Just && ($11.after instanceof Data_Maybe.Just && ($11.after.value0.length === 1 && $11.after.value0[0] instanceof Data_Maybe.Just))))) {
                      var qualifier = (function () {
                          var $12 = IdePurescript_Regex["match'"](moduleRegex)(Data_String.take(Data_String.length(v) - Data_String.length(($11.before.value0[0]).value0))(v));
...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      ...
      return function ($77) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function.apply(Data_Function["const"])(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($77));
      };
  })();
  var getPort = function __do() {
      var v = Atom_Atom.getAtom();
      var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readInt)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdePort"))();
      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(v1))();
  };
  var fixTypo = function (modulesState) {
      var body = (function () {
          ...
          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(liftEff$prime$prime(Atom_Atom.getAtom)))(function (v) {
              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(liftEff$prime$prime(getPort)))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Data_Function.apply(liftEff$prime$prime)(Atom_Workspace.getActiveTextEditor(v.workspace))))(function (v2) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(IdePurescript_Atom_Editor.getLinePosition(v2))))(function (v3) {
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Data_Function.apply(liftEff$prime$prime)(IdePurescript_Atom_Tooltips.getToken(v2)(v3.pos))))(function (v4) {
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(Control_Monad_Eff_Ref.readRef(modulesState))))(function (v5) {
                                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(IdePurescript_PscIde.eitherToErr(PscIde_1.suggestTypos(v1)(v4.word)(2)(v5.main))))(function (v6) {
                                      return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Aff.monadEffAff)))(IdePurescript_Atom_SelectView.selectListViewStatic(view)(replaceTypo(v1)(v2)(v4.range))(Data_Maybe.Nothing.value)(Data_Functor.map(Data_Functor.functorArray)(runCompletion)(v6)));
                                  });
                              });
                          });
                      });
      ...
      var body = Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(liftEff$prime$prime(Atom_Atom.getAtom)))(function (v) {
          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(liftEff$prime$prime(getPort)))(function (v1) {
              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Data_Function.apply(liftEff$prime$prime)(Atom_Workspace.getActiveTextEditor(v.workspace))))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(IdePurescript_Atom_Editor.getLinePosition(v2))))(function (v3) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Data_Function.apply(liftEff$prime$prime)(IdePurescript_Atom_Tooltips.getToken(v2)(v3.pos))))(function (v4) {
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(IdePurescript_Atom_PromptPanel.addPromptPanel("Parameter type")("")))(function (v5) {
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(IdePurescript_PscIde.eitherToErr)(PscIde_1.caseSplit(v1)(v3.line)(Data_Function.apply(Atom_Point.getColumn)(Atom_Range.getStart(v4.range)))(Data_Function.apply(Atom_Point.getColumn)(Atom_Range.getEnd(v4.range)))(true)(v5))))(function (v6) {
                                  return Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(Data_Functor["void"](Control_Monad_Aff.functorAff))(Data_Function.apply(liftEff$prime$prime)(Data_Function.apply(Atom_Editor.setTextInBufferRange(v2)(v3.range))(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\n")(v6)))));
                              });
                          });
                      });
                  });
  ...
  var addClause = function __do() {
      ...
      if (v1 instanceof Data_Maybe.Just && v2 instanceof Data_Maybe.Just) {
          return Data_Function.apply(launchAffAndRaise)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(IdePurescript_Atom_Editor.getLinePosition(v1.value0)))(function (v3) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(IdePurescript_PscIde.eitherToErr)(PscIde_1.addClause(v2.value0)(v3.line)(true)))(function (v4) {
                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Atom_Editor.setTextInBufferRange(v1.value0)(v3.range))(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\n")(v4)));
              });
          }))();
      };
      return Data_Unit.unit;
...
(function(exports) {
  ...
  var pulpCmd = (function () {
      var $2 = Data_Eq.eq(Node_Platform.eqPlatform)(Node_Process.platform)(Node_Platform.Win32.value);
      if ($2) {
          return "pulp.cmd";
      };
      if (!$2) {
  ...
  var getPscIdePort = function __do() {
      var v = Atom_Atom.getAtom();
      var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readInt)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdePort"))();
      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Either.either(Data_Function["const"](4242))(Control_Category.id(Control_Category.categoryFn))(v1))();
  };
...
(function(exports) {
                          ...
                          return function (msg) {
                              return function __do() {
                                  ...
                                  return Data_Function.apply((function () {
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 127, column 8 - line 127, column 43: " + [ $14.constructor.name ]);
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(IdePurescript_Atom_Build.toLintResult)(buildCmd))(function (v) {
                                  return Data_Function.apply(liftEffA)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(function __do() {
                                      ...
                                      status((function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 112, column 21 - line 112, column 68: " + [ $18.constructor.name ]);
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Atom_Atom.getAtom))(function (v) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Atom_Config.getConfig(config)("ide-purescript.buildCommand")))(function (v1) {
                              var buildCommand = (function () {
                                  var $24 = Data_String_Regex.regex("\\s+")(Data_String_Regex.noFlags);
                                  var $25 = Data_Foreign.readString(v1);
                                  if ($24 instanceof Data_Either.Right && $25 instanceof Data_Either.Right) {
                                      return Data_Function.apply(Data_String_Regex.split($24.value0))(Data_Function.apply(Data_String.trim)($25.value0));
                                  };
                                  return [  ];
                              })();
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(IdePurescript_Atom_Config.getPscIdePort))(function (v2) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readBoolean)(Atom_Config.getConfig(config)("ide-purescript.fastRebuild"))))(function (v3) {
                                      var fastBuild = (function () {
                                          if (v3 instanceof Data_Either.Right && (v3.value0 && file instanceof Data_Maybe.Just)) {
                                              return Data_Function.apply(Data_Maybe.Just.create)(IdePurescript_Build.rebuild(v2)(file.value0));
                                          };
                                          return Data_Maybe.Nothing.value;
                                      })();
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function () {
                                          var $35 = Data_Array.uncons(buildCommand);
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 95, column 3 - line 100, column 20: " + [ fastBuild.constructor.name, $35.constructor.name ]);
                                      });
                                  });
                              });
                          });
  ...
  var getProjectRoot = (function () {
      var validDir = Data_Function.apply(Data_Function["const"])(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(true));
      ...
      var getRoot = function (path) {
          ...
          if (!$40) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 71, column 7 - line 71, column 58: " + [ v.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 67, column 5 - line 71, column 58: " + [ $40.constructor.name ]);
      };
      return function __do() {
          var v = Atom_Atom.getAtom();
          var v1 = Atom_Project.getPaths(v.project)();
          var v2 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Array.catMaybes)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(getRoot)(v1))();
          var v3 = Data_Array.filterM(Control_Monad_Eff.monadEff)(validDir)(v2)();
          var $47 = Data_Array.uncons(v3);
          ...
          if ($47 instanceof Data_Maybe.Just) {
              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Function.apply(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Array["null"]($47.value0.tail))))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Multiple project roots, using first: " + $47.value0.head))();
              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array["null"]($47.value0.tail) && Data_Array.length(v2) > 1))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Multiple project roots but only 1 looks valid: " + $47.value0.head))();
              var output = Node_Path.concat([ $47.value0.head, "output" ]);
              var v4 = Node_FS_Sync.exists(output)();
              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(!v4))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Doesn't look like a project has been built - didn't find: " + output))();
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Maybe.Just($47.value0.head))();
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 41, column 3 - line 51, column 22: " + [ $47.constructor.name ]);
      };
  })();
...
(function(exports) {
  ...
  var xtermColor = function (c) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 132, column 16 - line 151, column 1: " + [ c.constructor.name ]);
  };
  ...
  var opener = function (s) {
      var $49 = Data_String.indexOf(paneUri)(s);
      if ($49 instanceof Data_Maybe.Just && $49.value0 === 0) {
          return function __do() {
      ...
      return function (cb) {
          return function __do() {
              ...
              return Atom_Workspace.open(v.workspace)(paneUri)((function () {
                  var $57 = {};
                  for (var $58 in Atom_Workspace.defaultOpenOptions) {
                      if (Atom_Workspace.defaultOpenOptions.hasOwnProperty($58)) {
                          $57[$58] = Atom_Workspace.defaultOpenOptions[$58];
                      };
                  };
                  $57.split = "right";
                  $57.activatePane = false;
                  return $57;
  ...
  var replaceAnsiColor = function (text) {
      ...
      var colorCss = function (n) {
          return "color: " + Data_Maybe.maybe("black")(function ($134) {
              return renderRgbCss(xtermColor($134));
          })(colorForCode(n));
      };
      var colEscape = function (text1) {
          var $60 = IdePurescript_Regex["match'"](Data_String_Regex.regex("\\x1b\\[([0-9]+)m")(Data_String_Regex.noFlags))(text1);
          if ($60 instanceof Data_Maybe.Just && ($60.value0.length === 2 && $60.value0[1] instanceof Data_Maybe.Just)) {
              return Data_Int.fromNumber(Global.readInt(10)(($60.value0[1]).value0));
          };
          return Data_Maybe.Nothing.value;
      };
      var toNodes = function (v) {
          ...
          if (Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(2)))(new Data_Maybe.Just(0)) && Data_Maybe.isJust(Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(0)))) {
              var $66 = Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(0));
              var $67 = Data_Array.index(v)(1);
              if ($66 instanceof Data_Maybe.Just && $67 instanceof Data_Maybe.Just) {
                  return function __do() {
                      var v1 = createElement$prime("span")();
                      DOM_Node_Node.setTextContent($67.value0)(DOM_Node_Types.elementToNode(v1))();
                      DOM_Node_Element.setAttribute("style")(colorCss($66.value0))(v1)();
  ...
  var clearText = function (v) {
      ...
      return Control_Monad_Eff.whileE(DOM_Node_Node.hasChildNodes(node))(function __do() {
          ...
          return Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($135) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Function.flip(DOM_Node_Node.removeChild)(node)($135));
          })(v1)();
      });
  };
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Unsafe_Coerce.unsafeCoerce(openPsci))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(function __do() {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.psciCommand"))))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Atom_LinterBuild.getProjectRoot))(function (v3) {
                              var command = (function () {
                                  var $94 = Data_String_Regex.regex("\\s+")(Data_String_Regex.noFlags);
                                  if (v2 instanceof Data_Either.Right && $94 instanceof Data_Either.Right) {
                                      return Data_String_Regex.split($94.value0)(v2.value0);
                                  };
                                  return [  ];
                              })();
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)((function () {
                                  var $98 = Data_Array.uncons(command);
                                  if (v3 instanceof Data_Maybe.Just && $98 instanceof Data_Maybe.Just) {
                                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn($98.value0.head)($98.value0.tail)((function () {
                                          var $99 = {};
                                          for (var $100 in Node_ChildProcess.defaultSpawnOptions) {
                                              if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($100)) {
                                                  $99[$100] = Node_ChildProcess.defaultSpawnOptions[$100];
                                              };
                                          };
                                          $99.cwd = v3;
                                          return $99;
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($136) {
                                      return Control_Monad_Eff_Ref.writeRef(psciRef)(Data_Maybe.Just.create($136));
                                  })(v4)))(function () {
                                      return Data_Function.apply(liftEff$prime$prime)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (proc) {
                                          return Data_Function.apply(Control_Monad_Eff_Exception.catchException(Data_Function.apply(Data_Function["const"])(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))))(function __do() {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 269, column 5 - line 280, column 27: " + [ v5.constructor.name ]);
                                          });
                                      })(v4));
                                  });
                              });
  ...
  var activate = function __do() {
      ...
      var close = function __do() {
          ...
          if (v3 instanceof Data_Maybe.Just && v4 instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 301, column 13 - line 303, column 35: " + [ v5.constructor.name ]);
          };
          return Data_Unit.unit;
      };
          ...
          return function (name) {
              return function (action) {
                  var scope = (function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 324, column 23 - line 325, column 3: " + [ isEditor.constructor.name ]);
                  })();
                  return Atom_CommandRegistry.addCommand(v.commands)("atom-workspace")("psci:" + name)(Data_Function["const"](action));
              };
          };
      };
...
(function(exports) {
  ...
  var startServer$prime = function (stdio) {
      return function (exe) {
          return function (port) {
              return function (projectRoot) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_ChildProcess.spawn(exe)([ "-p", Data_Show.show(Data_Show.showInt)(port) ])((function () {
                      var $5 = {};
      ...
      return function (port) {
          return function (rootPath) {
              var launchServer = (function () {
                  var r = function (v) {
                      if (v instanceof PscIde_Server.Started) {
                          return new Started(v.value0);
                      };
                      if (v instanceof PscIde_Server.Closed) {
                          return Closed.value;
                      };
                      if (v instanceof PscIde_Server.StartError) {
                          return new StartError(v.value0);
                      };
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 33, column 7 - line 33, column 36: " + [ v.constructor.name ]);
                  };
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("Starting psc-ide-server")))(function () {
                      return Data_Functor.map(Control_Monad_Aff.functorAff)(r)(PscIde_Server.startServer(exe)(port)(new Data_Maybe.Just(rootPath)));
                  });
              })();
                  ...
                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                      ...
                      if (!$5) {
                          return function __do() {
                              ...
                              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new WrongPath(workingDir))();
                          };
                      };
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 38, column 5 - line 45, column 38: " + [ $5.constructor.name ]);
                  })());
              };
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Aff.attempt)(IdePurescript_PscIde.cwd(port)))(function (v) {
                  return Data_Either.either(Data_Function["const"](launchServer))(gotPath)(v);
              });
          };
      };
  };
...
(function(exports) {
  ...
  var startServer = (function () {
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffS(Atom_Atom.getAtom))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffS(IdePurescript_Atom_LinterBuild.getProjectRoot))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readInt)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdePort"))))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v3) {
                      var $13 = {
                          portRaw: v2, 
                          serverRaw: v3, 
                          path: v1
                      };
                      if ($13.portRaw instanceof Data_Either.Right && ($13.serverRaw instanceof Data_Either.Right && $13.path instanceof Data_Maybe.Just)) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_Server.findBins($13.serverRaw.value0))(function (v4) {
                              var $15 = Data_Array.head(v4);
                              if ($15 instanceof Data_Maybe.Nothing) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Node_Process.lookupEnv("PATH")))(function (v5) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Function.apply(Atom_NotificationManager.addError(v.notifications))("Couldn't find psc-ide-server, check PATH. Looked for: " + ($13.serverRaw.value0 + (" in PATH: " + Data_Maybe.fromMaybe("")(v5))))))(function () {
                                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Aff.applicativeAff))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit));
                                      });
                                  });
                              };
                              if ($15 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Resolved psc-ide-server:")))(function () {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v5) {
                                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)(v5.value0 + (": " + Data_Maybe.fromMaybe("ERROR")(v5.value1))));
                                      })(v4))(function () {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v4) > 1))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Found multiple psc-ide-server executables; using " + $15.value0.value0))))(function () {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($15.value0.value0)($13.portRaw.value0)($13.path.value0))(function (v5) {
                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                                                      if (v5 instanceof IdePurescript_PscIdeServer.CorrectPath) {
                                                          return Data_Functor.voidRight(Control_Monad_Eff.functorEff)(Data_Maybe.Nothing.value)(Atom_NotificationManager.addInfo(v.notifications)("Found existing psc-ide-server with correct path"));
                                                      };
                                                      if (v5 instanceof IdePurescript_PscIdeServer.WrongPath) {
                                                          return Data_Functor.voidRight(Control_Monad_Eff.functorEff)(Data_Maybe.Nothing.value)(Data_Function.apply(Atom_NotificationManager.addError(v.notifications))("Found existing psc-ide-server with wrong path: '" + (v5.value0 + "'. Correct, kill or configure a different port, and restart.")));
                                                      };
                                                      if (v5 instanceof IdePurescript_PscIdeServer.Started) {
                                                          return Data_Functor.voidRight(Control_Monad_Eff.functorEff)(new Data_Maybe.Just(v5.value0))(Atom_NotificationManager.addSuccess(v.notifications)("Started psc-ide-server"));
                                                      };
                                                      if (v5 instanceof IdePurescript_PscIdeServer.Closed) {
                                                          return Data_Functor.voidRight(Control_Monad_Eff.functorEff)(Data_Maybe.Nothing.value)(Atom_NotificationManager.addInfo(v.notifications)("psc-ide-server exited with success code"));
                                                      };
                                                      if (v5 instanceof IdePurescript_PscIdeServer.StartError) {
                                                          return Data_Functor.voidRight(Control_Monad_Eff.functorEff)(Data_Maybe.Nothing.value)(Data_Function.apply(Atom_NotificationManager.addError(v.notifications))("Could not start psc-ide-server process. Check the configured port number is valid.\n" + v5.value0));
                                                      };
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 64, column 26 - line 69, column 170: " + [ v5.constructor.name ]);
                                                  })()))(function (v6) {
                                                      if (v6 instanceof Data_Maybe.Nothing) {
                                                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Aff.applicativeAff))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit));
                                                      };
                                                      if (v6 instanceof Data_Maybe.Just) {
                                                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Aff.applicativeAff))(Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.launchAff)(IdePurescript_PscIdeServer.stopServer($13.portRaw.value0)(v6.value0))));
                                                      };
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 70, column 13 - line 72, column 72: " + [ v6.constructor.name ]);
                                                  });
                                              });
                                          });
                                      });
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 52, column 9 - line 72, column 72: " + [ $15.constructor.name ]);
                          });
                      };
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Aff.applicativeAff))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit));
                  });
          ...
          return function (linterMain) {
              return function (messages) {
                      ...
                      return function (v1) {
                          if (v1.suggestion.hasSuggestion) {
                              ...
                              var getFix$prime = function (range1) {
                                  return new Data_Maybe.Just({
                                      ...
                                      action: function __do() {
                                          Atom_Editor.setTextInBufferRange(editor)(range1)(v1.suggestion.replacement)();
                              ...
                              if (v1.suggestion.range.length === 2 && ((v1.suggestion.range[0]).length === 2 && (v1.suggestion.range[1]).length === 2)) {
                                  return Data_Function.apply(getFix$prime)(Atom_Range.mkRange(Atom_Point.mkPoint(v1.suggestion.range[0][0])(v1.suggestion.range[0][1]))(Atom_Point.mkPoint(v1.suggestion.range[1][0])(v1.suggestion.range[1][1])));
                              };
                              return Data_Maybe.Nothing.value;
                          };
                  ...
                  return function __do() {
                      ...
                      var fixes = Data_Array.mapMaybe(getFix(v1))(v3);
                      return IdePurescript_Atom_SelectView.selectListViewStaticInline(view)(applyFix)(Data_Maybe.Nothing.value)(fixes)();
                  };
              };
          };
      };
...
(function(exports) {
      ...
      return function (editor) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Just && mainModule instanceof Data_Maybe.Just) {
                  return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(logError)(ignoreError))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.loadDeps(v2)(mainModule.value0))(function () {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.getModulesForFile(v2)(v.value0)(v1))(function (v3) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.writeRef(modulesStateRef)(v3)))(function () {
                              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
                          });
                      });
                  })))();
          ...
          return Data_Function.apply(Control_Promise_1.fromAff)(Data_Function.apply(Data_Function.flip(Control_Monad_Error_Class.catchError(Control_Monad_Aff.monadErrorAff))(raiseError$prime([  ])))((function () {
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Atom_Config.getPscIdePort))(function (v3) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v4) {
                              var autoCompleteAllModules = Data_Function.apply(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(Data_Foreign.readBoolean(v4));
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 66, column 14 - line 66, column 136: " + [ $59.constructor.name ]);
                              })())(function (v5) {
  ...
  var main = function __do() {
      ...
      var v5 = Control_Monad_Eff_Ref.newRef(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))();
      var v6 = Control_Monad_Eff_Ref.newRef(Data_Maybe.Nothing.value)();
      var startPscIdeServer = Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Control_Monad_Aff.runAff(function (v7) {
          return Control_Monad_Eff_Console.log("Error starting server");
      })(ignoreError)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(IdePurescript_Atom_Config.getPscIdePort))(function (v7) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer)(function (v8) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.writeRef(v5)(v8)))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_1.load(v7)([  ])([  ]))(function () {
                      return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                          ...
                          return Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(useEditor(v2))(v9)();
                      });
                  });
              });
          });
      ...
      var restartPscIdeServer = function __do() {
          Data_Function.apply(Control_Bind.join(Control_Monad_Eff.bindEff))(Control_Monad_Eff_Ref.readRef(v5))();
      ...
      var doLint = function (file) {
          return function __do() {
              ...
              if ($88.root instanceof Data_Maybe.Just && ($88.linterIndie instanceof Data_Maybe.Just && $88.statusElt instanceof Data_Maybe.Just)) {
                  return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(raiseError)(ignoreError))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(file)(v.config)($88.root.value0)($88.linterIndie.value0)($88.statusElt.value0))(function (v11) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(Control_Monad_Eff_Ref.writeRef(v3))(v11)))(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_1.load(v10)([  ])([  ]))(function () {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v12) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(useEditor(v2))(v12)))(function () {
                                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
                                  });
                              });
                          });
      ...
      var activate = function __do() {
          ...
          var cmd = function (name) {
              return function (action) {
                  return Atom_CommandRegistry.addCommand(v.commands)("atom-workspace")("purescript:" + name)(Data_Function["const"](action));
              };
          };
          Data_Function.apply(cmd("build"))(doLint(Data_Maybe.Nothing.value))();
          cmd("show-quick-fixes")(quickFix)();
          Data_Function.apply(cmd("pursuit-search"))(IdePurescript_Atom_Search.pursuitSearch(v7))();
          Data_Function.apply(cmd("pursuit-search-modules"))(IdePurescript_Atom_Search.pursuitSearchModule(v7)(v2))();
          Data_Function.apply(cmd("add-module-import"))(IdePurescript_Atom_Imports.addModuleImportCmd(v7)(v2))();
          Data_Function.apply(cmd("add-explicit-import"))(IdePurescript_Atom_Imports.addExplicitImportCmd(v7)(v2))();
          Data_Function.apply(cmd("search"))(IdePurescript_Atom_Search.localSearch(v7)(v2))();
          cmd("case-split")(IdePurescript_Atom_Assist.caseSplit)();
          cmd("add-clause")(IdePurescript_Atom_Assist.addClause)();
          Data_Function.apply(cmd("fix-typo"))(IdePurescript_Atom_Assist.fixTypo(v2))();
                  ...
                  if (v8 instanceof Data_Maybe.Just && Data_String.contains(".purs")(v8.value0)) {
                      ...
                      return Atom_Editor.onDidSave(editor)(function (v9) {
                          return function __do() {
                              ...
                              return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Function.apply(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(Data_Foreign.readBoolean(v10)))(doLint(v8))();
                          };
                      })();
                  };
                  return Data_Unit.unit;
          ...
          Atom_Workspace.onDidChangeActivePaneItem(v.workspace)(function (item) {
              return Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(useEditor(v2))(Atom_Editor.toEditor(item));
          })();
      ...
      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Foreign.toForeign({
          ...
          consumeLinterIndie: Data_Function_Eff.mkEffFn1(function (registry) {
              return function __do() {
                  ...
                  return Data_Function.apply(Control_Monad_Eff_Ref.writeRef(v1))(new Data_Maybe.Just(v7))();
              };
          }), 
          ...
          consumeStatusBar: Data_Function_Eff.mkEffFn1(function (statusBar) {
              return function __do() {
                  ...
                  Data_Function.apply(Control_Monad_Eff_Ref.writeRef(v6))(new Data_Maybe.Just(v7))();
              ...
              return {
                  ...
                  onDidInsertSuggestion: Data_Function_Eff.mkEffFn1(function (x) {
                      return function __do() {
                          ...
                          return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Eq.eq(Data_Either.eqEither(Data_Foreign.eqForeignError)(Data_Eq.eqBoolean))(Data_Foreign.readBoolean(v8))(new Data_Either.Right(true)))(Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(raiseError)(ignoreError))(IdePurescript_Atom_Imports.addSuggestionImport(v9)(v2)(x))))();
                      };
                  })
              };
          }
