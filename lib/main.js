...
(function(exports) {
  ...
  var pulpCmd = (function () {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Config line 27, column 11 - line 29, column 1: " + [ $2.constructor.name ]);
  })();
...
(function(exports) {
  ...
  var startServer$prime$prime = function (stdio) {
      return function (exe) {
          return function (v) {
              return function (projectRoot) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_ChildProcess.spawn(exe)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (p) {
                      ...
                      throw new Error("Failed pattern match at PscIde.Server line 72, column 8 - line 72, column 44: " + [ v.watch.constructor.name ]);
                      ...
                      throw new Error("Failed pattern match at PscIde.Server line 73, column 8 - line 73, column 41: " + [ v.debug.constructor.name ]);
                  })())(v.source))))))((function () {
                      var $14 = {};
                      for (var $15 in Node_ChildProcess.defaultSpawnOptions) {
                          if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($15)) {
  ...
  var getSavedPort = function (cwd) {
      return function __do() {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($36) {
              return Data_Int.fromNumber(Global.readInt(10)($36));
          })(v))();
      };
  };
  ...
  exports["startServer''"] = startServer$prime$prime;
              ...
              var launchServer = (function () {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(PscIde_Server_1.pickFreshPort))(function (v) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                          ...
                          return Data_Functor.map(Control_Monad_Aff.functorAff)(r(v))(PscIde_Server_1["startServer''"](Node_ChildProcess.pipe)(exe)((function () {
                              var $13 = {};
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffS(Atom_Atom.getAtom))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readArray)(Atom_Config.getConfig(v.config)("ide-purescript.pscSourceGlob"))))(function (v2) {
                  var srcGlob$prime = Data_Bifunctor.rmap(Data_Either.bifunctorEither)(Data_Function.apply(Data_Array.mapMaybe)(function ($33) {
                      return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Data_Foreign.readString($33));
                  }))(v2);
                  ...
                  if (v1 instanceof Data_Either.Right) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_Server.findBins(v1.value0))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Resolved psc-ide-server paths (1st is used):")))(function () {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v4) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v3) > 1))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Found multiple psc-ide-server executables; using " + $14.value0.value0))))(function () {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($14.value0.value0)(path)(glob))(function (v4) {
                                              var noRes = {
                                                  quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                                  port: Data_Maybe.Nothing.value
                                              };
                                              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                                                  ...
                                                  throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 70, column 13 - line 83, column 169: " + [ v4.constructor.name ]);
                                              })());
                                          });
                                      });
                                  });
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 57, column 9 - line 83, column 169: " + [ $14.constructor.name ]);
                      });
                  };
...
(function(exports) {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  var $75 = v.activatedManually || autoCompleteAllModules;
                                  if ($75) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 72, column 14 - line 72, column 136: " + [ $75.constructor.name ]);
                              })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($109.editor instanceof Data_Maybe.Just && ($109.linter instanceof Data_Maybe.Just && $109.n > 0)) {
              return withPort(function (port) {
                  return IdePurescript_Atom_QuickFixes.showQuickFixes(port)(v2)($109.editor.value0)($109.linter.value0)(v8);
              })();
          };
          return Data_Unit.unit;
      };
                      ...
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Editor.getPath(v8)))(function (v9) {
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(getPort(v9)))(function (v10) {
                              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 251, column 9 - line 255, column 39: " + [ v10.constructor.name ]);
                              })());
                          });
                      });
                  })));
