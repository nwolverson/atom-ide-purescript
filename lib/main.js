...
(function(exports) {
  ...
  var encodeJsonInt = new EncodeJson(function ($30) {
      return Data_Argonaut_Core.fromNumber(Data_Int.toNumber($30));
  });
...
(function(exports) {
  ...
  var getModuleName = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Modules line 26, column 1 - line 27, column 1: " + [ v.constructor.name ]);
  };
  ...
  var getModulesForFile = function (file) {
      return function (fullText) {
          var mod = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Modules line 51, column 3 - line 52, column 3: " + [ v.constructor.name ]);
          };
