...
(function(exports) {
  ...
  var encodePursuitType = new Data_Argonaut_Encode_Class.EncodeJson(function ($139) {
      return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Show.show(showPursuitType)($139));
  });
  ...
  var decodeMessage = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Data_Maybe.maybe(new Data_Either.Left("Message not string"))(function ($140) {
          return Data_Either.Right.create(Message($140));
  ...
  var decodeImportList = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      var decodeObject = Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonString))(v)("moduleName"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeImport))(v)("imports"))(function (v2) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)({
                      moduleName: Data_Array.head(v1), 
                      imports: v2
                  });
              });
          });
...
(function(exports) {
  ...
  var getUnqualActiveModules = function (v) {
      return function (ident) {
          var include = function (v1) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Modules line 96, column 3 - line 96, column 49: " + [ v1.constructor.name ]);
          };
          return Data_Functor.map(Data_Functor.functorArray)(getModuleName)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function ($102) {
              return Data_Array.singleton(mkImplicit($102));
  ...
  var getMainModule = function (text) {
      ...
      var $55 = IdePurescript_Regex["match'"](regex)(text);
      if ($55 instanceof Data_Maybe.Just && ($55.value0.length === 2 && $55["value0"][1] instanceof Data_Maybe.Just)) {
          return new Data_Maybe.Just($55["value0"][1].value0);
      };
      return Data_Maybe.Nothing.value;
  };
          ...
          return function (fileName) {
              return function (text) {
                  return function (moduleName) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Modules line 144, column 3 - line 150, column 21: " + [ shouldAdd.constructor.name ]);
                  };
              };
          };
      };
                  ...
                  return function (moduleName) {
                      return function (identifier) {
                          ...
                          var filters = (function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Modules line 169, column 15 - line 171, column 49: " + [ moduleName.constructor.name ]);
                          })();
                          var addImport = function (tmpFile) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(withTempFile(fileName)(text)(addImport))(function (v) {
                                  var state$prime = (function () {
                                      if (v instanceof UpdatedImports) {
                                          ...
                                          $98.identifiers = Data_Array.cons(identifier)(state.identifiers);
                                          return $98;
                                      };
                                      return state;
                                  })();
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Modules line 159, column 3 - line 166, column 37: " + [ shouldAdd.constructor.name ]);
                      };
                  };
              };
          };
...
(function(exports) {
  ...
  var startServer = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_ChildProcess.spawn(v.exe)(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
          ...
          throw new Error("Failed pattern match at PscIde.Server line 66, column 8 - line 66, column 53: " + [ v.combinedExe.constructor.name ]);
          ...
          throw new Error("Failed pattern match at PscIde.Server line 70, column 8 - line 70, column 44: " + [ v.watch.constructor.name ]);
          ...
          throw new Error("Failed pattern match at PscIde.Server line 71, column 8 - line 71, column 41: " + [ v.debug.constructor.name ]);
      })())(v.source)))))))((function () {
          var $15 = {};
  ...
  var getSavedPort = function (cwd) {
      return function __do() {
          ...
          return Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($48) {
              return Data_Int.fromNumber(Global.readInt(10)($48));
          })(v);
      };
  };
              ...
              return Control_Monad_Aff.makeAff(function (err) {
                  return function (succ) {
                      return Node_ChildProcess.execFile(bin)([ "--version" ])((function () {
                          var $38 = {};
                          for (var $39 in Node_ChildProcess.defaultExecOptions) {
                              if ({}.hasOwnProperty.call(Node_ChildProcess.defaultExecOptions, $39)) {
                                  $38[$39] = Node_ChildProcess["defaultExecOptions"][$39];
                              };
                          };
                          $38.env = v.env;
                          return $38;
              ...
              return function (port) {
                  return function (res) {
                      var range = function (v) {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 95, column 3 - line 95, column 54: " + [ v.constructor.name ]);
                      };
                      var result = function (errorType) {
                          return function (v) {
                              var fixes = function (v1) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 120, column 5 - line 120, column 137: " + [ v1.constructor.name ]);
                              };
                              ...
                              return function __do() {
                                  ...
                                  var editor$prime = (function () {
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 102, column 19 - line 102, column 60: " + [ v1.constructor.name ]);
                                  })();
                                  ...
                                  return {
                                      ...
                                      icon: Data_Nullable.toNullable((function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 116, column 28 - line 117, column 7: " + [ $53.constructor.name ]);
                                      })()), 
                                      solutions: solutions
                                  };
                              };
                  ...
                  var gotPath = function (port) {
                      return function (workingDir) {
                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 146, column 15 - line 153, column 43: " + [ $28.constructor.name ]);
                          })());
                      };
                  };
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(PscIde_Server.getSavedPort(rootPath)))(function (v) {
                          ...
                          return function (logCb) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(IdePurescript_Exec.getPathVar(addNpmBin)(path)))(function (v) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v)(server))(function (v1) {
                                              ...
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v2) {
                                                  ...
                                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v1) > 1)(cb(Warning.value)("Found multiple psc-ide-server executables; using " + $60.value0.value0))))(function () {
                                                      var glob$prime = (function () {
                                                          ...
                                                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 98, column 19 - line 98, column 104: " + [ $64.constructor.name ]);
                                                      })();
                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer($60.value0.value0)(path)(glob$prime)(usePurs))(function (v2) {
                                                          var noRes = {
                                                              quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                                              port: Data_Maybe.Nothing.value
                                                          };
                                                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                              ...
                                                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 101, column 17 - line 115, column 142: " + [ v2.constructor.name ]);
                                                          })());
                                                      });
                                                  });
                                              });
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 88, column 3 - line 115, column 142: " + [ $60.constructor.name ]);
                                  });
                              });
                          };
                      };
  ...
  var startServer = function (path) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Atom.getAtom))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pursExe"))))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readArray)(Atom_Config.getConfig(v.config)("ide-purescript.pscSourceGlob"))))(function (v3) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readBoolean)(Atom_Config.getConfig(v.config)("ide-purescript.useCombinedExe"))))(function (v4) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readBoolean)(Atom_Config.getConfig(v.config)("ide-purescript.addNpmPath"))))(function (v5) {
                              var srcGlob$prime = Data_Bifunctor.rmap(Data_Either.bifunctorEither)(Data_Array.mapMaybe(function ($17) {
                                  return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Control_Monad_Except.runExcept(Data_Foreign.readString($17)));
                              }))(Control_Monad_Except.runExcept(v3));
                              ...
                              var usePurs$prime = Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn))(Control_Monad_Except.runExcept(v4));
                              var addNpmPath$prime = Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn))(Control_Monad_Except.runExcept(v5));
                              var server = (function () {
                                  if (usePurs$prime) {
                                      return Data_Either.either(Data_Function["const"]("purs"))(Control_Category.id(Control_Category.categoryFn))(Control_Monad_Except.runExcept(v2));
                                  };
                                  if (!usePurs$prime) {
                                      return Data_Either.either(Data_Function["const"]("psc-ide-server"))(Control_Category.id(Control_Category.categoryFn))(Control_Monad_Except.runExcept(v1));
                                  };
                                  throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 70, column 16 - line 73, column 75: " + [ usePurs$prime.constructor.name ]);
                              })();
                              return IdePurescript_PscIdeServer["startServer'"](path)(server)(addNpmPath$prime)(usePurs$prime)(glob)(notify(v.notifications))(logMsg);
                          });
                      });
                  });
              });
