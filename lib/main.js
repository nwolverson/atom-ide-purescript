...
(function(exports) {
  ...
  var setText = function ($2) {
      return Data_Function_Eff.runEffFn1($foreign.setTextImpl($2));
  };
  ...
  var foldableList = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return Data_Foldable.foldl(foldableList)(function (acc) {
              return function ($366) {
                  return Prelude.append(dictMonoid["__superclass_Prelude.Semigroup_0"]())(acc)(f($366));
              };
...
(function(exports) {
  ...
  var linterBuild = function (v) {
      var range = function (v1) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 50, column 3 - line 51, column 3: " + [ v1.constructor.name ]);
      };
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Build.build({
          ...
          return Prelude.pure(Control_Monad_Aff.applicativeAff)({
              ...
              result: resultToString((function () {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 46, column 13 - line 47, column 3: " + [ v1.success.constructor.name ]);
              })())
          });
      });
  };
...
(function(exports) {
  ...
  var getSuggestions = function (v) {
      var suggestionTypeAtomValue = function (s) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 74, column 33 - line 80, column 5: " + [ s.constructor.name ]);
      };
          ...
          return function (v1) {
              var suggestType = (function () {
                  ...
                  if (!$12) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 106, column 16 - line 107, column 16: " + [ $13.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 105, column 11 - line 107, column 16: " + [ $12.constructor.name ]);
              })();
              return {
                  text: v1.identifier, 
      ...
      if (parsed instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 56, column 7 - line 63, column 5: " + [ moduleCompletion.constructor.name ]);
      };
      if (parsed instanceof Data_Maybe.Nothing) {
          return Prelude["return"](Control_Monad_Aff.applicativeAff)([  ]);
      };
      throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 54, column 6 - line 64, column 3: " + [ parsed.constructor.name ]);
  };
...
(function(exports) {
          ...
          return function (action) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($foreign.tmpDir))(function (v) {
                  var name = Data_String_Regex.replace(Data_String_Regex.regex("[\\/\\\\]")((function () {
                      var $11 = {};
                      for (var $12 in Data_String_Regex.noFlags) {
                          if (Data_String_Regex.noFlags.hasOwnProperty($12)) {
                              $11[$12] = Data_String_Regex.noFlags[$12];
                          };
                      };
                      $11.global = true;
                      return $11;
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(tmpFile)(text))(function () {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(action(tmpFile))(function (v1) {
                          if (v1 instanceof Data_Either.Right && v1.value0 instanceof PscIde_Command.SuccessFile) {
                              return Prelude["<$>"](Control_Monad_Aff.functorAff)(Data_Maybe.Just.create)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(tmpFile));
                          };
                          return Prelude.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
                      });
                  });
  ...
  var getUnqualActiveModules = function (v) {
      return Prelude.map(Prelude.functorArray)(getModuleName)(Prelude["++"](Prelude.semigroupArray)(Data_Maybe.maybe([  ])(function ($48) {
          return Data_Array.singleton(Unqualified.create($48));
      })(v.main))(v.modules));
  };
  var getMainModule = function (text) {
      var regex = Data_String_Regex.regex("module\\s+([\\w.]+)")((function () {
          var $31 = {};
          for (var $32 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($32)) {
                  $31[$32] = Data_String_Regex.noFlags[$32];
              };
          };
          $31.multiline = true;
          return $31;
      })());
      var $33 = Data_String_Regex.match(regex)(text);
      if ($33 instanceof Data_Maybe.Just && ($33.value0.length === 2 && $33.value0[1] instanceof Data_Maybe.Just)) {
          return new Data_Maybe.Just(($33.value0[1]).value0);
      };
      return Data_Maybe.Nothing.value;
  };
  ...
  var addModuleImport = function (fileName) {
      return function (text) {
          return function (moduleName) {
              return withTempFile(fileName)(text)(function (tmpFile) {
                  return PscIde.implicitImport(tmpFile)(new Data_Maybe.Just(tmpFile))([  ])(moduleName);
              });
          };
      };
  };
  var addExplicitImport = function (fileName) {
      return function (text) {
          return function (moduleName) {
              return function (identifier) {
                  var filters = (function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Modules line 107, column 15 - line 109, column 48: " + [ moduleName.constructor.name ]);
                  })();
                  return withTempFile(fileName)(text)(function (tmpFile) {
...
(function(exports) {
  ...
  var Atom_Editor = PS["Atom.Editor"];
  var Atom_CommandRegistry = PS["Atom.CommandRegistry"];        
  var addPromptPanel = Control_Monad_Aff.makeAff(function (err) {
      return function (succ) {
          return function __do() {
              var v = Atom_Atom.getAtom();
              ...
              var v3 = DOM_Node_Document.createTextNode("Select Type:")(v1)();
              ...
              var close = function (isSucc) {
                  return function (v6) {
                      return function __do() {
                          var v7 = $foreign.getEditorModel(v4)();
                          var v8 = Atom_Editor.getText(v7)();
                          Atom_Workspace.destroyPanel(v5)();
                          return succ((function () {
                              if (isSucc) {
                                  return new Data_Maybe.Just(v8);
                              };
                              if (!isSucc) {
                                  return Data_Maybe.Nothing.value;
                              };
                              throw new Error("Failed pattern match at IdePurescript.Atom.PromptPanel line 48, column 15 - line 48, column 52: " + [ isSucc.constructor.name ]);
                          })())();
                      };
                  };
              };
...
(function(exports) {
  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 71, column 3 - line 79, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($70.editor instanceof Data_Maybe.Just && ($70.linter instanceof Data_Maybe.Just && $70.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($70.editor.value0)($70.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      ...
      var doLint = function __do() {
          ...
          if ($89.root instanceof Data_Maybe.Just && ($89.linterIndie instanceof Data_Maybe.Just && $89.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($89.root.value0)($89.linterIndie.value0)($89.statusElt.value0))(function (v10) {
      ...
      var addImport = function (moduleName) {
          return function __do() {
              ...
              if (v7 instanceof Data_Maybe.Just) {
                  ...
                  var v9 = Atom_Editor.getPath(v7.value0)();
                  return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v9)(v8)(moduleName))(function (v10) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($133) {
                          return Prelude["void"](Control_Monad_Eff.functorEff)(Atom_Editor.setText(v7.value0)($133));
                      })(v10));
                  }))();
              };
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 188, column 7 - line 197, column 5: " + [ v7.constructor.name ]);
          };
      };
              ...
              return function (editor) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getText(editor)))(function (v7) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getPath(editor)))(function (v8) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addExplicitImport(v8)(v7)(moduleName)(ident))(function (v9) {
                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function (out) {
                                  return function __do() {
                                      var v10 = Atom_Editor.getBuffer(editor)();
                                      return Prelude["void"](Control_Monad_Eff.functorEff)(Atom_TextBuffer.setTextViaDiff(v10)(out))();
                                  };
                              })(v9));
                          });
                      });
      ...
      var addSuggestionImport = function (v7) {
          if (v7.suggestion.addImport instanceof Data_Maybe.Just) {
      ...
      var addExplicitImportCmd = Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PromptPanel.addPromptPanel)(function (v7) {
          return Data_Maybe.maybe(Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.unit))(addIdentImport(Data_Maybe.Nothing.value))(v7);
      }));
          ...
          provideAutocomplete: function (v7) {
              return {
                  ...
                  onDidInsertSuggestion: Data_Function_Eff.mkEffFn1(function (x) {
                      return Control_Monad_Aff.runAff(raiseError)(ignoreError)(addSuggestionImport(x));
                  })
              };
          }
      };
