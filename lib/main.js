  ...
  var toLintResult = function (res) {
      ...
      return {
          ...
          result: resultToString((function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 68, column 13 - line 68, column 69: " + [ res.success.constructor.name ]);
          })())
      };
  };
 ...
 */  
  ...
  var replaceAnsiColor = function (text) {
      ...
      var colEscape = function (text1) {
          var $63 = IdePurescript_Regex["match'"](Data_String_Regex.regex("\\x1b\\[([0-9]+)m")(Data_String_Regex_Flags.noFlags))(text1);
...
(function(exports) {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  var $81 = v.activatedManually || autoCompleteAllModules;
                                  if ($81) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 75, column 14 - line 75, column 136: " + [ $81.constructor.name ]);
                              })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($120.editor instanceof Data_Maybe.Just && ($120.linter instanceof Data_Maybe.Just && $120.n > 0)) {
              return withPort(function (port) {
                  return IdePurescript_Atom_QuickFixes.showQuickFixes(port)(v2)($120.editor.value0)($120.linter.value0)(v9);
              })();
          };
          return Data_Unit.unit;
      };
          ...
          return function __do() {
              ...
              var v12 = (function () {
                  ...
                  if (v11 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function ($165) {
                          return Control_Monad_Maybe_Trans.MaybeT(PscIde_Project.getRoot($165));
                      }));
                  };
      ...
      return Data_Foreign.toForeign({
          ...
          provideAutocomplete: function (v9) {
              return {
