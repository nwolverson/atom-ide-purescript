...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      var raiseError = function (e) {
          return function __do() {
              var v = Atom_Atom.getAtom();
              Control_Monad_Eff_Console.error(Data_Show.show(Control_Monad_Eff_Exception.showError)(e))();
              return Atom_NotificationManager.addError(v.notifications)(Data_Show.show(Control_Monad_Eff_Exception.showError)(e))();
          };
      };
      return function ($82) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function["const"](Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($82));
      };
  })();
              ...
              return function __do() {
                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      ...
                      if (v4 instanceof Data_Maybe.Just) {
                          return launchAffAndRaise(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v2)(port)(v4.value0)(v3)(moduleName))(function (v5) {
                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($83) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Imports line 107, column 7 - line 112, column 29: " + [ v4.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Imports line 102, column 3 - line 112, column 29: " + [ v1.constructor.name ]);
              };
          };
      };
  };
      ...
      return function (modulesState) {
          return launchAffAndRaise(Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffM(Atom_Atom.getAtom))(function (v) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffM(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Imports line 55, column 3 - line 61, column 25: " + [ v1.constructor.name ]);
              });
          }));
      };
  };
      ...
      autocomplete: {
          ...
          properties: {
              ...
              excludeLowerPriority: {
                  ...
                  description: "Whether to set the excludeLowerPriority flag for autocomplete+: disable this to see plain-text suggestions from context, for example.", 
                  type: "boolean", 
                  "default": true
              }
          }
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var activate = function __do() {
          ...
          cmd("pursuit-search-modules")(withPort(function (port) {
              return IdePurescript_Atom_Search.pursuitSearchModule(port)(v2);
          }))();
          cmd("add-module-import")(withPort(function (port) {
              return IdePurescript_Atom_Imports.addModuleImportCmd(port)(v2);
          }))();
          cmd("add-explicit-import")(withPort(function (port) {
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Atom_Editor.getPath(v9)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(getPort(v10)))(function (v11) {
                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))((function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 285, column 19 - line 289, column 39: " + [ v11.constructor.name ]);
                          })());
                      });
                  });
              })));
      ...
      return Data_Foreign.toForeign({
          ...
          provideAutocomplete: Data_Function_Eff.mkEffFn1(function (v9) {
              return function __do() {
                  Control_Monad_Eff_Console.log("provideAutocomplete called")();
                  ...
                  Control_Monad_Eff_Console.log("excludeLowerPriority set to: " + Data_Show.show(Data_Show.showBoolean)(v10))();
                  return {
