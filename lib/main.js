...
(function(exports) {
          ...
          return function (action) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($foreign.tmpDir))(function (v) {
                  var name = Data_String_Regex.replace(Data_String_Regex.regex("[\\/\\\\]")((function () {
                      var $13 = {};
                      for (var $14 in Data_String_Regex.noFlags) {
                          if (Data_String_Regex.noFlags.hasOwnProperty($14)) {
                              $13[$14] = Data_String_Regex.noFlags[$14];
                          };
                      };
                      $13.global = true;
                      return $13;
  ...
  var getModuleName = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Modules line 34, column 1 - line 35, column 1: " + [ v.constructor.name ]);
  };
  ...
  var getUnqualActiveModules = function (v) {
      return Prelude.map(Prelude.functorArray)(getModuleName)(Prelude["++"](Prelude.semigroupArray)(Data_Maybe.maybe([  ])(function ($56) {
          return Data_Array.singleton(Unqualified.create($56));
      })(v.main))(v.modules));
  };
  var getMainModule = function (text) {
      var regex = Data_String_Regex.regex("module\\s+([\\w.]+)")((function () {
          var $36 = {};
          for (var $37 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($37)) {
                  $36[$37] = Data_String_Regex.noFlags[$37];
              };
          };
          $36.multiline = true;
          return $36;
      })());
      var $38 = Data_String_Regex.match(regex)(text);
      if ($38 instanceof Data_Maybe.Just && ($38.value0.length === 2 && $38.value0[1] instanceof Data_Maybe.Just)) {
          return new Data_Maybe.Just(($38.value0[1]).value0);
      };
      return Data_Maybe.Nothing.value;
  };
  var getModulesForFile = function (file) {
      return function (fullText) {
          var mod = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Modules line 59, column 3 - line 60, column 3: " + [ v.constructor.name ]);
          };
          ...
          return function (moduleName) {
              return function (identifier) {
                  var filters = (function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Modules line 114, column 15 - line 116, column 48: " + [ moduleName.constructor.name ]);
                  })();
      ...
      return Control_Monad_Aff.makeAff(function (err) {
          return function (succ) {
              return function __do() {
                  ...
                  var v6 = Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)($foreign.getActiveElement)();
                  $foreign.focus(v4)();
                  var close = function (isSucc) {
                      return function (v7) {
                          return function __do() {
                              var v8 = $foreign.getEditorModel(v4)();
                              var v9 = Atom_Editor.getText(v8)();
                              Atom_Workspace.destroyPanel(v5)();
                              Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))($foreign.focus)(v6)();
                              return succ((function () {
                                  if (isSucc) {
                                      return new Data_Maybe.Just(v9);
                                  };
                                  if (!isSucc) {
                                      return Data_Maybe.Nothing.value;
                                  };
                                  throw new Error("Failed pattern match at IdePurescript.Atom.PromptPanel line 53, column 15 - line 53, column 55: " + [ isSucc.constructor.name ]);
                              })())();
                          };
                      };
                  };
  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 72, column 3 - line 80, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($73.editor instanceof Data_Maybe.Just && ($73.linter instanceof Data_Maybe.Just && $73.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($73.editor.value0)($73.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      ...
      var doLint = function __do() {
          ...
          if ($92.root instanceof Data_Maybe.Just && ($92.linterIndie instanceof Data_Maybe.Just && $92.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($92.root.value0)($92.linterIndie.value0)($92.statusElt.value0))(function (v10) {
          ...
          return function __do() {
              ...
              if (v7 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v9)(v8)(moduleName))(function (v10) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($146) {
                          return Prelude["void"](Control_Monad_Eff.functorEff)(Atom_Editor.setText(v7.value0)($146));
                      })(v10));
                  }))();
              };
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 198, column 7 - line 207, column 5: " + [ v7.constructor.name ]);
          };
      };
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getText(editor)))(function (v7) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Editor.getPath(editor)))(function (v8) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addExplicitImport(v8)(v7)(moduleName)(ident))(function (v9) {
                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                  if (v9 instanceof IdePurescript_Modules.UpdatedImports) {
                                      return function __do() {
                                          var v10 = Atom_Editor.getBuffer(editor)();
                                          return Prelude["void"](Control_Monad_Eff.functorEff)(Atom_TextBuffer.setTextViaDiff(v10)(v9.value0))();
                                      };
                                  };
                                  if (v9 instanceof IdePurescript_Modules.AmbiguousImport) {
                                      return IdePurescript_Atom_SelectView.selectListViewStatic(view)(addImp)(Data_Maybe.Nothing.value)(Prelude["<$>"](Prelude.functorArray)(runCompletion)(v9.value0));
                                  };
                                  return Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit);
                              })());
                          });
      ...
      var addExplicitImportCmd = Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PromptPanel.addPromptPanel("Identifier"))(function (v7) {
