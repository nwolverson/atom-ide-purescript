...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var v1 = Control_Monad_Eff_Uncurried.runEffFn1(IdePurescript_Atom_Hooks_LanguageClient.makeLanguageClient)(Control_Monad_Eff_Uncurried.mkEffFn1(function (conn) {
          ...
          return function __do() {
              ...
              return fwdCmd("stop-psc-ide")("stopPscIde")();
          };
      }))();
      var v2 = Control_Monad_Eff_Ref.newRef(Data_Maybe.Nothing.value)();
      return Data_Foreign.toForeign(v1);
  };
