...
(function(exports) {
  ...
  var encodePursuitType = new Data_Argonaut_Encode.EncodeJson(function ($110) {
      return Data_Argonaut_Encode.encodeJson(Data_Argonaut_Encode.encodeJsonJString)(Prelude.show(showPursuitType)($110));
  });
  ...
  var encodeImportCommand = new Data_Argonaut_Encode.EncodeJson(function (v) {
      ...
      throw new Error("Failed pattern match at PscIde.Command line 156, column 3 - line 160, column 3: " + [ v.constructor.name ]);
  });
  ...
  var decodeMessage = new Data_Argonaut_Decode.DecodeJson(function (json) {
      return Data_Maybe.maybe(new Data_Either.Left("Message not string"))(function ($111) {
  ...
  var encodeCommand = new Data_Argonaut_Encode.EncodeJson(function (v) {
      ...
      if (v instanceof Type) {
          return commandWrapper(Data_Argonaut_Encode.encodeJsonJson)("type")(Data_Argonaut_Combinators["~>"](Data_Argonaut_Encode.encodeJsonJson)(Data_Argonaut_Combinators[":="](Data_Argonaut_Encode.encodeJsonJson)("search")(Data_Argonaut_Encode.encodeJson(Data_Argonaut_Encode.encodeJsonJString)(v.value0)))(Data_Argonaut_Combinators["~>"](Data_Argonaut_Encode.encodeJsonJson)(Data_Argonaut_Combinators[":="](Data_Argonaut_Encode.encodeJsonJson)("filters")(Data_Argonaut_Encode.encodeJson(Data_Argonaut_Encode.encodeJsonArray(encodeFilter))(v.value1)))(Data_Argonaut_Combinators["~>"](Data_Argonaut_Encode.encodeJsonJson)(Data_Argonaut_Combinators[":="](Data_Argonaut_Encode.encodeJsonJson)("currentModule")(Data_Argonaut_Encode.encodeJson(Data_Argonaut_Encode.encodeJsonMaybe(Data_Argonaut_Encode.encodeJsonJString))(v.value2)))(Data_Argonaut_Core.jsonEmptyObject))));
      };
...
(function(exports) {
                  ...
                  return function (command) {
                      return Control_Monad_Aff.makeAff(function (err) {
                          return function (succ) {
                              return $foreign.send(Prelude.show(Data_Argonaut_Core.showJson)(Data_Argonaut_Encode.encodeJson(dictEncodeJson)(command)))(port)(function ($6) {
      ...
      return function (dictDecodeJson) {
          return function (port) {
              return function (command) {
                  return Control_Monad_Aff.makeAff(function (err) {
                      return function (succ) {
                          return $foreign.send(Prelude.show(Data_Argonaut_Core.showJson)(Data_Argonaut_Encode.encodeJson(dictEncodeJson)(command)))(port)(function ($7) {
                              return succ(Control_Bind.join(Data_Either.bindEither)(PscIde_Command.unwrapResponse(Data_Argonaut_Decode.decodeJsonString)(dictDecodeJson)($7)));
                          })(err);
                      };
                  });
              };
  ...
  var type$prime = function (port) {
      return function (s) {
          return function (fs) {
              return function (mod) {
                  return sendCommand(PscIde_Command.encodeCommand)(Data_Argonaut_Decode.decodeArray(PscIde_Command.decodeCompletion))(port)(new PscIde_Command.Type(s, fs, mod));
              };
          };
      };
  };
  ...
  var complete = function (port) {
      return function (fs) {
          return function (m) {
              return function (mod) {
                  return sendCommand(PscIde_Command.encodeCommand)(Data_Argonaut_Decode.decodeArray(PscIde_Command.decodeCompletion))(port)(new PscIde_Command.Complete(fs, m, mod));
              };
          };
      };
  };
                  ...
                  return function (moduleCompletion) {
                      return function (unqualModules) {
                          return function (getQualifiedModule) {
                              ...
                              return Prelude["<$>"](Control_Monad_Aff.functorAff)(conv)(eitherToErr(PscIde.complete(port)(Data_Array[":"](new PscIde_Command.PrefixFilter(prefix))(moduleFilters(mods)))(Data_Maybe.Nothing.value)(currentModule)));
                          };
                      };
                  };
              };
              ...
              return function (modulePrefix) {
                  return function (unqualModules) {
                      return function (getQualifiedModule) {
                          ...
                          return result(conv)(PscIde["type'"](port)(text)(moduleFilters(mods))(currentModule));
                      };
                  };
              };
          };
  ...
  var getSuggestions = function (port) {
      return function (v) {
                      ...
                      return {
                          ...
                          addImport: new Data_Maybe.Just({
                              ...
                              qualifier: (function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 110, column 55 - line 110, column 107: " + [ $17.constructor.name ]);
                              })()
                          })
                      };
                  };
          ...
          if (parsed instanceof Data_Maybe.Just) {
              ...
              if (!moduleCompletion) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getCompletion(port)(parsed.value0.token)(v.moduleInfo.mainModule)(parsed.value0.mod)(moduleCompletion)(v.moduleInfo.modules)(v.moduleInfo.getQualifiedModule))(function (v1) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 60, column 7 - line 67, column 5: " + [ moduleCompletion.constructor.name ]);
          };
          if (parsed instanceof Data_Maybe.Nothing) {
              return Prelude["return"](Control_Monad_Aff.applicativeAff)([  ]);
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 58, column 6 - line 68, column 3: " + [ parsed.constructor.name ]);
      };
  };
  ...
  var addModuleImport = function (state) {
      return function (port) {
          return function (fileName) {
              return function (text) {
                  return function (moduleName) {
                      var shouldAdd = Prelude["/="](Data_Maybe.eqMaybe(Prelude.eqString))(state.main)(new Data_Maybe.Just(moduleName)) && Data_Foldable.notElem(Data_Foldable.foldableArray)(moduleEq)(new Implicit(moduleName))(state.modules);
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(getToken(v1.value0)(pos)))(function (v2) {
                              if (v2 instanceof Data_Maybe.Just) {
                                  ...
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getType(port)(v2.value0.word)(state.main)(prefix)(IdePurescript_Modules.getUnqualActiveModules(state)(new Data_Maybe.Just(v2.value0.word)))(Prelude.flip(IdePurescript_Modules.getQualModule)(state)))(function (v3) {
                                      return Prelude.pure(Control_Monad_Aff.applicativeAff)({
                  ...
                  return Prelude.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Maybe_Trans.MaybeT(liftEff$prime$prime(Atom_Workspace.getActiveTextEditor(v.workspace))))(function (v2) {
                      return Prelude.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(liftEff$prime$prime(IdePurescript_Atom_Editor.getLinePosition(v2))))(function (v3) {
                          return Prelude.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Maybe_Trans.MaybeT(liftEff$prime$prime(IdePurescript_Atom_Tooltips.getToken(v2)(v3.pos))))(function (v4) {
                              return Prelude.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(liftEff$prime$prime(Control_Monad_Eff_Ref.readRef(modulesState))))(function (v5) {
                                  return Prelude.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff)(IdePurescript_PscIde.eitherToErr(PscIde_1.suggestTypos(v1)(v4.word)(2)(v5.main))))(function (v6) {
                                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Aff.monadEffAff))(IdePurescript_Atom_SelectView.selectListViewStatic(view)(replaceTypo(v1)(v2)(v4.range))(Data_Maybe.Nothing.value)(Prelude["<$>"](Prelude.functorArray)(runCompletion)(v6)));
                                  });
                              });
                          });
                      });
...
(function(exports) {
  ...
  var parseSuggestion = Data_Maybe.maybe(Prelude.pure(Data_Either.applicativeEither)(Data_Maybe.Nothing.value))(function (obj) {
      return Prelude.bind(Data_Either.bindEither)(Data_Argonaut_Combinators[".?"](Data_Argonaut_Decode.decodeJsonString)(obj)("replacement"))(function (v) {
          return Prelude.bind(Data_Either.bindEither)(Prelude.pure(Data_Either.applicativeEither)(Data_Either.either(Prelude["const"](Data_Maybe.Nothing.value))(Prelude.id(Prelude.categoryFn))(Prelude[">>="](Data_Either.bindEither)(Data_Argonaut_Combinators[".?"](Data_Argonaut_Decode.decodeJsonMaybe(Data_Argonaut_Decode.decodeStrMap(Data_Argonaut_Decode.decodeJsonJson)))(obj)("replaceRange"))(parsePosition))))(function (v1) {
              return Prelude.pure(Data_Either.applicativeEither)(new Data_Maybe.Just({
                  replacement: v, 
                  replaceRange: v1
              }));
          });
  ...
  var parsePscOutput = Control_Bind["<=<"](Data_Either.bindEither)(function ($17) {
...
(function(exports) {
  ...
  var fixPosition = Prelude.id(Prelude.categoryFn);
  var toLintResult = function (res) {
      var range = function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 62, column 3 - line 63, column 3: " + [ v.constructor.name ]);
      };
              ...
              var replace = function (v1) {
                  if (v1 instanceof Data_Maybe.Just) {
                      return {
                          ...
                          hasSuggestion: true, 
                          range: range(Data_Maybe.maybe(Prelude["<$>"](Data_Maybe.functorMaybe)(fixPosition)(v.position))(Data_Maybe.Just.create)(v1.value0.replaceRange))
                      };
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 83, column 5 - line 88, column 5: " + [ v1.constructor.name ]);
              };
              return {
                  type: errorType, 
                  text: v.message, 
                  ...
                  range: range(Prelude["<$>"](Data_Maybe.functorMaybe)(fixPosition)(v.position)), 
                  multiline: true, 
      ...
      return {
          ...
          result: resultToString((function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 58, column 13 - line 59, column 3: " + [ res.success.constructor.name ]);
          })())
      };
  };
...
(function(exports) {
  ...
  var xtermColor = function (c) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 131, column 16 - line 150, column 1: " + [ c.constructor.name ]);
  };
  var renderRgbCss = function (v) {
      return "rgb(" + (Prelude.show(Prelude.showInt)(v.value0) + ("," + (Prelude.show(Prelude.showInt)(v.value1) + ("," + (Prelude.show(Prelude.showInt)(v.value2) + ")")))));
  };
  ...
  var replaceAnsiColor = function (text) {
      var parts = Data_String_Regex.split(Data_String_Regex.regex("(\\x1b\\[[0-9;]+m)")(Data_String_Regex.noFlags))(text);
      var colorCss = function (n) {
          return "color: " + Data_Maybe.maybe("black")(function ($130) {
              return renderRgbCss(xtermColor($130));
          })(colorForCode(n));
      };
      var colEscape = function (text1) {
          var $60 = Data_String_Regex.match(Data_String_Regex.regex("\\x1b\\[([0-9]+)m")(Data_String_Regex.noFlags))(text1);
      ...
      var toNodes = function (v) {
          ...
          if (Prelude["=="](Data_Maybe.eqMaybe(Prelude.eqInt))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array["!!"](v)(2)))(new Data_Maybe.Just(0)) && Data_Maybe.isJust(Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array["!!"](v)(0)))) {
              var $66 = Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array["!!"](v)(0));
              var $67 = Data_Array["!!"](v)(1);
          ...
          var text1 = Data_Maybe.fromMaybe("")(Data_Array["!!"](v)(0));
          return function __do() {
              var v1 = createElement$prime("span")();
  ...
  var clearText = function (v) {
      ...
      return Control_Monad_Eff.whileE(DOM_Node_Node.hasChildNodes(node))(function __do() {
          ...
          return Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($131) {
              return Prelude["void"](Control_Monad_Eff.functorEff)(Prelude.flip(DOM_Node_Node.removeChild)(node)($131));
          })(v1)();
      });
  };
  var appendText = function (v) {
      return function (text) {
          return function __do() {
              ...
              Prelude[">>="](Control_Monad_Eff.bindEff)(replaceAnsiColor(text))(Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(function (node) {
                  ...
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(function __do() {
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.psciCommand"))))(function (v2) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Atom_LinterBuild.getProjectRoot))(function (v3) {
                              var command = Data_Either.either(Prelude["const"]([  ]))(function ($132) {
                                  return Data_String_Regex.split(Data_String_Regex.regex("\\s+")(Data_String_Regex.noFlags))(Data_String.trim($132));
                              })(v2);
                              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime((function () {
                                  var $94 = Data_Array.uncons(command);
                                  if (v3 instanceof Data_Maybe.Just && $94 instanceof Data_Maybe.Just) {
                                      return Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn($94.value0.head)($94.value0.tail)((function () {
                                          var $95 = {};
                                          for (var $96 in Node_ChildProcess.defaultSpawnOptions) {
                                              if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($96)) {
                                                  $95[$96] = Node_ChildProcess.defaultSpawnOptions[$96];
                                              };
                                          };
                                          $95.cwd = v3;
                                          return $95;
                                  ...
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($133) {
                                      return Control_Monad_Eff_Ref.writeRef(psciRef)(Data_Maybe.Just.create($133));
                                  })(v4)))(function () {
                                      return liftEff$prime$prime(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function (proc) {
                                          return Control_Monad_Eff_Exception.catchException(Prelude["const"](Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit)))(function __do() {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 267, column 5 - line 279, column 3: " + [ v5.constructor.name ]);
                                          });
                                      })(v4));
                                  });
                              });
  ...
  var activate = function __do() {
      ...
      var close = function __do() {
          ...
          if (v3 instanceof Data_Maybe.Just && v4 instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 299, column 13 - line 302, column 11: " + [ v5.constructor.name ]);
          };
          return Prelude.unit;
      };
          ...
          return function (name) {
              return function (action) {
                  var scope = (function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 322, column 23 - line 323, column 3: " + [ isEditor.constructor.name ]);
                  })();
...
(function(exports) {
  ...
  var stopServer = function (port) {
      return Prelude["void"](Control_Monad_Aff.functorAff)(PscIde.quit(port));
  };
          ...
          return Control_Monad_Aff.makeAff(function (err) {
              return function (succ) {
                  return Node_ChildProcess.execFile(exe1)([ "--version" ])(Node_ChildProcess.defaultExecOptions)(function (v) {
                      return Data_Maybe.maybe(Prelude[">>="](Control_Monad_Eff.bindEff)(Node_Buffer_1.readString(Node_Encoding.UTF8.value)(0)(100)(v.stdout))(succ))(err)(v.error);
                  });
              };
          });
      };
      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Alt["<|>"](Control_Monad_Aff.altAff)(Node_Which.which(exe))(Prelude.pure(Control_Monad_Aff.applicativeAff)([  ])))(function (v) {
          return Data_Traversable["for"](Control_Monad_Aff.applicativeAff)(Data_Traversable.traversableArray)(v)(function (exe1) {
              return Prelude["<$>"](Control_Monad_Aff.functorAff)(Prelude["<$>"](Prelude.functorFn)(Executable.create(exe1))(Data_Either.either(Prelude["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)))(Control_Monad_Aff.attempt(getVersion(exe1)));
          });
      });
  };
          ...
          return function (rootPath) {
              var launchServer = (function () {
                  var r = function (v) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 33, column 7 - line 34, column 7: " + [ v.constructor.name ]);
                  };
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Starting psc-ide-server")))(function () {
                      return Prelude["<$>"](Control_Monad_Aff.functorAff)(r)(PscIde_Server.startServer(exe)(port)(new Data_Maybe.Just(rootPath)));
                  });
              })();
              var gotPath = function (workingDir) {
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 38, column 5 - line 48, column 1: " + [ $5.constructor.name ]);
                  })());
              };
              ...
              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Foreign.readInt)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdePort"))))(function (v2) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v3) {
                      ...
                      if ($13.portRaw instanceof Data_Either.Right && ($13.serverRaw instanceof Data_Either.Right && $13.path instanceof Data_Maybe.Just)) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(PscIde_Server.findBins($13.serverRaw.value0))(function (v4) {
                              var $15 = Data_Array.head(v4);
                              if ($15 instanceof Data_Maybe.Nothing) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(Node_Process.lookupEnv("PATH")))(function (v5) {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(Atom_NotificationManager.addError(v.notifications)("Couldn't find psc-ide-server, check PATH. Looked for: " + ($13.serverRaw.value0 + (" in PATH: " + Data_Maybe.fromMaybe("")(v5))))))(function () {
                              ...
                              if ($15 instanceof Data_Maybe.Just) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Resolved psc-ide-server:")))(function () {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v5) {
                                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(v5.value0 + (": " + Data_Maybe.fromMaybe("ERROR")(v5.value1))));
                                      })(v4))(function () {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad.when(Control_Monad_Eff.monadEff)(Data_Array.length(v4) > 1)(Atom_NotificationManager.addWarning(v.notifications)("Found multiple psc-ide-server executables; using " + $15.value0.value0))))(function () {
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($15.value0.value0)($13.portRaw.value0)($13.path.value0))(function (v5) {
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                      ...
                                                      if (v5 instanceof IdePurescript_PscIdeServer.WrongPath) {
                                                          return Data_Functor["<$"](Control_Monad_Eff.functorEff)(Data_Maybe.Nothing.value)(Atom_NotificationManager.addError(v.notifications)("Found existing psc-ide-server with wrong path: '" + (v5.value0 + "'. Correct, kill or configure a different port, and restart.")));
                                                      };
                                                      if (v5 instanceof IdePurescript_PscIdeServer.Started) {
                                                          return Data_Functor["<$"](Control_Monad_Eff.functorEff)(new Data_Maybe.Just(v5.value0))(Atom_NotificationManager.addSuccess(v.notifications)("Started psc-ide-server"));
                                                      };
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 65, column 26 - line 71, column 13: " + [ v5.constructor.name ]);
                                                  })()))(function (v6) {
                                                      if (v6 instanceof Data_Maybe.Nothing) {
                                                          return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit));
                                                      };
                                                      if (v6 instanceof Data_Maybe.Just) {
                                                          return Prelude.pure(Control_Monad_Aff.applicativeAff)(Control_Monad_Aff.launchAff(IdePurescript_PscIdeServer.stopServer($13.portRaw.value0)(v6.value0)));
                                                      };
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 71, column 13 - line 74, column 5: " + [ v6.constructor.name ]);
                                                  });
                                              });
                                          });
                                      });
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 53, column 9 - line 74, column 5: " + [ $15.constructor.name ]);
                          });
                      };
                      return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit));
                  });
                      ...
                      return function (v1) {
                          if (v1.suggestion.hasSuggestion) {
                              ...
                              if (v1.suggestion.range.length === 2 && ((v1.suggestion.range[0]).length === 2 && (v1.suggestion.range[1]).length === 2)) {
                                  return getFix$prime(Atom_Range.mkRange(Atom_Point.mkPoint(v1.suggestion.range[0][0])(v1.suggestion.range[0][1]))(Atom_Point.mkPoint(v1.suggestion.range[1][0])(v1.suggestion.range[1][1])));
                              };
                              return Data_Maybe.Nothing.value;
                          };
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Atom_Config.getPscIdePort))(function (v3) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v4) {
                              ...
                              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 68, column 14 - line 69, column 3: " + [ $59.constructor.name ]);
                              })())(function (v5) {
