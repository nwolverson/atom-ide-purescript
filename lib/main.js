...
(function(exports) {
          ...
          return Control_Promise_1.fromAff(Prelude.flip(Control_Monad_Error_Class.catchError(Control_Monad_Aff.monadErrorAff))(raiseError$prime([  ]))((function () {
              ...
              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(getPscIdePort))(function (v3) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v4) {
                              ...
                              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                  var $54 = v.activatedManually || autoCompleteAllModules;
                                  if ($54) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 66, column 14 - line 67, column 3: " + [ $54.constructor.name ]);
                              })())(function (v5) {
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($77.editor instanceof Data_Maybe.Just && ($77.linter instanceof Data_Maybe.Just && $77.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes(v2)($77.editor.value0)($77.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      var doLint = function __do() {
          ...
          var v10 = getPscIdePort();
          var $87 = {
              root: v7, 
              linterIndie: v8, 
              statusElt: v9
          };
          if ($87.root instanceof Data_Maybe.Just && ($87.linterIndie instanceof Data_Maybe.Just && $87.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($87.root.value0)($87.linterIndie.value0)($87.statusElt.value0))(function (v11) {
                  ...
                  if (v8 instanceof Data_Maybe.Just && Data_String.contains(".purs")(v8.value0)) {
                      ...
                      return Atom_Editor.onDidSave(editor)(function (v9) {
                          return function __do() {
                              ...
                              return Control_Monad.when(Control_Monad_Eff.monadEff)(Data_Either.either(Prelude["const"](false))(Prelude.id(Prelude.categoryFn))(Data_Foreign.readBoolean(v10)))(doLint)();
                          };
                      })();
                  };
                  return Prelude.unit;
