  ...
  var rebuild = function (port) {
      return function (file) {
          var wrapError = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Build line 74, column 3 - line 82, column 6: " + [ v.constructor.name ]);
          };
          ...
          var onResult = function ($27) {
              ...
              })(Data_Bifunctor.bimap(Data_Either.bifunctorEither)(wrapError)(wrapError)($27));
          };
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(rebuild$prime(port)(file))(function (v) {
              return Data_Either.either(function ($28) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error($28));
              })(function ($29) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(onResult($29));
              })(v);
          });
      };
  };
      ...
      return Data_Function.apply(Control_Monad_Aff.makeAff)(function (err) {
          return function (succ) {
              return function __do() {
                  ...
                  Node_ChildProcess.onError(v1)(function ($30) {
                  ...
                  return Node_ChildProcess.onClose(v1)(function (exit) {
                      if (exit instanceof Node_ChildProcess.Normally && (exit.value0 === 0 || exit.value0 === 1)) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Build line 58, column 7 - line 62, column 5: " + [ $17.constructor.name ]);
                          };
                      };
...
(function(exports) {
      ...
      return function (rootPath) {
          return function (glob) {
              var launchServer = (function () {
                  var r = function (v) {
                      return function (v1) {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 132, column 7 - line 132, column 52: " + [ v.constructor.name, v1.constructor.name ]);
                      };
                  };
              ...
              var gotPath = function (port) {
                  return function (workingDir) {
                      return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 137, column 5 - line 144, column 43: " + [ $35.constructor.name ]);
                      })());
                  };
              };
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(PscIde_Server_1.getSavedPort(rootPath)))(function (v) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 117, column 3 - line 122, column 28: " + [ v.constructor.name ]);
              });
          };
      };
  };
  ...
  var startServer$prime = function (path) {
      return function (server) {
          return function (glob) {
              return function (cb) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_Server_1.findBins(server))(function (v) {
                      var $57 = Data_Array.head(v);
                      if ($57 instanceof Data_Maybe.Nothing) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Node_Process.lookupEnv("PATH")))(function (v1) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Data_Function.apply(cb(Info.value))("Couldn't find psc-ide-server, check PATH. Looked for: " + (server + (" in PATH: " + Data_Maybe.fromMaybe("")(v1))))))(function () {
                                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)({
                      ...
                      if ($57 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Resolved psc-ide-server paths (1st is used):")))(function () {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v1) {
                                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)(v1.value0 + (": " + Data_Maybe.fromMaybe("ERROR")(v1.value1))));
                              })(v))(function () {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v) > 1))(Data_Function.apply(cb(Warning.value))("Found multiple psc-ide-server executables; using " + $57.value0.value0))))(function () {
                                      var glob$prime = (function () {
                                          var $62 = Data_Ord.greaterThanOrEq(Data_Maybe.ordMaybe(ordVersion))(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(parseVersion)(Data_String.trim))($57.value0.value1)))(new Data_Maybe.Just(new Version(0, 9, 2)));
                                          if ($62) {
                                              return glob;
                                          };
                                          if (!$62) {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 92, column 19 - line 92, column 104: " + [ $62.constructor.name ]);
                                      })();
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer($57.value0.value0)(path)(glob$prime))(function (v1) {
                                          var noRes = {
                                              quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                              port: Data_Maybe.Nothing.value
                                          };
                                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                                              if (v1 instanceof CorrectPath) {
                                                  return Data_Functor.voidRight(Control_Monad_Eff.functorEff)({
                                                      quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                                      port: new Data_Maybe.Just(v1.value0)
                                                  })(cb(Info.value)("Found existing psc-ide-server with correct path on port " + Data_Show.show(Data_Show.showInt)(v1.value0)));
                                              };
                                              if (v1 instanceof WrongPath) {
                                                  return function __do() {
                                                      Data_Function.apply(cb($$Error.value))("Found existing psc-ide-server on port '" + (Data_Show.show(Data_Show.showInt)(v1.value0) + ("' with wrong path: '" + (v1.value1 + "'. Correct, kill or configure a different port, and restart."))))();
                                                      return noRes;
                                                  };
                                              };
                                              if (v1 instanceof Started) {
                                                  return function __do() {
                                                      Data_Function.apply(cb(Success.value))("Started psc-ide-server (port " + (Data_Show.show(Data_Show.showInt)(v1.value0) + ")"))();
                                                      return {
                                                          quit: Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(function (v2) {
                                                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                                          })(function (v2) {
                                                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                                          }))(stopServer(v1.value0)(path)(v1.value1))), 
                                                          port: new Data_Maybe.Just(v1.value0)
                                                      };
                                                  };
                                              };
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 95, column 7 - line 108, column 142: " + [ v1.constructor.name ]);
                                          })());
                                      });
                                  });
                              });
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 81, column 3 - line 108, column 142: " + [ $57.constructor.name ]);
                  });
              };
          };
      };
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Atom.getAtom))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readArray)(Atom_Config.getConfig(v.config)("ide-purescript.pscSourceGlob"))))(function (v2) {
                  var srcGlob$prime = Data_Bifunctor.rmap(Data_Either.bifunctorEither)(Data_Function.apply(Data_Array.mapMaybe)(function ($7) {
                      return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Data_Foreign.readString($7));
                  }))(v2);
                  ...
                  return IdePurescript_PscIdeServer["startServer'"](path)(server)(glob)(notify(v.notifications));
              });
          });
      });
  };
