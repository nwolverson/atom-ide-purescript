...
(function(exports) {
  ...
  var resultToString = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 59, column 1 - line 60, column 1: " + [ v.constructor.name ]);
  };
  ...
  var fixPosition = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 63, column 1 - line 65, column 20: " + [ v.constructor.name ]);
  };
                  ...
                  return function (res) {
                      return function (projdir) {
                          var range = function (v) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 96, column 3 - line 96, column 54: " + [ v.constructor.name ]);
                          };
          ...
          return function (glob) {
              return function (usePurs) {
                  ...
                  var launchServer = (function () {
                      var r = function (v) {
                          return function (v1) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 146, column 7 - line 146, column 52: " + [ v.constructor.name, v1.constructor.name ]);
                          };
                      };
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(PscIde_Server.getSavedPort(rootPath)))(function (v) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 131, column 3 - line 136, column 28: " + [ v.constructor.name ]);
                  });
              };
          };
      };
                          ...
                          return function (logCb) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(IdePurescript_Exec.getPathVar(addNpmBin)(path)))(function (v) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v)(server))(function (v1) {
                                                  ...
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v1) > 1)(cb(Warning.value)("Found multiple psc-ide-server executables; using " + v2.value0.value0))))(function () {
                                                      ...
                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer(v2.value0.value0)(path)(glob$prime)(usePurs))(function (v3) {
                                                          ...
                                                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                              ...
                                                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 106, column 17 - line 120, column 142: " + [ v3.constructor.name ]);
                                                          })());
                                                      });
                                                  });
                                              });
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 93, column 3 - line 120, column 142: " + [ v2.constructor.name ]);
                                  });
                              });
                          };
                      };
          ...
          return function __do() {
              ...
              var v9 = (function () {
                  ...
                  if (v8 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function ($140) {
                          return Control_Monad_Maybe_Trans.MaybeT(PscIde_Project.getRoot($140));
                      }));
                  };
