...
(function(exports) {
  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 78, column 3 - line 86, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($103.editor instanceof Data_Maybe.Just && ($103.linter instanceof Data_Maybe.Just && $103.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($103.editor.value0)($103.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      ...
      var doLint = function __do() {
          ...
          if ($125.root instanceof Data_Maybe.Just && ($125.linterIndie instanceof Data_Maybe.Just && $125.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($125.root.value0)($125.linterIndie.value0)($125.statusElt.value0))(function (v10) {
          ...
          return function __do() {
              ...
              if (v7 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v8)(v10)(v9)(moduleName))(function (v11) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($233) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 213, column 7 - line 222, column 5: " + [ v7.constructor.name ]);
          };
      };
      ...
      var addExplicitImportCmd = Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v7) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 171, column 7 - line 179, column 5: " + [ v7.constructor.name ]);
      }));
      var addClause = function __do() {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 261, column 7 - line 269, column 5: " + [ v7.constructor.name ]);
      };
          ...
          return function __do() {
              ...
              Atom_Workspace.observeTextEditors(v.workspace)(function (editor) {
                  return function __do() {
                      ...
                      return Control_Monad.when(Control_Monad_Eff.monadEff)(Data_String.contains(".purs")(v7))(function __do() {
                          useEditor(v2)(editor)();
