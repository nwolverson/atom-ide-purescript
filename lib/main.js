...
(function(exports) {
  ...
  var toLintResult = function (res) {
      var range = function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 74, column 3 - line 74, column 21: " + [ v.constructor.name ]);
      };
      var result = function (errorType) {
          return function (v) {
              var replace = function (v1) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 95, column 5 - line 99, column 8: " + [ v1.constructor.name ]);
              };
              return {
                  type: errorType, 
                  text: v.message, 
      ...
      return {
          ...
          result: resultToString((function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 70, column 30 - line 70, column 69: " + [ res.success.constructor.name ]);
          })())
      };
  };
                              ...
                              return function (msg) {
                                  return function __do() {
                                      ...
                                      return (function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 96, column 8 - line 96, column 43: " + [ $12.constructor.name ]);
                          ...
                          var doBuild = function (buildCmd) {
                              return Control_Monad_Error_Class.catchError(Control_Monad_Aff.monadErrorAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(status(IdePurescript_Atom_BuildStatus.Building.value)(Data_Maybe.Nothing.value)))(function () {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(IdePurescript_Atom_Build.toLintResult)(buildCmd))(function (v) {
                                      return liftEffA(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(function __do() {
                                          ...
                                          status((function () {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 81, column 21 - line 81, column 68: " + [ $16.constructor.name ]);
                          ...
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(Atom_Atom.getAtom))(function (v) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(Atom_Config.getConfig(config)("ide-purescript.buildCommand")))(function (v1) {
                                  var buildCommand = (function () {
                                      var $22 = Data_String_Regex.regex("\\s+")(Data_String_Regex_Flags.noFlags);
                                      var $23 = Control_Monad_Except.runExcept(Data_Foreign.readString(v1));
                                      if ($22 instanceof Data_Either.Right && $23 instanceof Data_Either.Right) {
                                          return Data_String_Regex.split($22.value0)(Data_String.trim($23.value0));
                                      };
                                      return [  ];
                                  })();
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(IdePurescript_Atom_Config.getFastRebuild))(function (v2) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 64, column 3 - line 69, column 20: " + [ fastBuild.constructor.name, $33.constructor.name ]);
                                      });
                                  });
                              });
                          });
