...
(function(exports) {
  ...
  var encodePursuitType = new Data_Argonaut_Encode_Class.EncodeJson(function ($141) {
      return Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Show.show(showPursuitType)($141));
  });
  ...
  var encodeImportCommand = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      ...
      throw new Error("Failed pattern match at PscIde.Command line 158, column 3 - line 161, column 23: " + [ v.constructor.name ]);
  });
  ...
  var decodeMessage = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Data_Maybe.maybe(new Data_Either.Left("Message not string"))(function ($142) {
          return Data_Either.Right.create(Message($142));
