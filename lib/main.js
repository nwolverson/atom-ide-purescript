...
(function(exports) {
  ...
  var getSuggestions = function (v) {
      var suggestionTypeAtomValue = function (s) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 76, column 33 - line 82, column 5: " + [ s.constructor.name ]);
      };
              ...
              return function (v1) {
                  var suggestType = (function () {
                      ...
                      if (!$13) {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 113, column 16 - line 114, column 16: " + [ $14.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 112, column 11 - line 114, column 16: " + [ $13.constructor.name ]);
                  })();
                  return {
                      ...
                      addImport: new Data_Maybe.Just({
                          ...
                          qualifier: (function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 108, column 55 - line 108, column 107: " + [ $16.constructor.name ]);
                          })()
                      })
                  };
              };
      ...
      if (parsed instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 58, column 7 - line 65, column 5: " + [ moduleCompletion.constructor.name ]);
      };
      if (parsed instanceof Data_Maybe.Nothing) {
          return Prelude["return"](Control_Monad_Aff.applicativeAff)([  ]);
      };
      throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 56, column 6 - line 66, column 3: " + [ parsed.constructor.name ]);
  };
...
(function(exports) {
              ...
              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                          ...
                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                              var $95 = v.activatedManually || autoCompleteAllModules;
                              if ($95) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 68, column 14 - line 69, column 3: " + [ $95.constructor.name ]);
                          })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($110.editor instanceof Data_Maybe.Just && ($110.linter instanceof Data_Maybe.Just && $110.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($110.editor.value0)($110.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      ...
      var doLint = function __do() {
          ...
          if ($132.root instanceof Data_Maybe.Just && ($132.linterIndie instanceof Data_Maybe.Just && $132.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($132.root.value0)($132.linterIndie.value0)($132.statusElt.value0))(function (v10) {
          ...
          return function __do() {
              ...
              if (v7 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v8)(v10)(v9)(moduleName))(function (v11) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($241) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 220, column 7 - line 229, column 5: " + [ v7.constructor.name ]);
          };
      };
      ...
      var addClause = function __do() {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 268, column 7 - line 276, column 5: " + [ v7.constructor.name ]);
      };
