...
(function(exports) {
  ...
  var showPM = new Data_Show.Show(function (v) {
      if (v instanceof PSC) {
          return " --psc-package";
      };
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Config line 25, column 1 - line 25, column 38: " + [ v.constructor.name ]);
  });
  var pmType = (function () {
      var computeResult = function (v) {
          return function (v1) {
              if (v) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(PSC.value);
              };
              if (!v && v1) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(BOWER.value);
              };
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(UNKNOWN.value);
          };
      };
      return Control_Monad_Eff_Unsafe.unsafePerformEff(function __do() {
          var v = Node_FS_Sync.exists(".psc-package")();
          var v1 = Node_FS_Sync.exists("bower_components")();
          return computeResult(v)(v1)();
      });
  })();
  var pulpCmd = (function () {
      var $18 = Data_Eq.eq(Node_Platform.eqPlatform)(Node_Process.platform)(Node_Platform.Win32.value);
      if ($18) {
          return "pulp.cmd" + Data_Show.show(showPM)(pmType);
      };
      return "pulp" + Data_Show.show(showPM)(pmType);
  })();
  var getPrjectSrcGlob = function (v) {
      if (v instanceof UNKNOWN) {
          return [ "src/**/*.purs" ];
      };
      if (v instanceof BOWER) {
          return [ "src/**/*.purs", "bower_components/purescript-*/src/**/*.purs" ];
      };
      if (v instanceof PSC) {
          var getName = function (v1) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Config line 55, column 5 - line 55, column 29: " + [ v1.constructor.name ]);
          };
          return Control_Monad_Eff_Unsafe.unsafePerformEff(function __do() {
              var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                  return "set";
              }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)(Type_Row.rowLacks()()()(Type_Row.rowLacking))())))(Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)("psc-package.json"))();
              return [ "src/**/*.purs", ".psc-package/" + (getName(v1) + "/*/*/src/**/*.purs") ];
          });
      };
      throw new Error("Failed pattern match at IdePurescript.Atom.Config line 47, column 1 - line 47, column 50: " + [ v.constructor.name ]);
  };
  ...
  var defaultSrcGlob = getPrjectSrcGlob(pmType);
  var getSrcGlob = function __do() {
      ...
      var srcGlob$prime = Data_Bifunctor.rmap(Data_Either.bifunctorEither)(Data_Array.mapMaybe(function ($29) {
          return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Control_Monad_Except.runExcept(Data_Foreign.readString($29)));
      }))(v1);
  ...
  exports["getPrjectSrcGlob"] = getPrjectSrcGlob;
