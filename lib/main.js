...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      ...
      return function ($65) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function.apply(Data_Function["const"])(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($65));
      };
  })();
...
(function(exports) {
  ...
  var pulpCmd = (function () {
      var $0 = Data_Eq.eq(Node_Platform.eqPlatform)(Node_Process.platform)(Node_Platform.Win32.value);
      if ($0) {
          return "pulp.cmd";
      };
      if (!$0) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Config line 9, column 11 - line 11, column 1: " + [ $0.constructor.name ]);
  })();
...
(function(exports) {
                              ...
                              return function (msg) {
                                  return function __do() {
                                      ...
                                      return Data_Function.apply((function () {
                                          var $16 = Data_Eq.eq(IdePurescript_Atom_BuildStatus.eqBuildStatus)(s)(IdePurescript_Atom_BuildStatus.Failure.value);
                                          if ($16) {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 136, column 8 - line 136, column 43: " + [ $16.constructor.name ]);
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(IdePurescript_Atom_Build.toLintResult)(buildCmd))(function (v) {
                                      return Data_Function.apply(liftEffA)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(function __do() {
                                          ...
                                          status((function () {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 121, column 21 - line 121, column 68: " + [ $20.constructor.name ]);
                          ...
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Atom_Atom.getAtom))(function (v) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Atom_Config.getConfig(config)("ide-purescript.buildCommand")))(function (v1) {
                                  var buildCommand = (function () {
                                      var $26 = Data_String_Regex.regex("\\s+")(Data_String_Regex.noFlags);
                                      var $27 = Data_Foreign.readString(v1);
                                      if ($26 instanceof Data_Either.Right && $27 instanceof Data_Either.Right) {
                                          return Data_Function.apply(Data_String_Regex.split($26.value0))(Data_Function.apply(Data_String.trim)($27.value0));
                                      };
                                      return [  ];
                                  })();
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readBoolean)(Atom_Config.getConfig(config)("ide-purescript.fastRebuild"))))(function (v2) {
                                      var fastBuild = (function () {
                                          if (v2 instanceof Data_Either.Right && (v2.value0 && (file instanceof Data_Maybe.Just && port instanceof Data_Maybe.Just))) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 104, column 3 - line 109, column 20: " + [ fastBuild.constructor.name, $38.constructor.name ]);
                                      });
                                  });
                              });
                          });
  ...
  var getRoot = function (path) {
      ...
      if (!$43) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 44, column 5 - line 44, column 56: " + [ v.constructor.name ]);
          };
      };
      throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 40, column 3 - line 44, column 56: " + [ $43.constructor.name ]);
  };
  var getProjectRoots = function __do() {
      var v = Atom_Atom.getAtom();
  ...
  var getProjectRoot = function (warn) {
      ...
      return function __do() {
          ...
          var $53 = Data_Array.uncons(v3);
          if ($53 instanceof Data_Maybe.Nothing) {
              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(warn))(Atom_NotificationManager.addWarning(v.notifications)("Doesn't look like a purescript project - didn't find any src dir"))();
              return Data_Maybe.Nothing.value;
          };
          if ($53 instanceof Data_Maybe.Just) {
              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(warn && Data_Function.apply(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Array["null"]($53.value0.tail))))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Multiple project roots, using first: " + $53.value0.head))();
              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(warn && (Data_Array["null"]($53.value0.tail) && Data_Array.length(v2) > 1)))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Multiple project roots but only 1 looks valid: " + $53.value0.head))();
              var output = Node_Path.concat([ $53.value0.head, "output" ]);
              var v4 = Node_FS_Sync.exists(output)();
              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(warn && !v4))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Doesn't look like a project has been built - didn't find: " + output))();
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Maybe.Just($53.value0.head))();
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 64, column 3 - line 74, column 22: " + [ $53.constructor.name ]);
      };
  };
...
(function(exports) {
          ...
          return function (port) {
              return function (projectRoot) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_ChildProcess.spawn(exe)([ "-p", Data_Show.show(Data_Show.showInt)(port) ])((function () {
                      var $7 = {};
                      for (var $8 in Node_ChildProcess.defaultSpawnOptions) {
                          if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($8)) {
                              $7[$8] = Node_ChildProcess.defaultSpawnOptions[$8];
                          };
                      };
                      $7.cwd = projectRoot;
                      $7.stdio = stdio;
  ...
  var getSavedPort = function (cwd) {
      return function __do() {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($21) {
              return Data_Int.fromNumber(Global.readInt(10)($21));
          })(v))();
      };
  };
...
(function(exports) {
  ...
  var stopServer = function (port) {
      return function (rootPath) {
          return function (cp) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(PscIde_Server_1.deleteSavedPort(rootPath)))(function () {
          ...
          var launchServer = (function () {
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(PscIde_Server_1.pickFreshPort))(function (v) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                      Data_Function.apply(Control_Monad_Eff_Console.log)("Starting psc-ide-server on port " + Data_Show.show(Data_Show.showInt)(v))();
                      return PscIde_Server_1.savePort(v)(rootPath)();
                  }))(function () {
                      return Data_Functor.map(Control_Monad_Aff.functorAff)(r(v))(PscIde_Server_1.startServer(exe)(v)(new Data_Maybe.Just(rootPath)));
                  });
              });
          })();
          var gotPath = function (port) {
              return function (workingDir) {
                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 57, column 5 - line 64, column 43: " + [ $10.constructor.name ]);
                  })());
              };
          };
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(PscIde_Server_1.getSavedPort(rootPath)))(function (v) {
              if (v instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Aff.attempt)(IdePurescript_PscIde.cwd(v.value0)))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Data_Function.apply(Control_Monad_Eff_Console.log)("Found existing port from file: " + (Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(v) + ", cwd: "))))(function () {
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffS(Atom_Atom.getAtom))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v1) {
              if (v1 instanceof Data_Either.Right) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_Server.findBins(v1.value0))(function (v2) {
                      var $12 = Data_Array.head(v2);
                      if ($12 instanceof Data_Maybe.Nothing) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Node_Process.lookupEnv("PATH")))(function (v3) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffS)(Data_Function.apply(Atom_NotificationManager.addError(v.notifications))("Couldn't find psc-ide-server, check PATH. Looked for: " + (v1.value0 + (" in PATH: " + Data_Maybe.fromMaybe("")(v3))))))(function () {
                                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)({
                      ...
                      if ($12 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Resolved psc-ide-server:")))(function () {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v3) {
                                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)(v3.value0 + (": " + Data_Maybe.fromMaybe("ERROR")(v3.value1))));
                              })(v2))(function () {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v2) > 1))(Data_Function.apply(Atom_NotificationManager.addWarning(v.notifications))("Found multiple psc-ide-server executables; using " + $12.value0.value0))))(function () {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($12.value0.value0)(path))(function (v3) {
                                          var noRes = {
                                              quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                              port: Data_Maybe.Nothing.value
                                          };
                                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                                              if (v3 instanceof IdePurescript_PscIdeServer.CorrectPath) {
                                                  return Data_Functor.voidRight(Control_Monad_Eff.functorEff)({
                                                      quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                                      port: new Data_Maybe.Just(v3.value0)
                                                  })(Atom_NotificationManager.addInfo(v.notifications)("Found existing psc-ide-server with correct path on port " + Data_Show.show(Data_Show.showInt)(v3.value0)));
                                              };
                                              if (v3 instanceof IdePurescript_PscIdeServer.WrongPath) {
                                                  return function __do() {
                                                      Data_Function.apply(Atom_NotificationManager.addError(v.notifications))("Found existing psc-ide-server on port '" + (Data_Show.show(Data_Show.showInt)(v3.value0) + ("' with wrong path: '" + (v3.value1 + "'. Correct, kill or configure a different port, and restart."))))();
                                                      return noRes;
                                                  };
                                              };
                                              if (v3 instanceof IdePurescript_PscIdeServer.Started) {
                                                  return function __do() {
                                                      Data_Function.apply(Atom_NotificationManager.addSuccess(v.notifications))("Started psc-ide-server (port " + (Data_Show.show(Data_Show.showInt)(v3.value0) + ")"))();
                                                      return {
                                                          quit: Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(function (v4) {
                                                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                                          })(function (v4) {
                                                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                                          }))(IdePurescript_PscIdeServer.stopServer(v3.value0)(path)(v3.value1))), 
                                                          port: new Data_Maybe.Just(v3.value0)
                                                      };
                                                  };
                                              };
                                              if (v3 instanceof IdePurescript_PscIdeServer.Closed) {
                                              ...
                                              if (v3 instanceof IdePurescript_PscIdeServer.StartError) {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 66, column 13 - line 79, column 169: " + [ v3.constructor.name ]);
                                          })());
                                      });
                                  });
                              });
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 53, column 9 - line 79, column 169: " + [ $12.constructor.name ]);
                  });
              };
              ...
              return function (linterMain) {
                  return function (messages) {
                          ...
                          return function (v1) {
                              if (v1.suggestion.hasSuggestion) {
                                  ...
                                  if (v1.suggestion.range.length === 2 && ((v1.suggestion.range[0]).length === 2 && (v1.suggestion.range[1]).length === 2)) {
                                      var newRange = Atom_Range.mkRange(Atom_Point.mkPoint(v1.suggestion.range[0][0])(v1.suggestion.range[0][1]))(Atom_Point.mkPoint(v1.suggestion.range[1][0])(v1.suggestion.range[1][1]));
                      ...
                      return function __do() {
                          ...
                          IdePurescript_Atom_SelectView.selectListViewStaticInline(view)(applyFix)(Data_Maybe.Nothing.value)(fixes)();
                          return Data_Unit.unit;
                      };
                  };
              };
...
(function(exports) {
          ...
          return function (editor) {
              return function __do() {
                  ...
                  if (v instanceof Data_Maybe.Just && mainModule instanceof Data_Maybe.Just) {
                      return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(logError)(ignoreError))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.loadDeps(port)(mainModule.value0))(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.getModulesForFile(port)(v.value0)(v1))(function (v2) {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  var $68 = v.activatedManually || autoCompleteAllModules;
                                  if ($68) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 70, column 14 - line 70, column 136: " + [ $68.constructor.name ]);
                              })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var v6 = Control_Monad_Eff_Ref.newRef(Data_StrMap_1.empty)();
      var getPort = function (file) {
          return function __do() {
              var v7 = Control_Monad_Eff_Ref.readRef(v6)();
              var v8 = IdePurescript_Atom_LinterBuild.getRoot(file)();
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))((function () {
                  if (v8 instanceof Data_Maybe.Just) {
                      var $83 = Data_StrMap_1.lookup(v8.value0)(v7);
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Main line 145, column 11 - line 147, column 31: " + [ $83.constructor.name ]);
                  };
                  if (v8 instanceof Data_Maybe.Nothing) {
                      return Data_Maybe.Nothing.value;
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 143, column 7 - line 148, column 27: " + [ v8.constructor.name ]);
              })())();
          };
      };
      var getPortActiveEditor = function __do() {
          var v7 = Atom_Workspace.getActiveTextEditor(v.workspace)();
          if (v7 instanceof Data_Maybe.Just) {
              var v8 = Atom_Editor.getPath(v7.value0)();
              var v9 = Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Maybe.Nothing.value))(getPort)(v8)();
              return Data_Functor.map(Data_Maybe.functorMaybe)(function (v10) {
                  return v10.port;
              })(v9);
          };
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 199, column 7 - line 204, column 32: " + [ v7.constructor.name ]);
      };
      ...
      })(ignoreError)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(IdePurescript_Atom_LinterBuild.getProjectRoots))(function (v7) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Data_Traversable["for"](Control_Monad_Aff.applicativeAff)(Data_Traversable.traversableArray)(v7))(function (root) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer(root))(function (v8) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                          ...
                          useEditor$prime(v2)(v8.port)(v9)();
                          return IdePurescript_Atom_Tooltips.registerTooltips(getPortActiveEditor)(v2)();
                      }))(function () {
                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Aff.applicativeAff))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(function (port$prime) {
                              return new Data_Maybe.Just(new Data_Tuple.Tuple(root, {
                                  port: port$prime, 
                                  quit: v8.quit
                              }));
                          })(v8.port));
              ...
              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Ref.writeRef(v6))(Data_StrMap_1.fromFoldable(Data_Foldable.foldableArray)(Data_Array.catMaybes(v8))));
          });
      })));
      ...
      var quickFix = function __do() {
          ...
          if ($102.editor instanceof Data_Maybe.Just && ($102.linter instanceof Data_Maybe.Just && $102.n > 0)) {
              return withPort(function (port) {
                  return IdePurescript_Atom_QuickFixes.showQuickFixes(port)(v2)($102.editor.value0)($102.linter.value0)(v7);
              })();
          };
          return Data_Unit.unit;
      };
      var doLint = function (file) {
          return function __do() {
              ...
              var v8 = Control_Monad_Eff_Ref.readRef(v5)();
              var v9 = Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Maybe.Nothing.value))(getPort)(file)();
              if (v9 instanceof Data_Maybe.Just && (v7 instanceof Data_Maybe.Just && v8 instanceof Data_Maybe.Just)) {
                  return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(raiseError)(ignoreError))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(new Data_Maybe.Just(v9.value0.port))(file)(v.config)(v9.value0.root)(v7.value0)(v8.value0))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(Control_Monad_Eff_Ref.writeRef(v3))(v10)))(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_1.load(v9.value0.port)([  ])([  ]))(function () {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v11) {
                                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(useEditor$prime(v2)(new Data_Maybe.Just(v9.value0.port))(v11));
                              });
                          });
                      });
                  })))();
      ...
      var deactivate = function __do() {
          var v7 = Control_Monad_Eff_Ref.readRef(v6)();
          return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Data_Traversable.sequence(Data_List.traversableList)(Control_Monad_Eff.applicativeEff))(Data_Functor.map(Data_List.functorList)(function (v8) {
              return v8.quit;
          })(Data_StrMap_1.values(v7))))();
      };
      ...
      var activate = (function () {
          ...
          return function __do() {
              ...
              Atom_Workspace.observeTextEditors(v.workspace)(function (editor) {
                  return function __do() {
                      ...
                      if (v7 instanceof Data_Maybe.Just && Data_String.contains(".purs")(v7.value0)) {
                          var v8 = getPort(v7.value0)();
                          useEditor$prime(v2)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v9) {
                              return v9.port;
                          })(v8))(new Data_Maybe.Just(editor))();
                          return Atom_Editor.onDidSave(editor)(function (v9) {
                              return function __do() {
                                  ...
                                  return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(buildOnSaveEnabled)(doLint(v7))();
                              };
                          })();
                      };
                      return Data_Unit.unit;
              ...
              Atom_Workspace.onDidChangeActivePaneItem(v.workspace)(function (item) {
                  return withPort(function (port) {
                      return useEditor$prime(v2)(new Data_Maybe.Just(port))(Atom_Editor.toEditor(item));
                  });
              })();
              startPscIdeServer();
      ...
      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Foreign.toForeign({
          ...
          consumeStatusBar: Data_Function_Eff.mkEffFn1(function (statusBar) {
              return function __do() {
                  ...
                  Data_Function.apply(Control_Monad_Eff_Ref.writeRef(v5))(new Data_Maybe.Just(v7))();
          ...
          provideAutocomplete: function (v7) {
              return {
                  ...
                  onDidInsertSuggestion: Data_Function_Eff.mkEffFn1(function (x) {
                      return function __do() {
                          var v8 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Functor.map(Data_Functor.functorFn)(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(Data_Foreign.readBoolean))(Atom_Config.getConfig(v.config)("ide-purescript.autocomplete.addImport"))();
                          return withPort(function (port) {
                              return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v8)(Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(raiseError)(ignoreError))(IdePurescript_Atom_Imports.addSuggestionImport(port)(v2)(x))));
                          })();
                      };
                  })
              };
