                              ...
                              return function (msg) {
                                  return function __do() {
                                      ...
                                      return (function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 99, column 8 - line 99, column 43: " + [ $14.constructor.name ]);
                          ...
                          var doBuild = function (buildCmd) {
                              return Control_Monad_Error_Class.catchError(Control_Monad_Aff.monadErrorAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(status(IdePurescript_Atom_BuildStatus.Building.value)(Data_Maybe.Nothing.value)))(function () {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(IdePurescript_Atom_Build.toLintResult)(buildCmd))(function (v) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Config.getConfig(config)("ide-purescript.censorWarnings")))(function (v1) {
                                          ...
                                          return liftEffA(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)((function () {
                                              var messages$prime = Data_Array.filter(function (v2) {
                                                  return Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(v2.errorCode)(codes);
                                              })(v.messages);
                                              return function __do() {
                                                  IdePurescript_Atom_Hooks_Linter.deleteMessages(linter)();
                                                  IdePurescript_Atom_Hooks_Linter.setMessages(linter)(messages$prime)();
                                                  status((function () {
                                                      var $21 = v.result === "success";
                                                      if ($21) {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 84, column 21 - line 84, column 68: " + [ $21.constructor.name ]);
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(failure("Error running PureScript build command: " + Data_Show.show(Control_Monad_Eff_Exception.showError)(v))))(function () {
                                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
                                  });
                              });
                          };
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(Atom_Atom.getAtom))(function (v) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(Atom_Config.getConfig(config)("ide-purescript.buildCommand")))(function (v1) {
                                  var buildCommand = (function () {
                                      var $27 = Data_String_Regex.regex("\\s+")(Data_String_Regex_Flags.noFlags);
                                      var $28 = Control_Monad_Except.runExcept(Data_Foreign.readString(v1));
                                      if ($27 instanceof Data_Either.Right && $28 instanceof Data_Either.Right) {
                                          return Data_String_Regex.split($27.value0)(Data_String.trim($28.value0));
                                      };
                                      return [  ];
                                  })();
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(IdePurescript_Atom_Config.getFastRebuild))(function (v2) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function () {
                                          var $38 = Data_Array.uncons(buildCommand);
                                          ...
                                          if ($38 instanceof Data_Maybe.Just) {
                                              return doBuild(IdePurescript_Atom_Build.linterBuild({
                                                  command: $38.value0.head, 
                                                  args: $38.value0.tail, 
                                                  directory: projdir
                                              }));
                                          };
                                          if ($38 instanceof Data_Maybe.Nothing) {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(failure("Error parsing PureScript build command")))(function () {
                                                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
                                              });
                                          };
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 64, column 3 - line 69, column 20: " + [ fastBuild.constructor.name, $38.constructor.name ]);
                                      });
                                  });
                              });
                          });
...
(function(exports) {
  ...
  var replaceAnsiColor = function (text) {
      ...
      var colorCss = function (n) {
          return "color: " + Data_Maybe.maybe("black")(function ($138) {
              return renderRgbCss(xtermColor($138));
          })(colorForCode(n));
      };
      var colEscape = function (str) {
          var $63 = IdePurescript_Regex["match'"](Data_String_Regex.regex("\\x1b\\[([0-9]+)m")(Data_String_Regex_Flags.noFlags))(str);
          if ($63 instanceof Data_Maybe.Just && ($63.value0.length === 2 && $63.value0[1] instanceof Data_Maybe.Just)) {
              return Data_Int.fromNumber(Global.readInt(10)(($63.value0[1]).value0));
          };
          return Data_Maybe.Nothing.value;
      };
      var toNodes = function (v) {
          ...
          if (Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(2)))(new Data_Maybe.Just(0)) && Data_Maybe.isJust(Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(0)))) {
              var $69 = Data_Maybe.maybe(Data_Maybe.Nothing.value)(colEscape)(Data_Array.index(v)(0));
              var $70 = Data_Array.index(v)(1);
              if ($69 instanceof Data_Maybe.Just && $70 instanceof Data_Maybe.Just) {
                  return function __do() {
                      var v1 = createElement$prime("span")();
                      DOM_Node_Node.setTextContent($70.value0)(DOM_Node_Types.elementToNode(v1))();
                      DOM_Node_Element.setAttribute("style")(colorCss($69.value0))(v1)();
  ...
  var clearText = function (v) {
      ...
      return Control_Monad_Eff.whileE(DOM_Node_Node.hasChildNodes(node))(function __do() {
          ...
          return Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($139) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Function.flip(DOM_Node_Node.removeChild)(node)($139));
          })(v1)();
      });
  };
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Unsafe_Coerce.unsafeCoerce(openPsci))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(function __do() {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Functor.map(Data_Functor.functorFn)(Control_Monad_Except.runExcept)(Data_Foreign.readString))(Atom_Config.getConfig(v.config)("ide-purescript.psciCommand"))))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Atom_LinterBuild.getProjectRoot(false)))(function (v3) {
                              var command = (function () {
                                  var $97 = Data_String_Regex.regex("\\s+")(Data_String_Regex_Flags.noFlags);
                                  if (v2 instanceof Data_Either.Right && $97 instanceof Data_Either.Right) {
                                      return Data_String_Regex.split($97.value0)(v2.value0);
                                  };
                                  return [  ];
                              })();
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime((function () {
                                  var $101 = Data_Array.uncons(command);
                                  if (v3 instanceof Data_Maybe.Just && $101 instanceof Data_Maybe.Just) {
                                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn($101.value0.head)($101.value0.tail)((function () {
                                          var $102 = {};
                                          for (var $103 in Node_ChildProcess.defaultSpawnOptions) {
                                              if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($103)) {
                                                  $102[$103] = Node_ChildProcess.defaultSpawnOptions[$103];
                                              };
                                          };
                                          $102.cwd = v3;
                                          return $102;
                                  ...
                                  if ($101 instanceof Data_Maybe.Nothing) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 271, column 30 - line 275, column 91: " + [ v3.constructor.name, $101.constructor.name ]);
                              })()))(function (v4) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($140) {
                                      return Control_Monad_Eff_Ref.writeRef(psciRef)(Data_Maybe.Just.create($140));
                                  })(v4)))(function () {
                                      return liftEff$prime$prime(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (proc) {
                                          return Control_Monad_Eff_Exception.catchException(function (e) {
                                              ...
                                              Node_ChildProcess.onError(proc)(function ($141) {
                                                  return notifyErr(Data_Show.show(Control_Monad_Eff_Exception.showError)(Node_ChildProcess.toStandardError($141)));
                                              })();
  ...
  var activate = function __do() {
      ...
      var close = function __do() {
          ...
          if (v3 instanceof Data_Maybe.Just && v4 instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 320, column 13 - line 322, column 35: " + [ v5.constructor.name ]);
          };
          return Data_Unit.unit;
      };
          ...
          return function (name) {
              return function (action) {
                  var scope = (function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 343, column 23 - line 344, column 3: " + [ isEditor.constructor.name ]);
                  })();
