                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer(v8.value0))(function (v9) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                          ...
                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 200, column 13 - line 202, column 91: " + [ v9.port.constructor.name ]);
                          });
                      });
                  });
              };
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 191, column 7 - line 202, column 91: " + [ v8.constructor.name ]);
          });
      };
      ...
      var doLint = function (file) {
          return function __do() {
              ...
              var v11 = (function () {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 154, column 16 - line 156, column 74: " + [ v10.constructor.name ]);
              })()();
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Editor.getPath(v8)))(function (v9) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(getPort(v9)))(function (v10) {
                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))((function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 257, column 9 - line 261, column 39: " + [ v10.constructor.name ]);
                          })());
                      });
                  });
              })));
