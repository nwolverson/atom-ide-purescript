...
(function(exports) {
  ...
  var moduleRegex = Data_String_Regex.regex("(?:^|[^A-Za-z_.])(?:((?:[A-Z][A-Za-z0-9]*\\.)*(?:[A-Z][A-Za-z0-9]*))\\.)?([a-zA-Z_][a-zA-Z0-9_']*)?$")(Data_String_Regex_Flags.noFlags);
  ...
  var getSuggestions = function (port) {
      return function (v) {
          var suggestionTypeAtomValue = function (s) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 79, column 33 - line 85, column 5: " + [ s.constructor.name ]);
          };
                  ...
                  return function (v1) {
                      var suggestType = (function () {
                          ...
                          if (!$14) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 116, column 16 - line 117, column 16: " + [ $15.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 115, column 11 - line 117, column 16: " + [ $14.constructor.name ]);
                      })();
                      return {
                          ...
                          addImport: new Data_Maybe.Just({
                              ...
                              qualifier: (function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 111, column 55 - line 111, column 106: " + [ $17.constructor.name ]);
                              })()
                          })
                      };
                  };
          ...
          if (parsed instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 61, column 7 - line 67, column 50: " + [ moduleCompletion.constructor.name ]);
          };
          if (parsed instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([  ]);
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 59, column 6 - line 68, column 23: " + [ parsed.constructor.name ]);
      };
  };
  ...
  var getPathVar = function (addNpmBin) {
      return function (rootDir) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Exec line 30, column 3 - line 32, column 41: " + [ addNpmBin.constructor.name ]);
          };
      };
  };
                              ...
                              return function (msg) {
                                  return function __do() {
                                      ...
                                      return (function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 89, column 8 - line 89, column 43: " + [ $9.constructor.name ]);
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(IdePurescript_Atom_Build.toLintResult)(buildCmd))(function (v) {
                                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(function __do() {
                                          ...
                                          status((function () {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 74, column 19 - line 74, column 66: " + [ $13.constructor.name ]);
              ...
              var gotPath = function (port) {
                  return function (workingDir) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 139, column 5 - line 146, column 43: " + [ $36.constructor.name ]);
                      })());
                  };
              };
                                          ...
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v1) > 1)(cb(Warning.value)("Found multiple psc-ide-server executables; using " + $59.value0.value0))))(function () {
                                              ...
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer($59.value0.value0)(path)(glob$prime))(function (v2) {
                                                  ...
                                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 97, column 7 - line 110, column 142: " + [ v2.constructor.name ]);
                                                  })());
                                              });
                                          });
                                      });
