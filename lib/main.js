...
(function(exports) {
  ...
  var config = {
      pscIdePort: {
          ...
          description: "The port to use to communciate with `psc-ide-server`, also to launch the server with if required. " + "The default port is 4242 and this only need be changed if you've explicitly chosen to use another port.", 
          type: "integer", 
          "default": 4242
      }, 
      pscIdeServerExe: {
          ...
          return function (rootPath) {
              ...
              var gotPath = function (workingDir) {
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 43, column 5 - line 52, column 1: " + [ $14.constructor.name ]);
                  })());
              };
                      ...
                      if ($10.portRaw instanceof Data_Either.Right && ($10.serverRaw instanceof Data_Either.Right && $10.path instanceof Data_Maybe.Just)) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($10.serverRaw.value0)($10.portRaw.value0)($10.path.value0))(function (v4) {
                              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 43, column 22 - line 49, column 9: " + [ v4.constructor.name ]);
                              })()))(function (v5) {
  ...
  var main = function __do() {
      ...
      var addImport = function (moduleName) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 127, column 7 - line 135, column 5: " + [ v6.constructor.name ]);
          };
      };
