...
(function(exports) {
  ...
  var toEditor = function (item) {
      ...
      throw new Error("Failed pattern match at Atom.Editor line 43, column 3 - line 48, column 1: " + [ $0.constructor.name ]);
  };
  ...
  var getTextInRange = function ($2) {
      return Data_Function_Eff.runEffFn1($foreign.getTextInRangeImpl($2));
  };
...
(function(exports) {
  ...
  var moduleFilterModules = function (modulePrefix) {
      return function (unqualModules) {
          return function (getQualifiedModule) {
              ...
              if (!$14) {
                  var $15 = Data_String.contains(".")(modulePrefix);
                  if ($15) {
                      return [ modulePrefix ];
                  };
                  if (!$15) {
                      var mods = getQualifiedModule(modulePrefix);
                      var $16 = Data_Array["null"](mods);
                      if ($16) {
                          return [ modulePrefix ];
                      };
                      if (!$16) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIde line 58, column 5 - line 63, column 1: " + [ $16.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at IdePurescript.PscIde line 54, column 8 - line 63, column 1: " + [ $15.constructor.name ]);
              };
              throw new Error("Failed pattern match at IdePurescript.PscIde line 52, column 3 - line 63, column 1: " + [ $14.constructor.name ]);
          };
      };
  };
  ...
  var abbrevType = (function () {
      var r = Data_String_Regex.regex("(?:\\w+\\.)+(\\w+)")((function () {
          var $42 = {};
          for (var $43 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($43)) {
                  $42[$43] = Data_String_Regex.noFlags[$43];
              };
          };
          $42.global = true;
          return $42;
      ...
      return function (modulePrefix) {
          return function (unqualModules) {
              return function (getQualifiedModule) {
                  ...
                  var conv = function (r) {
                      var $44 = Data_Array.head(Prelude.map(Prelude.functorArray)(convCompletion)(r));
                      if ($44 instanceof Data_Maybe.Just) {
                          return abbrevType($44.value0.type);
                      };
                      if ($44 instanceof Data_Maybe.Nothing) {
                          return "";
                      };
                      throw new Error("Failed pattern match at IdePurescript.PscIde line 78, column 14 - line 82, column 1: " + [ $44.constructor.name ]);
                  };
...
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var $foreign = PS["IdePurescript.Atom.Imports"];
  var Prelude = PS["Prelude"];
  var Data_Function_Eff = PS["Data.Function.Eff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Promise = PS["Control.Promise"];     
  var showAddImportsView = function (getImports) {
      return function (addImport) {
          return Data_Function_Eff.runEffFn2($foreign.showAddImportsViewImpl)(getImports)(Data_Function_Eff.mkEffFn1(addImport));
      };
  };
  exports["showAddImportsView"] = showAddImportsView;;
...
(function(exports) {
  ...
  var getModuleName = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Modules line 24, column 1 - line 25, column 1: " + [ v.constructor.name ]);
  };
  var getQualModule = function (qualifier) {
      return function (v) {
          ...
          return Prelude.map(Prelude.functorArray)(getModuleName)(Data_Array_1.filter(qual(qualifier))(v.modules));
      };
  };
  var getUnqualActiveModules = function (v) {
      return Prelude.map(Prelude.functorArray)(getModuleName)(Prelude["++"](Prelude.semigroupArray)(Data_Maybe.maybe([  ])(function ($43) {
          return Data_Array_1.singleton(Unqualified.create($43));
      })(v.main))(v.modules));
  };
  ...
  var getModulesForFile = function (file) {
      return function (fullText) {
          var mod = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Modules line 49, column 3 - line 50, column 3: " + [ v.constructor.name ]);
          };
  ...
  var findImportInsertPos = function (text) {
      ...
      var lines = Data_String.split("\n")(text);
      var res = Data_Maybe.fromMaybe(0)(Data_Array_1.findLastIndex(Data_String_Regex.test(regex))(lines));
      return res + 1 | 0;
  };
          ...
          return function (rootPath) {
              ...
              var gotPath = function (workingDir) {
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 43, column 15 - line 50, column 28: " + [ $12.constructor.name ]);
                  })());
              };
...
(function(exports) {
      ...
      return function (editor) {
          return function __do() {
              ...
              if (mainModule instanceof Data_Maybe.Just) {
                  return Control_Monad_Aff.runAff(ignoreError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.loadDeps(mainModule.value0))(function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 63, column 3 - line 71, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($49.editor instanceof Data_Maybe.Just && ($49.linter instanceof Data_Maybe.Just && $49.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($49.editor.value0)($49.linter.value0)(v6)();
          };
          return Prelude.unit;
      };
      var pursuitSearch = IdePurescript_Atom_Pursuit.pursuitSearch(function ($77) {
          return Control_Promise_1.fromAff(IdePurescript_PscIde.getPursuitCompletion($77));
      });
      var doLint = function __do() {
          ...
          if ($57.root instanceof Data_Maybe.Just && $57.linterIndie instanceof Data_Maybe.Just) {
              return Control_Monad_Aff.runAff(ignoreError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($57.root.value0)($57.linterIndie.value0))(function (v8) {
      ...
      var addImport = function (moduleName) {
          return function __do() {
              var v6 = Atom_Workspace.getActiveTextEditor(v.workspace)();
              if (v6 instanceof Data_Maybe.Nothing) {
                  return Prelude.unit;
              };
              if (v6 instanceof Data_Maybe.Just) {
                  var v7 = Atom_Editor.getText(v6.value0)();
                  var index = IdePurescript_Modules.findImportInsertPos(v7);
                  var pt = Atom_Range.mkRange(Atom_Point.mkPoint(index)(0))(Atom_Point.mkPoint(index)(0));
                  return Prelude["void"](Control_Monad_Eff.functorEff)(Atom_Editor.setTextInBufferRange(v6.value0)(pt)("import " + (moduleName + "\n")))();
              };
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 125, column 7 - line 133, column 5: " + [ v6.constructor.name ]);
          };
      };
      var addModuleImport = IdePurescript_Atom_Imports.showAddImportsView(Control_Promise_1.fromAff(IdePurescript_PscIde.getAvailableModules))(addImport);
      var pursuitSearchModule = IdePurescript_Atom_Pursuit.pursuitSearchModules(function ($78) {
          return Control_Promise_1.fromAff(IdePurescript_PscIde.getPursuitModuleCompletion($78));
      })(addImport);
          ...
          return function __do() {
              ...
              Control_Monad_Aff.runAff(function (v6) {
                  ...
                  return function __do() {
                      ...
                      var v6 = Atom_Workspace.getActiveTextEditor(v.workspace)();
                      return Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(useEditor(v2))(v6)();
                  };
