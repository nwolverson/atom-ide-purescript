...
(function(exports) {
  ...
  var getAvailableModules = (function () {
      ...
      return function ($43) {
          return result(conv)(PscIde.listAvailableModules($43));
      };
  })();
  var getLoadedModules = (function () {
      ...
      return function ($44) {
          return result(conv)(PscIde.listLoadedModules($44));
      };
  })();
  ...
  var cwd = function ($45) {
      return result(runMsg)(PscIde.cwd($45));
  };
...
(function(exports) {
  ...
  var getUnqualActiveModules = function (v) {
      return function (ident) {
          ...
          return Data_Function.apply(Data_Functor.map(Data_Functor.functorArray)(getModuleName))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function ($102) {
  ...
  var getMainModule = function (text) {
      var regex = Data_Function.apply(Data_String_Regex.regex("module\\s+([\\w.]+)"))((function () {
          var $55 = {};
          for (var $56 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($56)) {
                  $55[$56] = Data_String_Regex.noFlags[$56];
              };
          };
          $55.multiline = true;
          return $55;
      })());
      var $57 = IdePurescript_Regex["match'"](regex)(text);
      if ($57 instanceof Data_Maybe.Just && ($57.value0.length === 2 && $57.value0[1] instanceof Data_Maybe.Just)) {
          return new Data_Maybe.Just(($57.value0[1]).value0);
      };
      return Data_Maybe.Nothing.value;
  };
                              ...
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(IdePurescript_PscIde.getTypeInfo(port)(v3.word)(v4.main)(prefix)(Data_Function.apply(IdePurescript_Modules.getUnqualActiveModules(v4))(new Data_Maybe.Just(v3.word)))(Data_Function.apply(Data_Function.flip(IdePurescript_Modules.getQualModule))(v4))))(function (v5) {
                                  if (v5 instanceof Data_Maybe.Just && v5.value0.definedAt instanceof Data_Maybe.Just) {
                                      return Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(Atom_Workspace.open(v.workspace)(v5.value0.definedAt.value0.name)((function () {
                                          ...
                                          $55.initialLine = v5.value0.definedAt.value0.start.line - 1;
                                          $55.initialColumn = v5.value0.definedAt.value0.start.column - 1;
                                          return $55;
                                      })())(Data_Function.apply(Data_Function["const"])(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))));
                                  };
                                  return Control_Applicative.pure(Control_Monad_Maybe_Trans.applicativeMaybeT(Control_Monad_Aff.monadAff))(Data_Unit.unit);
...
(function(exports) {
  ...
  var getSavedPort = function (cwd) {
      return function __do() {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($42) {
              return Data_Int.fromNumber(Global.readInt(10)($42));
          })(v))();
      };
  };
              ...
              return Data_Function.apply(Control_Monad_Aff.makeAff)(function (err) {
                  return function (succ) {
                      return Node_ChildProcess.execFile(exe2)([ "--version" ])((function () {
                          var $33 = {};
                          for (var $34 in Node_ChildProcess.defaultExecOptions) {
                              if (Node_ChildProcess.defaultExecOptions.hasOwnProperty($34)) {
                                  $33[$34] = Node_ChildProcess.defaultExecOptions[$34];
                              };
                          };
                          $33.env = v.env;
                          return $33;
  ...
  var rebuild = function (port) {
      return function (file) {
          ...
          var onResult = function ($55) {
              ...
              })(Data_Bifunctor.bimap(Data_Either.bifunctorEither)(wrapError)(wrapError)($55));
          };
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(rebuild$prime(port)(file))(function (v) {
              return Data_Either.either(function ($56) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Aff.monadErrorAff)(Control_Monad_Eff_Exception.error($56));
              })(function ($57) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(onResult($57));
              })(v);
          });
      };
  };
              ...
              return function (succ) {
                  return function __do() {
                      ...
                      if (v1.cp instanceof Data_Maybe.Just) {
                          Node_ChildProcess_1.onError(v1.cp.value0)(function ($58) {
                              return err(Node_ChildProcess_1.toStandardError($58));
                          })();
                          ...
                          return Node_ChildProcess_1.onClose(v1.cp.value0)(function (exit) {
                              if (exit instanceof Node_ChildProcess_1.Normally && (exit.value0 === 0 || exit.value0 === 1)) {
                                  return function __do() {
                                      ...
                                      var $41 = Data_Functor.map(Data_Maybe.functorMaybe)(IdePurescript_PscErrors.parsePscOutput)(json);
                                      if ($41 instanceof Data_Maybe.Just && $41.value0 instanceof Data_Either.Left) {
                                          return Data_Function.apply(err)(Control_Monad_Eff_Exception.error($41.value0.value0))();
                                      };
                                      if ($41 instanceof Data_Maybe.Just && $41.value0 instanceof Data_Either.Right) {
                                          return succ({
                                              errors: $41.value0.value0, 
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.Build line 89, column 13 - line 93, column 11: " + [ $41.constructor.name ]);
                                  };
                              };
              ...
              var gotPath = function (port) {
                  return function (workingDir) {
                      return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 139, column 5 - line 146, column 43: " + [ $35.constructor.name ]);
                      })());
                  };
              };
                  ...
                  return function (cb) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(IdePurescript_Exec.getPathVar(addNpmBin)(path)))(function (v) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v)(server))(function (v1) {
                              ...
                              if ($58 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Resolved psc-ide-server paths (1st is used):")))(function () {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v2) {
                                          ...
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v1) > 1))(Data_Function.apply(cb(Warning.value))("Found multiple psc-ide-server executables; using " + $58.value0.value0))))(function () {
                                              var glob$prime = (function () {
                                                  var $62 = Data_Ord.greaterThanOrEq(Data_Maybe.ordMaybe(ordVersion))(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(parseVersion)(Data_String.trim))($58.value0.value1)))(new Data_Maybe.Just(new Version(0, 9, 2)));
                                                  if ($62) {
                                                      return glob;
                                                  };
                                                  if (!$62) {
                                                  ...
                                                  throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 94, column 19 - line 94, column 104: " + [ $62.constructor.name ]);
                                              })();
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer($58.value0.value0)(path)(glob$prime))(function (v2) {
                                                  var noRes = {
                                                      quit: Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit), 
                                                      port: Data_Maybe.Nothing.value
                                                  };
                              ...
                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 84, column 3 - line 110, column 142: " + [ $58.constructor.name ]);
                          });
                      });
                  };
              };
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 74, column 14 - line 74, column 136: " + [ $81.constructor.name ]);
                              })())(function (v4) {
  ...
  var main = function __do() {
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.takeVar(v9))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(PscIde_Project.getRoot(path)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                          ...
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Loading modules: " + path)))(function () {
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                                                  ...
                                                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.Main line 216, column 15 - line 218, column 93: " + [ v12.port.constructor.name ]);
                                                  });
                                              });
                                          });
                                      }));
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 203, column 7 - line 218, column 93: " + [ v10.constructor.name ]);
                      })())(function () {
      ...
      var startPscIdeServer = Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function (v9) {
          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(Data_Function.apply(Control_Monad_Eff_Console.log)("Starting psc-ide-server for path: " + v9)))(function () {
              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Control_Monad_Aff.runAff(function (v10) {
          ...
          return function __do() {
              ...
              var v12 = (function () {
                  ...
                  if (v11 instanceof Data_Maybe.Nothing) {
                      return Data_Function.apply(Control_Monad_Maybe_Trans.runMaybeT)(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function ($162) {
                          return Control_Monad_Maybe_Trans.MaybeT(PscIde_Project.getRoot($162));
                      }));
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 155, column 16 - line 157, column 74: " + [ v11.constructor.name ]);
              })()();
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Editor.getPath(v9)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(getPort(v10)))(function (v11) {
                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))((function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 274, column 9 - line 278, column 39: " + [ v11.constructor.name ]);
                          })());
                      });
                  });
              })));
