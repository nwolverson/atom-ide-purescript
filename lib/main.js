...
(function(exports) {
  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 68, column 3 - line 76, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($55.editor instanceof Data_Maybe.Just && ($55.linter instanceof Data_Maybe.Just && $55.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($55.editor.value0)($55.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      var pursuitSearch = IdePurescript_Atom_Pursuit.pursuitSearch(function ($87) {
          return Control_Promise_1.fromAff(IdePurescript_PscIde.getPursuitCompletion($87));
      });
      var doLint = function __do() {
          ...
          if ($64.root instanceof Data_Maybe.Just && ($64.linterIndie instanceof Data_Maybe.Just && $64.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($64.root.value0)($64.linterIndie.value0)($64.statusElt.value0))(function (v10) {
      ...
      var addImport = function (moduleName) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 133, column 7 - line 141, column 5: " + [ v7.constructor.name ]);
          };
      };
      ...
      var pursuitSearchModule = IdePurescript_Atom_Pursuit.pursuitSearchModules(function ($88) {
          return Control_Promise_1.fromAff(IdePurescript_PscIde.getPursuitModuleCompletion($88));
      })(addImport);
