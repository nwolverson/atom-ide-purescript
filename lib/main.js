...
(function(exports) {
  ...
  var xtermColor = function (c) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 138, column 16 - line 157, column 1: " + [ c.constructor.name ]);
  };
  ...
  var opener = function (s) {
      ...
      if ($49 instanceof Data_Maybe.Just && $49.value0 === 0) {
          return function __do() {
              ...
              Data_Function.apply($foreign.setTimeout(10))(IdePurescript_Atom_PromptPanel.focus(v3))();
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($136) {
                                      ...
                                      return Data_Function.apply(liftEff$prime$prime)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (proc) {
                                          return Data_Function.apply(Control_Monad_Eff_Exception.catchException(Data_Function.apply(Data_Function["const"])(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))))(function __do() {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 275, column 5 - line 286, column 27: " + [ v5.constructor.name ]);
                                          });
                                      })(v4));
                                  });
                              });
  ...
  var activate = function __do() {
      ...
      var close = function __do() {
          ...
          if (v3 instanceof Data_Maybe.Just && v4 instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 307, column 13 - line 309, column 35: " + [ v5.constructor.name ]);
          };
          return Data_Unit.unit;
      };
          ...
          return function (name) {
              return function (action) {
                  var scope = (function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 330, column 23 - line 331, column 3: " + [ isEditor.constructor.name ]);
                  })();
  ...
  var main = function __do() {
      ...
      var getPort = function (file) {
          return Data_Function.apply(Control_Monad_Maybe_Trans.runMaybeT)(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(Control_Monad_Eff_Ref.readRef(v7)))(function (v8) {
              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(IdePurescript_Atom_LinterBuild.getRoot(file)))(function (v9) {
      ...
      var getPortActiveEditor = Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v8) {
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer(v8.value0))(function (v9) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                          ...
                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 197, column 13 - line 199, column 91: " + [ v9.port.constructor.name ]);
                          });
                      });
                  });
              };
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 188, column 7 - line 199, column 91: " + [ v8.constructor.name ]);
          });
      };
      ...
      var quickFix = function __do() {
          ...
          if ($105.editor instanceof Data_Maybe.Just && ($105.linter instanceof Data_Maybe.Just && $105.n > 0)) {
              return withPort(function (port) {
                  return IdePurescript_Atom_QuickFixes.showQuickFixes(port)(v2)($105.editor.value0)($105.linter.value0)(v8);
              })();
          };
          return Data_Unit.unit;
      };
                      ...
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Editor.getPath(v8)))(function (v9) {
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(getPort(v9)))(function (v10) {
                              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 246, column 9 - line 250, column 39: " + [ v10.constructor.name ]);
                              })());
                          });
                      });
                  })));
