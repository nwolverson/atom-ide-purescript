      ...
      return function (elt) {
          return function (commandName) {
              return function (callback) {
                  return function () {
                      return $foreign.addImpl(cr)(elt, commandName, Control_Monad_Eff_Uncurried.mkEffFn1(callback));
                  };
              };
          };
      };
  ...
  var addCommand = function (cr) {
      return function (selector) {
          return function (commandName) {
              return function (callback) {
                  return function () {
                      return $foreign.addImpl(cr)(selector, commandName, Control_Monad_Eff_Uncurried.mkEffFn1(callback));
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var paneForItem = function (w) {
      return function (a) {
          return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(function () {
              return $foreign.paneForItemImpl(w)(a);
          });
      };
  };
  var open = function (w) {
      return function (s) {
          return function (o) {
              return function (cb) {
                  return function (err) {
                      return function () {
                          return $foreign.openImpl(w)(s, o, Control_Monad_Eff_Uncurried.mkEffFn1(cb), err);
                      };
                  };
              };
          };
  ...
  var addOpener = function (w) {
      return function (f) {
          return function () {
              return $foreign.addOpenerImpl(w)(Control_Monad_Eff_Uncurried.mkEffFn1(f));
          };
      };
  };
      ...
      return function (item) {
          return function (visible) {
              return function (priority) {
                  return function () {
                      return $foreign.addModalPanelImpl(w)({
                          item: item,
                          visible: visible,
                          priority: priority
                      });
...
(function(exports) {
  ...
  var fixTypoCmd = new CommandInfo("Fix typo", "fixTypo");
...
(function(exports) {
  ...
  var pursuitRequest = function (text) {
      return Network_HTTP_Affjax.affjax(Network_HTTP_Affjax_Request.requestableUnit)(Network_HTTP_Affjax_Response.responsableJson)((function () {
          ...
          $26.url = "https://pursuit.purescript.org/search?q=" + text;
          $26.headers = [ new Network_HTTP_RequestHeader.Accept(Data_MediaType_Common.applicationJSON) ];
          return $26;
      })());
  };
  ...
  var pursuitSearchModule = function (conn) {
      ...
      return IdePurescript_Atom_SelectView.selectListViewDynamic(view)(importDialog)(Data_Maybe.Nothing.value)(Data_Function["const"](""))(pursuitModuleSearchRequest)(1000);
  };
  ...
  var pursuitSearch = (function () {
      ...
      })(Data_Maybe.Nothing.value)(Data_Function["const"](""))(pursuitSearchRequest)(1000);
  })();
...
(function(exports) {
  ...
  var translateConfig = function (config1) {
      return Data_Either.either(Data_Function["const"](Data_Foreign.toForeign({})))(Control_Category.id(Control_Category.categoryFn))(Control_Monad_Except.runExcept((function () {
          var unchanged = [ "pursExe", "useCombinedExe", "pscIdeServerExe", "addNpmPath", "buildCommand", "fastRebuild", "censorWarnings", "editorMode", "pscIdelogLevel", "autoStartPscIde" ];
