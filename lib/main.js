...
(function(exports) {
          ...
          return function (getQualifiedModule) {
              ...
              if (!$16) {
                  ...
                  if (!$17) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIde line 66, column 5 - line 69, column 11: " + [ $18.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at IdePurescript.PscIde line 62, column 8 - line 69, column 11: " + [ $17.constructor.name ]);
              };
              throw new Error("Failed pattern match at IdePurescript.PscIde line 60, column 3 - line 69, column 11: " + [ $16.constructor.name ]);
          };
      };
  };
                          ...
                          return function (unqualModules) {
                              return function (getQualifiedModule) {
                                  var mods = (function () {
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.PscIde line 109, column 10 - line 109, column 108: " + [ moduleCompletion.constructor.name ]);
                                  })();
                                  return Data_Function.apply(eitherToErr)(PscIde.complete(port)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mainFilter)(moduleFilters(mods)))(matcher)(currentModule));
                              };
                          };
                      };
                  };
  ...
  var getAvailableModules = (function () {
      ...
      return function ($46) {
          return result(conv)(PscIde.listAvailableModules($46));
      };
  })();
  var getLoadedModules = (function () {
      ...
      return function ($47) {
          return result(conv)(PscIde.listLoadedModules($47));
      };
  })();
              ...
              return function (modulePrefix) {
                  return function (unqualModules) {
                      return function (getQualifiedModule) {
                          ...
                          return Data_Function.apply(result(Data_Array.head))(PscIde["type'"](port)(text)(moduleFilters(mods))(currentModule));
                      };
                  };
              };
          };
  ...
  var cwd = function ($48) {
      return result(runMsg)(PscIde.cwd($48));
  };
