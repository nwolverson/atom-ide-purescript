          ...
          return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(IdePurescript_Atom_LinterBuild.getProjectRoot))(function (v1) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Foreign.readInt)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdePort"))))(function (v2) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v3) {
                      ...
                      if ($16.portRaw instanceof Data_Either.Right && ($16.serverRaw instanceof Data_Either.Right && $16.path instanceof Data_Maybe.Just)) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Node_Which.which($16.serverRaw.value0))(function (v4) {
                              var $18 = Data_Array.head(v4);
                              if ($18 instanceof Data_Maybe.Nothing) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_NotificationManager.addError(v.notifications)("Couldn't find psc-ide-server, check PATH. Looked for: " + $16.serverRaw.value0)))(function () {
                              ...
                              if ($18 instanceof Data_Maybe.Just) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Resolved psc-ide-server:")))(function () {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (x) {
                                          ...
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad.when(Control_Monad_Eff.monadEff)(Data_Array.length(v4) > 1)(Atom_NotificationManager.addWarning(v.notifications)("Found multiple psc-ide-server executables; using " + $18.value0))))(function () {
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($18.value0)($16.portRaw.value0)($16.path.value0))(function (v5) {
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 64, column 26 - line 70, column 13: " + [ v5.constructor.name ]);
                                                  })()))(function (v6) {
                                                      if (v6 instanceof Data_Maybe.Nothing) {
                                                          return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit));
                                                      };
                                                      if (v6 instanceof Data_Maybe.Just) {
                                                          return Prelude.pure(Control_Monad_Aff.applicativeAff)(Control_Monad_Aff.launchAff(IdePurescript_PscIdeServer.stopServer($16.portRaw.value0)(v6.value0)));
                                                      };
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 70, column 13 - line 73, column 5: " + [ v6.constructor.name ]);
                                                  });
                                              });
                                          });
                                      });
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 53, column 9 - line 73, column 5: " + [ $18.constructor.name ]);
                          });
                      };
                      return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit));
                  });
                      ...
                      return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Atom_Config.getPscIdePort))(function (v3) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v4) {
                              ...
                              return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 67, column 14 - line 68, column 3: " + [ $59.constructor.name ]);
                              })())(function (v5) {
