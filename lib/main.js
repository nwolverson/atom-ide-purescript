...
(function(exports) {
  ...
  var decodeTypeInfo = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      var getFieldMaybe = function (dictDecodeJson) {
          return function (o) {
              return function (f) {
                  return Data_Function.apply(Data_Either.Right.create)(Data_Function.apply(Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create))(Data_Argonaut_Decode_Combinators.getField(dictDecodeJson)(o)(f)));
              };
          };
      };
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
  ...
  var decodeMessage = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left("Message not string"))(function ($134) {
...
(function(exports) {
  ...
  var moduleFilterModules = function (modulePrefix) {
      return function (unqualModules) {
          return function (getQualifiedModule) {
              ...
              throw new Error("Failed pattern match at IdePurescript.PscIde line 60, column 3 - line 63, column 36: " + [ $14.constructor.name ]);
          };
      };
  };
                          ...
                          return function (unqualModules) {
                              return function (getQualifiedModule) {
                                  var moduleFilters = (function () {
                                      ...
                                      if (!moduleCompletion) {
                                          return [ Data_Function.apply(PscIde_Command_1.ModuleFilter.create)(moduleFilterModules(modulePrefix)(unqualModules)(getQualifiedModule)) ];
                                      };
                                      throw new Error("Failed pattern match at IdePurescript.PscIde line 97, column 19 - line 97, column 138: " + [ moduleCompletion.constructor.name ]);
                                  })();
                                  return Data_Function.apply(eitherToErr)(PscIde.complete(port)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mainFilter)(moduleFilters))(matcher)(currentModule));
                              };
                          };
                      };
                  };
  ...
  var getCompletion = function (port) {
      return function (prefix) {
          return getCompletion$prime(Data_Maybe.Nothing.value)([ new PscIde_Command_1.PrefixFilter(prefix) ])(port);
      };
  };
  ...
  var getAvailableModules = (function () {
      ...
      return function ($44) {
          return result(conv)(PscIde.listAvailableModules($44));
      };
  })();
  var getLoadedModules = (function () {
      ...
      return function ($45) {
          return result(conv)(PscIde.listLoadedModules($45));
      };
  })();
      ...
      return function (text) {
          return function (currentModule) {
              return function (modulePrefix) {
                  return function (unqualModules) {
                      return function (getQualifiedModule) {
                          var moduleFilters = [ Data_Function.apply(PscIde_Command_1.ModuleFilter.create)(moduleFilterModules(modulePrefix)(unqualModules)(getQualifiedModule)) ];
                          return Data_Function.apply(result(Data_Array.head))(PscIde["type'"](port)(text)(moduleFilters)(currentModule));
                      };
                  };
              };
          };
  ...
  var cwd = function ($46) {
      return result(runMsg)(PscIde.cwd($46));
  };
...
(function(exports) {
  ...
  var moduleRegex = Data_String_Regex.regex("(?:^|[^A-Za-z_.])(?:((?:[A-Z][A-Za-z0-9]*\\.)*(?:[A-Z][A-Za-z0-9]*))\\.)?([a-zA-Z_][a-zA-Z0-9_']*)?$")(Data_String_Regex.noFlags);
...
(function(exports) {
          ...
          return function (action) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)($foreign.tmpDir))(function (v) {
                  var name = IdePurescript_Regex["replace'"](Data_String_Regex.regex("[\\/\\\\]")((function () {
                      var $25 = {};
                      for (var $26 in Data_String_Regex.noFlags) {
                          if (Data_String_Regex.noFlags.hasOwnProperty($26)) {
                              $25[$26] = Data_String_Regex.noFlags[$26];
                          };
                      };
                      $25.global = true;
                      return $25;
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(tmpFile)(text))(function () {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(action(tmpFile))(function (v1) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                              if (v1 instanceof Data_Either.Right && v1.value0 instanceof PscIde_Command_1.SuccessFile) {
                              ...
                              if (v1 instanceof Data_Either.Right && v1.value0 instanceof PscIde_Command_1.MultipleResults) {
  ...
  var mkImplicit = function (m) {
      return {
          ...
          importType: PscIde_Command_1.Implicit.value, 
          moduleName: m
      };
  };
  ...
  var getUnqualActiveModules = function (v) {
      return function (ident) {
          var include = function (v1) {
              ...
              if (v1.importType instanceof PscIde_Command_1.Explicit) {
              ...
              if (v1.importType instanceof PscIde_Command_1.Implicit) {
                  return true;
              };
              if (v1.importType instanceof PscIde_Command_1.Hiding) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Modules line 91, column 3 - line 91, column 49: " + [ v1.constructor.name ]);
          };
          return Data_Function.apply(Data_Functor.map(Data_Functor.functorArray)(getModuleName))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function ($105) {
              return Data_Array.singleton(mkImplicit($105));
  ...
  var getMainModule = function (text) {
      var regex = Data_Function.apply(Data_String_Regex.regex("module\\s+([\\w.]+)"))((function () {
          var $56 = {};
          for (var $57 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($57)) {
                  $56[$57] = Data_String_Regex.noFlags[$57];
              };
          };
          $56.multiline = true;
          return $56;
      })());
      var $59 = IdePurescript_Regex["match'"](regex)(text);
      if ($59 instanceof Data_Maybe.Just && ($59.value0.length === 2 && $59.value0[1] instanceof Data_Maybe.Just)) {
          return new Data_Maybe.Just(($59.value0[1]).value0);
      };
      return Data_Maybe.Nothing.value;
  };
      ...
      return function (file) {
          return function (fullText) {
              ...
              var idents = function (v) {
                  if (v.importType instanceof PscIde_Command_1.Explicit) {
  ...
  var eqImportType = function (v) {
      return function (v1) {
          if (v instanceof PscIde_Command_1.Implicit && v1 instanceof PscIde_Command_1.Implicit) {
              return true;
          };
          if (v instanceof PscIde_Command_1.Explicit && v1 instanceof PscIde_Command_1.Explicit) {
              return Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v.value0)(v1.value0);
          };
          if (v instanceof PscIde_Command_1.Hiding && v1 instanceof PscIde_Command_1.Hiding) {
              return Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqString))(v.value0)(v1.value0);
          };
          return false;
      };
          ...
          return function (fileName) {
              return function (text) {
                  return function (moduleName) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Modules line 139, column 3 - line 145, column 21: " + [ shouldAdd.constructor.name ]);
                  };
              };
          };
      };
                  ...
                  return function (moduleName) {
                      return function (identifier) {
                          var shouldAddMatch = function (v) {
                              return function (v1) {
                                  if (v1.qualifier instanceof Data_Maybe.Nothing && (v1.importType instanceof PscIde_Command_1.Implicit && v1.moduleName === v)) {
                                      return false;
                                  };
                                  if (v1.qualifier instanceof Data_Maybe.Nothing && (v1.importType instanceof PscIde_Command_1.Hiding && v1.moduleName === v)) {
                          ...
                          var shouldAdd = !isThisModule && (!Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)(identifier)(state.identifiers) && Data_Maybe.maybe(true)(function (mn) {
                              return Data_Foldable.all(Data_Foldable.foldableArray)(Data_BooleanAlgebra.booleanAlgebraBoolean)(shouldAddMatch(mn))(state.modules);
                          })(moduleName));
                          var filters = (function () {
                              ...
                              if (moduleName instanceof Data_Maybe.Just) {
                                  return [ new PscIde_Command_1.ModuleFilter([ moduleName.value0 ]) ];
                              };
                              throw new Error("Failed pattern match at IdePurescript.Modules line 164, column 15 - line 166, column 49: " + [ moduleName.constructor.name ]);
                          })();
                          var addImport = function (tmpFile) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(withTempFile(fileName)(text)(addImport))(function (v) {
                                  var state$prime = (function () {
                                      if (v instanceof UpdatedImports) {
                                          ...
                                          $101.identifiers = Data_Array.cons(identifier)(state.identifiers);
                                          return $101;
                                      };
                                      return state;
                                  })();
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Modules line 154, column 3 - line 161, column 37: " + [ shouldAdd.constructor.name ]);
                      };
                  };
              };
          };
...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      ...
      return function ($109) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function.apply(Data_Function["const"])(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($109));
      };
  })();
                          ...
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(Control_Monad_Eff_Ref.readRef(modulesState))))(function (v2) {
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(IdePurescript_PscIde.getTypeInfo(port)(v1.word)(v2.main)(prefix)(Data_Function.apply(IdePurescript_Modules.getUnqualActiveModules(v2))(new Data_Maybe.Just(v1.word)))(Data_Function.apply(Data_Function.flip(IdePurescript_Modules.getQualModule))(v2))))(function (v3) {
                                  if (v3 instanceof Data_Maybe.Just && v3.value0.definedAt instanceof Data_Maybe.Just) {
                                      return Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(Atom_Workspace.open(v.workspace)(v3.value0.definedAt.value0.name)((function () {
                                          var $37 = {};
                          ...
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(Control_Monad_Eff_Ref.readRef(modulesState))))(function (v4) {
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(IdePurescript_PscIde.getTypeInfo(port)(v3.word)(v4.main)(prefix)(Data_Function.apply(IdePurescript_Modules.getUnqualActiveModules(v4))(new Data_Maybe.Just(v3.word)))(Data_Function.apply(Data_Function.flip(IdePurescript_Modules.getQualModule))(v4))))(function (v5) {
                                  if (v5 instanceof Data_Maybe.Just && v5.value0.definedAt instanceof Data_Maybe.Just) {
                                      return Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(Atom_Workspace.open(v.workspace)(v5.value0.definedAt.value0.name)((function () {
                                          var $56 = {};
      ...
      return function __do() {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Data_Function.apply(launchAffAndRaise)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(IdePurescript_Atom_Editor.getLinePosition(v1.value0)))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(IdePurescript_PscIde.eitherToErr)(PscIde_1.addClause(port)(v2.line)(false)))(function (v3) {
...
(function(exports) {
  ...
  var startServer = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_ChildProcess.spawn(v.exe)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (p) {
          ...
          throw new Error("Failed pattern match at PscIde.Server line 66, column 8 - line 66, column 44: " + [ v.watch.constructor.name ]);
          ...
          throw new Error("Failed pattern match at PscIde.Server line 67, column 8 - line 67, column 41: " + [ v.debug.constructor.name ]);
      })())(v.source))))))((function () {
          var $12 = {};
  ...
  var getSavedPort = function (cwd) {
      return function __do() {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($44) {
              ...
              return Data_Function.apply(Control_Monad_Aff.makeAff)(function (err) {
                  return function (succ) {
                      return Node_ChildProcess.execFile(exe2)([ "--version" ])((function () {
                          ...
                          return Data_Maybe.maybe(Control_Bind.bind(Control_Monad_Eff.bindEff)(Node_Buffer_1.readString(Node_Encoding.UTF8.value)(0)(100)(v1.stdout))(succ))(err)(v1.error);
                      });
                  };
              });
          };
  ...
  var getPathVar = function (addNpmBin) {
      return function (rootDir) {
          return function __do() {
              ...
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))((function () {
                  if (addNpmBin) {
                      return Data_Function.apply(Data_Either.Right.create)(addNpmBinPath(rootDir)(v));
                  };
                  if (!addNpmBin) {
                      return Data_Function.apply(Data_Either.Left.create)(Data_Maybe.fromMaybe("")(v));
                  };
...
(function(exports) {
  ...
  "use strict";
  var Prelude = PS["Prelude"];
  var Node_ChildProcess_1 = PS["Node.ChildProcess"];
  var Node_Stream = PS["Node.Stream"];
  var PscIde_1 = PS["PscIde"];
  var PscIde_Command = PS["PscIde.Command"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  ...
  var spawn = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(IdePurescript_Exec.getPathVar(v.useNpmDir)(v.directory)))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v1)(v.command.value0))(function (v2) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                  var $15 = Data_Array.uncons(v2);
                  if ($15 instanceof Data_Maybe.Just) {
                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess_1.spawn($15.value0.head.value0)(v.command.value1)((function () {
                          var $16 = {};
                          for (var $17 in Node_ChildProcess_1.defaultSpawnOptions) {
                              if (Node_ChildProcess_1.defaultSpawnOptions.hasOwnProperty($17)) {
                                  $16[$17] = Node_ChildProcess_1.defaultSpawnOptions[$17];
                              };
                          };
                          $16.cwd = new Data_Maybe.Just(v.directory);
                          $16.env = new Data_Maybe.Just(Data_Function.apply(Data_StrMap.fromList)(Data_Function.apply(Data_List.singleton)(Data_Function.apply(Data_Tuple.Tuple.create("PATH"))(Data_Either.either(Control_Category.id(Control_Category.categoryFn))(Control_Category.id(Control_Category.categoryFn))(v1)))));
                          return $16;
                      })()));
                  };
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Maybe.Nothing.value);
      ...
      return function (file) {
          var wrapError = function (v) {
              if (v instanceof IdePurescript_PscErrors.RebuildError) {
                  return Data_Function.apply(Data_Array.singleton)({
  ...
  var build = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(spawn(v))(function (v1) {
          return Data_Function.apply(Control_Monad_Aff.makeAff)(function (err) {
              return function (succ) {
                  return function __do() {
                      Data_Function.apply(Control_Monad_Eff_Console.log)("Resolved build command (1st is used): ")();
                      Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(function (v2) {
                          return Data_Function.apply(Control_Monad_Eff_Console.log)(v2.value0 + Data_Maybe.maybe("")(function (v3) {
                              return ": " + v3;
                          })(v2.value1));
                      })(v1.cmdBins)();
                      if (v1.cp instanceof Data_Maybe.Nothing) {
                          return Data_Function.apply(err)(Data_Function.apply(Control_Monad_Eff_Exception.error)("Didn't find command in PATH: " + v.command.value0))();
                      };
                      if (v1.cp instanceof Data_Maybe.Just) {
                          Node_ChildProcess_1.onError(v1.cp.value0)(function ($59) {
                              return err(Node_ChildProcess_1.toStandardError($59));
                          })();
                          var stderr = Node_ChildProcess_1.stderr(v1.cp.value0);
                          ...
                          return Node_ChildProcess_1.onClose(v1.cp.value0)(function (exit) {
                              if (exit instanceof Node_ChildProcess_1.Normally && (exit.value0 === 0 || exit.value0 === 1)) {
                                  return function __do() {
                                      ...
                                      if ($42 instanceof Data_Maybe.Just && $42.value0 instanceof Data_Either.Left) {
                                          return Data_Function.apply(err)(Control_Monad_Eff_Exception.error($42.value0.value0))();
                                      };
...
(function(exports) {
  ...
  var resultToString = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 35, column 1 - line 36, column 1: " + [ v.constructor.name ]);
  };
  var linterBuild = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Atom.getAtom))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readBoolean)(Atom_Config.getConfig(v1.config)("ide-purescript.addNpmPath"))))(function (v2) {
              return IdePurescript_Build.build({
                  command: new IdePurescript_Build.Command(v.command, v.args), 
                  directory: v.directory, 
                  useNpmDir: Data_Function.apply(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(v2)
              });
          });
      });
  };
  ...
  var toLintResult = function (res) {
      var range = function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Build line 71, column 3 - line 71, column 21: " + [ v.constructor.name ]);
      };
      var result = function (errorType) {
          return function (v) {
              var replace = function (v1) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 92, column 5 - line 96, column 8: " + [ v1.constructor.name ]);
              };
              return {
                  type: errorType, 
                  text: v.message, 
      ...
      return {
          ...
          result: Data_Function.apply(resultToString)((function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 67, column 13 - line 67, column 69: " + [ res.success.constructor.name ]);
          })())
      };
  };
                              ...
                              return function (msg) {
                                  return function __do() {
                                      ...
                                      return Data_Function.apply((function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 94, column 8 - line 94, column 43: " + [ $12.constructor.name ]);
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(IdePurescript_Atom_Build.toLintResult)(buildCmd))(function (v) {
                                      return Data_Function.apply(liftEffA)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(function __do() {
                                          ...
                                          status((function () {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 79, column 21 - line 79, column 68: " + [ $16.constructor.name ]);
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Atom_Config.getConfig(config)("ide-purescript.buildCommand")))(function (v1) {
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEffA(IdePurescript_Atom_Config.getFastRebuild))(function (v2) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 62, column 3 - line 67, column 20: " + [ fastBuild.constructor.name, $33.constructor.name ]);
                                      });
                                  });
                              });
                          });
...
(function(exports) {
  ...
  var replaceAnsiColor = function (text) {
      ...
      var colEscape = function (text1) {
          var $63 = IdePurescript_Regex["match'"](Data_String_Regex.regex("\\x1b\\[([0-9]+)m")(Data_String_Regex.noFlags))(text1);
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(function __do() {
                      ...
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.psciCommand"))))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(IdePurescript_Atom_LinterBuild.getProjectRoot(false)))(function (v3) {
                              var command = (function () {
                                  var $97 = Data_String_Regex.regex("\\s+")(Data_String_Regex.noFlags);
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)((function () {
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($140) {
...
(function(exports) {
  ...
  var parseVersion = function (s) {
      var $23 = Data_Function.apply(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Int.fromNumber))(Data_Functor.map(Data_Functor.functorArray)(Global.readInt(10))(Data_String.split(".")(s)));
      if ($23 instanceof Data_Maybe.Just && $23.value0.length === 3) {
          return Data_Function.apply(Data_Maybe.Just.create)(new Version($23.value0[0], $23.value0[1], $23.value0[2]));
      };
      return Data_Maybe.Nothing.value;
  };
  var liftEff$prime$prime = Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff);
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(PscIde_Server_1.pickFreshPort))(function (v) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                          ...
                          return Data_Functor.map(Control_Monad_Aff.functorAff)(r(v))(PscIde_Server_1.startServer((function () {
                              var $33 = {};
                              for (var $34 in PscIde_Server_1.defaultServerArgs) {
                                  if (PscIde_Server_1.defaultServerArgs.hasOwnProperty($34)) {
                                      $33[$34] = PscIde_Server_1.defaultServerArgs[$34];
                                  };
                              };
                              $33.exe = exe;
              ...
              var gotPath = function (port) {
                  return function (workingDir) {
                      return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                          ...
                          if ($36) {
                              return function __do() {
                                  Data_Function.apply(Control_Monad_Eff_Console.log)("Found psc-ide-server on port " + (Data_Show.show(Data_Show.showInt)(port) + (" with correct path: " + workingDir)))();
                                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new CorrectPath(port))();
                              };
                          };
                          if (!$36) {
                              return function __do() {
                                  Data_Function.apply(Control_Monad_Eff_Console.log)("Found psc-ide-server on port " + (Data_Show.show(Data_Show.showInt)(port) + (" with wrong path: " + (workingDir + (" instead of " + rootPath)))))();
  ...
  var startServer$prime = function (path) {
      return function (server) {
          return function (addNpmBin) {
              return function (glob) {
                  return function (cb) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(IdePurescript_Exec.getPathVar(addNpmBin)(path)))(function (v) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v)(server))(function (v1) {
                              ...
                              if ($59 instanceof Data_Maybe.Nothing) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Data_Function.apply(cb(Info.value))("Couldn't find psc-ide-server, check PATH. Looked for: " + (server + (" in PATH: " + Data_Either.either(Control_Category.id(Control_Category.categoryFn))(Control_Category.id(Control_Category.categoryFn))(v))))))(function () {
                                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)({
                              ...
                              if ($59 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Resolved psc-ide-server paths (1st is used):")))(function () {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v2) {
                                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)(v2.value0 + (": " + Data_Maybe.fromMaybe("ERROR")(v2.value1))));
                                      })(v1))(function () {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v1) > 1))(Data_Function.apply(cb(Warning.value))("Found multiple psc-ide-server executables; using " + $59.value0.value0))))(function () {
                                              ...
                                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer($59.value0.value0)(path)(glob$prime))(function (v2) {
                                                  ...
                                                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                                                      ...
                                                      if (v2 instanceof WrongPath) {
                                                          return function __do() {
                                                              Data_Function.apply(cb($$Error.value))("Found existing psc-ide-server on port '" + (Data_Show.show(Data_Show.showInt)(v2.value0) + ("' with wrong path: '" + (v2.value1 + "'. Correct, kill or configure a different port, and restart."))))();
                                                              return noRes;
                                                          };
                                                      };
                                                      if (v2 instanceof Started) {
                                                          return function __do() {
                                                              Data_Function.apply(cb(Success.value))("Started psc-ide-server (port " + (Data_Show.show(Data_Show.showInt)(v2.value0) + ")"))();
                                                              return {
                                                                  quit: Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(function (v3) {
                                                                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                                                  })(function (v3) {
                                                                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                                      ...
                                                      if (v2 instanceof StartError) {
                                                          return Data_Functor.voidRight(Control_Monad_Eff.functorEff)(noRes)(Data_Function.apply(cb($$Error.value))("Could not start psc-ide-server process. Check the configured port number is valid.\n" + v2.value0));
                                                      };
...
(function(exports) {
  ...
  var notify = function (notifications) {
      return function (level) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 41, column 30 - line 45, column 36: " + [ level.constructor.name ]);
      };
  };
  var startServer = function (path) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Atom.getAtom))(function (v) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readArray)(Atom_Config.getConfig(v.config)("ide-purescript.pscSourceGlob"))))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readBoolean)(Atom_Config.getConfig(v.config)("ide-purescript.addNpmPath"))))(function (v3) {
                      var srcGlob$prime = Data_Bifunctor.rmap(Data_Either.bifunctorEither)(Data_Function.apply(Data_Array.mapMaybe)(function ($9) {
                          return Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create)(Data_Foreign.readString($9));
                      }))(v2);
                      ...
                      var server = Data_Either.either(Data_Function["const"]("psc-ide-server"))(Control_Category.id(Control_Category.categoryFn))(v1);
                      var addNpmPath$prime = Data_Function.apply(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(v3);
                          ...
                          return function (v1) {
                              if (v1.suggestion.hasSuggestion) {
                                      ...
                                      return new Data_Maybe.Just({
                                          ...
                                          action: (function () {
                                              ...
                                              return function __do() {
                                                  ...
                                                  var replacement$prime = Data_Function.apply(Data_String.trim)(IdePurescript_Regex["replace'"](Data_String_Regex.regex("\\s+\n")((function () {
                                                      var $18 = {};
                                                      for (var $19 in Data_String_Regex.noFlags) {
                                                          if (Data_String_Regex.noFlags.hasOwnProperty($19)) {
                                                              $18[$19] = Data_String_Regex.noFlags[$19];
                                                          };
                                                      };
                                                      $18.global = true;
                                                      return $18;
                                                  ...
                                                  Atom_Editor.setTextInBufferRange(editor)(range1)(replacement$prime + (function () {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.QuickFixes line 78, column 50 - line 78, column 97: " + [ addNewline.constructor.name ]);
                                                  })())();
                                  ...
                                  return function __do() {
                                      ...
                                      var markerRow = Data_Maybe.maybe(0)(function ($43) {
                                          return Atom_Point.getRow(Atom_Range.getStart($43));
                                      })(v2);
                                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))((function () {
          ...
          var search = function (text) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.readRef(modulesState)))(function (v) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getLoadedModules(port))(function (v1) {
                      ...
                      return IdePurescript_PscIde["getCompletion'"](Data_Function.apply(Data_Maybe.Just.create)(new PscIde_Command.Flex(text)))([  ])(port)(v.main)("")(false)(v1)(getQualifiedModule);
                  });
              });
          };
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var getVar = Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Ref.readRef(v8)))(Data_Maybe.maybe(Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar["makeVar'"](Data_Unit.unit))(function (v9) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Ref.writeRef(v8))(new Data_Maybe.Just(v9))))(function () {
      ...
      var getPort = function (file) {
          return Data_Function.apply(Control_Monad_Maybe_Trans.runMaybeT)(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(Control_Monad_Eff_Ref.readRef(v7)))(function (v9) {
              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(PscIde_Project.getRoot(file)))(function (v10) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_StrMap_1.lookup(v10)(v9))))(function (v11) {
      ...
      var getPathActiveEditor = Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v9) {
          return Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Editor.getPath(v9));
      });
      var getPortActiveEditor = Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function (v9) {
          return Data_Functor.map(Control_Monad_Maybe_Trans.functorMaybeT(Control_Monad_Eff.monadEff))(function (v10) {
              return v10.port;
          })(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(getPort(v9)));
      }));
      var startPscIdeServer$prime = function (path) {
          var retry = function (a) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(a))(function (v9) {
                  ...
                  if (v9 instanceof Data_Either.Left) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Retrying starting server after 500ms: " + Data_Show.show(Control_Monad_Eff_Exception.showError)(v9.value0))))(function () {
          ...
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(getVar)(function (v9) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.takeVar(v9))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(PscIde_Project.getRoot(path)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                          if (v10 instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
                          };
                          if (v10 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Ref.readRef(v7)))(function (v11) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Applicative.when(Control_Monad_Aff.applicativeAff)(Data_Function.apply(Data_Maybe.isJust)(Data_StrMap_1.lookup(v10.value0)(v11))))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Not starting server - already started: " + path))))(function () {
                                      return Control_Applicative.unless(Control_Monad_Aff.applicativeAff)(Data_Function.apply(Data_Maybe.isJust)(Data_StrMap_1.lookup(v10.value0)(v11)))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer(v10.value0))(function (v12) {
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Loading modules: " + path)))(function () {
                                              return retry(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                                                  ...
                                                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                                                      ...
                                                      if (v12.port instanceof Data_Maybe.Just) {
                                                          return Data_Function.apply(Control_Monad_Eff_Ref.modifyRef(v7))(Data_StrMap_1.insert(v10.value0)({
                          ...
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Function.apply(Control_Monad_Eff_Console.log)("Finished initialising server: " + path)))(function () {
      ...
      var startPscIdeServer = Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function (v9) {
          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(Data_Function.apply(Control_Monad_Eff_Console.log)("Starting psc-ide-server for path: " + v9)))(function () {
              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Control_Monad_Aff.runAff(function (e) {
                  return Data_Function.apply(Control_Monad_Eff_Console.log)("Error starting server: " + Data_Show.show(Control_Monad_Eff_Exception.showError)(e));
          ...
          return function __do() {
              ...
              var v12 = (function () {
                  if (v11 instanceof Data_Maybe.Just) {
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Maybe.Just(v11.value0.root));
                  };
                  if (v11 instanceof Data_Maybe.Nothing) {
                      return Data_Function.apply(Control_Monad_Maybe_Trans.runMaybeT)(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function ($165) {
              ...
              if (v12 instanceof Data_Maybe.Just && (v9 instanceof Data_Maybe.Just && v10 instanceof Data_Maybe.Just)) {
                  return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(raiseError)(ignoreError))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(Data_Functor.map(Data_Maybe.functorMaybe)(function (v13) {
                      return v13.port;
                  })(v11))(file)(v.config)(v12.value0)(v9.value0)(v10.value0))(function (v13) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(Control_Monad_Eff_Ref.writeRef(v3))(v13)))(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v14) {
                              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(useEditor$prime(v2)(Data_Functor.map(Data_Maybe.functorMaybe)(function (v15) {
                                  return v15.port;
                              })(v11))(v14));
                          });
                      });
      ...
      var deactivate = function __do() {
          ...
          Data_Function.apply(Data_Traversable.sequence(Data_List.traversableList)(Control_Monad_Eff.applicativeEff))(Data_Functor.map(Data_List.functorList)(function (v10) {
              return v10.quit;
          })(Data_StrMap_1.values(v9)))();
      ...
      var activate = function __do() {
                  ...
                  if (v9 instanceof Data_Maybe.Just && Data_String.contains(".purs")(v9.value0)) {
                      return Atom_Editor.onDidSave(editor)(function (v10) {
                          return function __do() {
                              ...
                              var buildOnSaveEnabled = Data_Function.apply(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(Data_Foreign.readBoolean(v11));
          ...
          Atom_Workspace.onDidChangeActivePaneItem(v.workspace)(function (item) {
              return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Atom_Editor.toEditor(item))))(function (v9) {
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Editor.getPath(v9)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(getPort(v10)))(function (v11) {
                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))((function () {
                              if (v11 instanceof Data_Maybe.Just) {
                                  return function __do() {
                                      Data_Function.apply(Control_Monad_Eff_Console.log)("Switching to editor for file: " + v10)();
      ...
      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Foreign.toForeign({
          ...
          consumeLinterIndie: Data_Function_Eff.mkEffFn1(function (registry) {
              return function __do() {
                  ...
                  return Data_Function.apply(Control_Monad_Eff_Ref.writeRef(v1))(new Data_Maybe.Just(v9))();
              };
          }), 
          ...
          consumeStatusBar: Data_Function_Eff.mkEffFn1(function (statusBar) {
              return function __do() {
                  ...
                  Data_Function.apply(Control_Monad_Eff_Ref.writeRef(v5))(new Data_Maybe.Just(v9))();
          ...
          provideAutocomplete: function (v9) {
              return {
                  ...
                  onDidInsertSuggestion: Data_Function_Eff.mkEffFn1(function (x) {
                      return function __do() {
                          var v10 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Functor.map(Data_Functor.functorFn)(Data_Either.either(Data_Function["const"](false))(Control_Category.id(Control_Category.categoryFn)))(Data_Foreign.readBoolean))(Atom_Config.getConfig(v.config)("ide-purescript.autocomplete.addImport"))();
                          return withPort(function (port) {
                              return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v10)(Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(raiseError)(ignoreError))(IdePurescript_Atom_Imports.addSuggestionImport(port)(v2)(x))));
                          })();
                      };
                  })
              };
                  ...
                  getSuggestion: Data_Function_Eff.mkEffFn2(function (editor) {
                      return function (pos) {
                          return function __do() {
                              ...
                              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(Data_Nullable.toNullable)((function (v11) {
