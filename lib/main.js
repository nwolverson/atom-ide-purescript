  ...
  var getSuggestions = function (port) {
      return function (v) {
          var suggestionTypeAtomValue = function (s) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 98, column 33 - line 104, column 5: " + [ s.constructor.name ]);
          };
                  ...
                  return function (v1) {
                      var suggestType = (function () {
                          ...
                          if (!$15) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 135, column 16 - line 136, column 16: " + [ $16.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 134, column 11 - line 136, column 16: " + [ $15.constructor.name ]);
                      })();
                      return {
          ...
          if (moduleExplicit) {
              var $30 = IdePurescript_Regex["match'"](explicitImportRegex)(v.line);
              if ($30 instanceof Data_Maybe.Just && ($30.value0.length === 3 && ($30.value0[0] instanceof Data_Maybe.Just && ($30.value0[1] instanceof Data_Maybe.Just && $30.value0[2] instanceof Data_Maybe.Just)))) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getCompletion(port)(($30.value0[2]).value0)(v.moduleInfo.mainModule)(Data_Maybe.Nothing.value)([ ($30.value0[1]).value0 ])(v.moduleInfo.getQualifiedModule))(function (v1) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(result(new Data_Maybe.Just(($30.value0[1]).value0))(($30.value0[2]).value0))(v1));
                  });
              };
          ...
          if (!moduleExplicit) {
              if (parsed instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 76, column 9 - line 82, column 52: " + [ moduleCompletion.constructor.name ]);
              };
              if (parsed instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)([  ]);
              };
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 74, column 5 - line 83, column 25: " + [ parsed.constructor.name ]);
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 67, column 3 - line 83, column 25: " + [ moduleExplicit.constructor.name ]);
      };
  };
