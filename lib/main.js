          ...
          return function (filterKey) {
              return function (filterQuery) {
                  return function (getItems) {
                      return Data_Function_Eff.runEffFn5($foreign.selectListViewDynamicImpl)(viewForItem)(Data_Function_Eff.mkEffFn1(confirmed))(Data_Nullable.toNullable(filterKey))(filterQuery)(Data_Function_Eff.mkEffFn1(function (s) {
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($59.editor instanceof Data_Maybe.Just && ($59.linter instanceof Data_Maybe.Just && $59.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($59.editor.value0)($59.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      var pursuitSearch = (function () {
          ...
          })(Data_Maybe.Nothing.value)(Prelude["const"](""))(IdePurescript_PscIde.getPursuitCompletion);
      })();
      var doLint = function __do() {
          ...
          if ($73.root instanceof Data_Maybe.Just && ($73.linterIndie instanceof Data_Maybe.Just && $73.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($73.root.value0)($73.linterIndie.value0)($73.statusElt.value0))(function (v10) {
      ...
      var pursuitSearchModule = (function () {
          ...
          return IdePurescript_Atom_SelectView.selectListViewDynamic(view)(importDialog)(new Data_Maybe.Just("module"))(Prelude.id(Prelude.categoryFn))(IdePurescript_PscIde.getPursuitModuleCompletion);
      })();
