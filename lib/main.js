...
(function(exports) {
  ...
  var encodeImportCommand = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      ...
      throw new Error("Failed pattern match at PscIde.Command line 173, column 3 - line 176, column 23: " + [ v.constructor.name ]);
  });
  ...
  var encodeCommand = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      ...
      throw new Error("Failed pattern match at PscIde.Command line 104, column 3 - line 105, column 3: " + [ v.constructor.name ]);
  });
  exports["Cwd"] = Cwd;
  exports["Ls"] = Ls;
  exports["Quit"] = Quit;
  ...
  var getSuggestions = function (port) {
      return function (v) {
          ...
          if (parsed instanceof Data_Maybe.Just) {
              ...
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getCompletion(port)(parsed.value0.token)(v.moduleInfo.mainModule)(parsed.value0.mod)(v.moduleInfo.modules)(v.moduleInfo.getQualifiedModule)(opts))(function (v1) {
  ...
  var getSuggestions = function (port) {
      return function (info) {
          ...
          var convert = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 36, column 28 - line 71, column 16: " + [ v.constructor.name ]);
          };
...
(function(exports) {
  ...
  var getUnqualActiveModules = function (v) {
      return function (ident) {
          ...
          return Data_Functor.map(Data_Functor.functorArray)(getModuleName)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function ($111) {
              return Data_Array.singleton(mkImplicit($111));
  ...
  var getAllActiveModules = function (v) {
      return Data_Functor.map(Data_Functor.functorArray)(getModuleName)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function ($112) {
          return Data_Array.singleton(mkImplicit($112));
      })(v.main))(v.modules));
  };
          ...
          return function (fileName) {
              return function (text) {
                  return function (moduleName) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Modules line 157, column 3 - line 163, column 21: " + [ shouldAdd.constructor.name ]);
                  };
              };
          };
      };
                          ...
                          if (shouldAdd) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(withTempFile(fileName)(text)(addImport))(function (v) {
                                  var state$prime = (function () {
                                      if (v instanceof UpdatedImports) {
                                          var $107 = {};
                                          for (var $108 in state) {
                                              if ({}.hasOwnProperty.call(state, $108)) {
                                                  $107[$108] = state[$108];
                                              };
                                          };
                                          $107.identifiers = Data_Array.cons(identifier)(state.identifiers);
                                          return $107;
                                      };
                                      return state;
                                  })();
...
(function(exports) {
  ...
  var resultToString = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 62, column 1 - line 63, column 1: " + [ v.constructor.name ]);
  };
  ...
  var fixPosition = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 66, column 1 - line 68, column 20: " + [ v.constructor.name ]);
  };
                  ...
                  return function (res) {
                      return function (projdir) {
                          var range = function (v) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Build line 99, column 3 - line 99, column 54: " + [ v.constructor.name ]);
                          };
                          var result = function (errorType) {
                              return function (v) {
                                  var fixes = function (v1) {
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 128, column 5 - line 128, column 137: " + [ v1.constructor.name ]);
                                  };
