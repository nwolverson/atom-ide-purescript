...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var v2 = Control_Monad_Eff_Uncurried.runEffFn4(IdePurescript_Atom_Hooks_LanguageClient.makeLanguageClient)({
          ...
          return function __do() {
              ...
              var fwdCmd = function (name) {
                  return function (name$prime) {
                      return Atom_CommandRegistry.addCommand(v.commands)("atom-workspace")("ide-purescript:" + name)(Data_Function["const"](IdePurescript_Atom_Util.launchAffAndRaise(IdePurescript_Atom_Hooks_LanguageClient.executeCommand(conn)({
              ...
              cmd("fixTypo")(IdePurescript_Atom_Assist.fixTypo)();
              cmd("search")(IdePurescript_Atom_Search.localSearch)();
              cmd("pursuit-search")(function (v2) {
                  return IdePurescript_Atom_Search.pursuitSearch;
              })();
              cmd("pursuit-search-modules")(IdePurescript_Atom_Search.pursuitSearchModule)();
              fwdCmd$prime("build")();
              ...
              return IdePurescript_Atom_Hooks_LanguageClient.onCustom(conn)("window/logMessage")(function ($17) {
