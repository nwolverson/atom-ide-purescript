                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEff$prime$prime)(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                                  var $71 = v.activatedManually || autoCompleteAllModules;
                                  if ($71) {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 70, column 14 - line 70, column 136: " + [ $71.constructor.name ]);
                              })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var getPort = function (file) {
          return function __do() {
              ...
              var v9 = IdePurescript_Atom_LinterBuild.getRoot(file)();
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))((function () {
                  if (v9 instanceof Data_Maybe.Just) {
                      var $87 = Data_StrMap_1.lookup(v9.value0)(v8);
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Main line 146, column 11 - line 148, column 31: " + [ $87.constructor.name ]);
                  };
                  if (v9 instanceof Data_Maybe.Nothing) {
                      return Data_Maybe.Nothing.value;
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 144, column 7 - line 149, column 27: " + [ v9.constructor.name ]);
              })())();
          };
      };
      var getPortActiveEditor = function __do() {
          ...
          if (v8 instanceof Data_Maybe.Just) {
              var v9 = Atom_Editor.getPath(v8.value0)();
              var v10 = Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Maybe.Nothing.value))(getPort)(v9)();
              return Data_Functor.map(Data_Maybe.functorMaybe)(function (v11) {
                  return v11.port;
              })(v10);
          };
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 209, column 7 - line 214, column 32: " + [ v8.constructor.name ]);
      };
      var startPscIdeServer$prime = function (path) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(IdePurescript_Atom_LinterBuild.getRoot(path)))(function (v8) {
              if (v8 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              };
              if (v8 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer(v8.value0))(function (v9) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                          ...
                          return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 202, column 13 - line 204, column 91: " + [ v9.port.constructor.name ]);
                          });
                      });
                  });
              };
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 193, column 7 - line 204, column 91: " + [ v8.constructor.name ]);
          });
      };
      var startPscIdeServer = Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v8) {
      ...
      var quickFix = function __do() {
          ...
          if ($111.editor instanceof Data_Maybe.Just && ($111.linter instanceof Data_Maybe.Just && $111.n > 0)) {
              return withPort(function (port) {
                  return IdePurescript_Atom_QuickFixes.showQuickFixes(port)(v2)($111.editor.value0)($111.linter.value0)(v8);
              })();
          };
          return Data_Unit.unit;
      };
      var doLint = function (file) {
          return function __do() {
              ...
              if (v10 instanceof Data_Maybe.Just && (v8 instanceof Data_Maybe.Just && v9 instanceof Data_Maybe.Just)) {
                  return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Control_Monad_Aff.runAff(raiseError)(ignoreError))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(new Data_Maybe.Just(v10.value0.port))(file)(v.config)(v10.value0.root)(v8.value0)(v9.value0))(function (v11) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(Control_Monad_Eff_Ref.writeRef(v3))(v11)))(function () {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(PscIde_1.load(v10.value0.port)([  ])([  ]))(function () {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v12) {
                                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(useEditor$prime(v2)(new Data_Maybe.Just(v10.value0.port))(v12));
                              });
                          });
                      });
                  })))();
                          ...
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(getPort(v9)))(function (v10) {
                              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))((function () {
                                  ...
                                  if (v10 instanceof Data_Maybe.Nothing) {
                                      return function __do() {
                                          Data_Function.apply(Control_Monad_Eff_Console.log)("Starting server on changing to file: " + v9)();
                                          return startPscIdeServer();
                                      };
                                  };
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 261, column 9 - line 267, column 30: " + [ v10.constructor.name ]);
                              })());
                          });
                      });
                  })));
