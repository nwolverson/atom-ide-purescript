...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($47.editor instanceof Data_Maybe.Just && ($47.linter instanceof Data_Maybe.Just && $47.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($47.editor.value0)($47.linter.value0)(v6)();
          };
          return Prelude.unit;
      };
      var pursuitSearchModule = IdePurescript_Atom_Pursuit.pursuitSearchModules(function ($71) {
          return Control_Promise_1.fromAff(IdePurescript_PscIde.getPursuitModuleCompletion($71));
      })(Prelude["const"](Control_Monad_Eff_Console.log("Selected module")));
      var pursuitSearch = IdePurescript_Atom_Pursuit.pursuitSearch(function ($72) {
          return Control_Promise_1.fromAff(IdePurescript_PscIde.getPursuitCompletion($72));
      });
      var doLint = function __do() {
          ...
          if ($55.root instanceof Data_Maybe.Just && $55.linterIndie instanceof Data_Maybe.Just) {
              return Control_Monad_Aff.runAff(ignoreError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($55.root.value0)($55.linterIndie.value0))(function (v8) {
