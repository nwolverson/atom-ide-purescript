...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      ...
      return function ($23) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function["const"](Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($23));
      };
  })();
  var fixTypo = function (conn) {
      var view = function (v) {
          return Text_Smolder_Renderer_String.render(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.li)(Text_Smolder_HTML_Attributes.className("two-lines"))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("primary-line"))(Text_Smolder_Markup.text(v.identifier)))(function () {
              return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("secondary-line"))(Text_Smolder_Markup.text(v.mod));
          })));
      };
      var go = function (pos) {
          return function (uri) {
              return function (choice) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_Hooks_LanguageClient.executeCommand(conn)({
                      ...
                      if (v1 instanceof Data_Either.Right && Data_Array.length(v1.value0) > 0) {
                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(IdePurescript_Atom_SelectView.selectListViewStatic(view)(function ($24) {
                              return launchAffAndRaise(go(pos)(uri)(Data_Maybe.Just.create(Data_Foreign.toForeign($24))));
      ...
      return Control_Bind.bind(Control_Monad_Eff.bindEff)(IdePurescript_Atom_Editor.getActivePosInfo)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (v) {
          return launchAffAndRaise(go(v.pos)(v.uri)(Data_Maybe.Nothing.value));
      }));
  };
  ...
  var pursuitSearchModule = function (conn) {
      var view = function (v) {
          if (v.info.mod instanceof Data_Maybe.Just) {
              return Text_Smolder_Renderer_String.render(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.li)(Text_Smolder_HTML_Attributes.className("two-lines"))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("primary-line"))(Text_Smolder_Markup.text(v.info.mod.value0)))(function () {
                  return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("secondary-line"))(Text_Smolder_Markup.text(v["package"]));
              })));
          };
          return "";
      };
  ...
  var pursuitSearch = (function () {
      var view = function (v) {
          if (v.info.title instanceof Data_Maybe.Just && v.info.mod instanceof Data_Maybe.Just) {
              return Text_Smolder_Renderer_String.render(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.li)(Text_Smolder_HTML_Attributes.className("two-lines"))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("primary-line"))(Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_Markup.text(v.info.title.value0))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)((function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Smolder_Markup.bindMarkupM)(Text_Smolder_HTML.br)(function () {
                          return Text_Smolder_Markup.text(v.text);
                      });
                  });
              })))(function () {
                  return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.className("secondary-line"))(Text_Smolder_Markup.text(v.info.mod.value0 + (" (" + (v["package"] + ")"))));
              })));
          };
          return "";
      };
  ...
  var main = function __do() {
      ...
      var v2 = Control_Monad_Eff_Uncurried.runEffFn3(IdePurescript_Atom_Hooks_LanguageClient.makeLanguageClient)({
          ...
          return function __do() {
              ...
              cmd("fix-typo")(IdePurescript_Atom_Assist.fixTypo)();
