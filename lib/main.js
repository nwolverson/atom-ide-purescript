                          ...
                          return function (unqualModules) {
                              return function (getQualifiedModule) {
                                  var mods = (function () {
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.PscIde line 111, column 10 - line 111, column 108: " + [ moduleCompletion.constructor.name ]);
                                  })();
                                  ...
                                  return Data_Functor.map(Control_Monad_Aff.functorAff)(conv)(Data_Function.apply(eitherToErr)(PscIde.complete(port)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(mainFilter)(moduleFilters(mods)))(matcher)(currentModule)));
                              };
                          };
                      };
                  };
