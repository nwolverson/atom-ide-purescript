...
(function(exports) {
  ...
  var which = function (s) {
      return Control_Monad_Aff.makeAff(function (err) {
          return function (succ) {
              return Data_Function_Eff.runEffFn3($foreign.whichImpl)(s)(Data_Function_Eff.mkEffFn1(succ))(Data_Function_Eff.mkEffFn1(err));
          };
      });
  };
  exports["which"] = which;
...
(function(exports) {
  ...
  var PscIde = PS["PscIde"];        
  var getVersion = function (exe) {
      return Control_Monad_Aff.makeAff(function (err) {
          return function (succ) {
              return Node_ChildProcess.execFile(exe)([ "--version" ])(Node_ChildProcess.defaultExecOptions)(function (v) {
          ...
          return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(IdePurescript_Atom_LinterBuild.getProjectRoot))(function (v1) {
              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Foreign.readInt)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdePort"))))(function (v2) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffS(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Foreign.readString)(Atom_Config.getConfig(v.config)("ide-purescript.pscIdeServerExe"))))(function (v3) {
                      ...
                      if ($17.portRaw instanceof Data_Either.Right && ($17.serverRaw instanceof Data_Either.Right && $17.path instanceof Data_Maybe.Just)) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Alt["<|>"](Control_Monad_Aff.altAff)(Node_Which.which($17.serverRaw.value0))(Prelude.pure(Control_Monad_Aff.applicativeAff)([  ])))(function (v4) {
                              var $19 = Data_Array.head(v4);
                              if ($19 instanceof Data_Maybe.Nothing) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_Process.lookupEnv("PATH")))(function (v5) {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_NotificationManager.addError(v.notifications)("Couldn't find psc-ide-server, check PATH. Looked for: " + ($17.serverRaw.value0 + (" in PATH: " + Data_Maybe.fromMaybe("")(v5))))))(function () {
                              ...
                              if ($19 instanceof Data_Maybe.Just) {
                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Resolved psc-ide-server:")))(function () {
                                      return Prelude.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (x) {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Alt["<|>"](Control_Monad_Aff.altAff)(getVersion(x))(Prelude.pure(Control_Monad_Aff.applicativeAff)("Error getting version")))(function (v5) {
                                              return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(x + (": " + v5)));
                                          });
                                      })(v4))(function () {
                                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad.when(Control_Monad_Eff.monadEff)(Data_Array.length(v4) > 1)(Atom_NotificationManager.addWarning(v.notifications)("Found multiple psc-ide-server executables; using " + $19.value0))))(function () {
                                              return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($19.value0)($17.portRaw.value0)($17.path.value0))(function (v5) {
                                                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 68, column 26 - line 74, column 13: " + [ v5.constructor.name ]);
                                                  })()))(function (v6) {
                                                      if (v6 instanceof Data_Maybe.Nothing) {
                                                          return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit));
                                                      };
                                                      if (v6 instanceof Data_Maybe.Just) {
                                                          return Prelude.pure(Control_Monad_Aff.applicativeAff)(Control_Monad_Aff.launchAff(IdePurescript_PscIdeServer.stopServer($17.portRaw.value0)(v6.value0)));
                                                      };
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 74, column 13 - line 77, column 5: " + [ v6.constructor.name ]);
                                                  });
                                              });
                                          });
                                      });
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 55, column 9 - line 77, column 5: " + [ $19.constructor.name ]);
                          });
                      };
                      return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit));
                  });
