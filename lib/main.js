...
(function(exports) {
  ...
  var toEditor = function (item) {
      ...
      throw new Error("Failed pattern match at Atom.Editor line 39, column 3 - line 44, column 1: " + [ $0.constructor.name ]);
  };
  ...
  var getTextInRange = function ($1) {
      return Data_Function_Eff.runEffFn1($foreign.getTextInRangeImpl($1));
  };
                  ...
                  return Prelude.bind(dictMonad["__superclass_Prelude.Bind_1"]())(p(x))(function (v) {
                      return Prelude.bind(dictMonad["__superclass_Prelude.Bind_1"]())(filterM(dictMonad)(p)(xs))(function (v1) {
                          return Prelude["return"](dictMonad["__superclass_Prelude.Applicative_0"]())((function () {
                              ...
                              throw new Error("Failed pattern match at Data.Array line 382, column 12 - line 388, column 1: " + [ v.constructor.name ]);
                          })());
                      });
                  });
              };
                  ...
                  return Node_ChildProcess.onClose(v1)(function (exit) {
                      if (exit instanceof Node_ChildProcess.Normally && (exit.value0 === 0 || exit.value0 === 1)) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Build line 53, column 7 - line 57, column 5: " + [ $11.constructor.name ]);
                          };
                      };
      ...
      return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Build.build({
          ...
          return Prelude.pure(Control_Monad_Aff.applicativeAff)({
              ...
              result: resultToString((function () {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Build line 45, column 30 - line 46, column 3: " + [ v1.success.constructor.name ]);
              })())
          });
      });
  };
...
(function(exports) {
  ...
  var encodePursuitType = new Data_Argonaut_Encode.EncodeJson(function ($75) {
      return Data_Argonaut_Encode.encodeJson(Data_Argonaut_Encode.encodeJsonJString)(Prelude.show(showPursuitType)($75));
  });
  ...
  var decodeMessage = new Data_Argonaut_Decode.DecodeJson(function (json) {
      return Data_Maybe.maybe(new Data_Either.Left("Message not string"))(function ($76) {
          return Data_Either.Right.create(Message($76));
  ...
  var encodeCommand = new Data_Argonaut_Encode.EncodeJson(function (v) {
      ...
      throw new Error("Failed pattern match at PscIde.Command line 85, column 3 - line 86, column 3: " + [ v.constructor.name ]);
  });
...
(function(exports) {
          ...
          return function (getQualifiedModule) {
              ...
              if (!$16) {
                  ...
                  if (!$17) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIde line 80, column 5 - line 85, column 1: " + [ $18.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at IdePurescript.PscIde line 76, column 8 - line 85, column 1: " + [ $17.constructor.name ]);
              };
              throw new Error("Failed pattern match at IdePurescript.PscIde line 74, column 3 - line 85, column 1: " + [ $16.constructor.name ]);
          };
      };
  };
  var eitherToErr = function (c) {
      return Prelude.bind(Control_Monad_Aff.bindAff)(c)(function (v) {
          ...
          throw new Error("Failed pattern match at IdePurescript.PscIde line 27, column 3 - line 31, column 1: " + [ v.constructor.name ]);
      });
  };
  var result = function ($54) {
      return Control_Promise.fromAff(eitherToErr($54));
  };
  var result$prime = function (f) {
      return function (a) {
          return result(Prelude["<$>"](Control_Monad_Aff.functorAff)(Prelude["<$>"](Data_Either.functorEither)(f))(a));
      };
  };
  var resultA = function (f) {
      return function (a) {
          return eitherToErr(Prelude["<$>"](Control_Monad_Aff.functorAff)(Prelude["<$>"](Data_Either.functorEither)(f))(a));
      };
  };
  var loadDepsA = function (main) {
      return resultA(runMsg)(PscIde.load([  ])([ main ]));
  };
  ...
  var cwdA = resultA(runMsg)(PscIde.cwd);
  var cwd = result$prime(runMsg)(PscIde.cwd);
  ...
  var getPursuitModuleCompletion = function (str) {
      ...
      return result$prime(Prelude.map(Prelude.functorArray)(convPursuitModuleCompletion))(complete(str));
  };
  ...
  var getPursuitCompletion = function (str) {
      return result$prime(Prelude.map(Prelude.functorArray)(convPursuitCompletion))(PscIde.pursuitCompletion(str));
  };
              ...
              return function (unqualModules) {
                  return function (getQualifiedModule) {
                      var mods = (function () {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.PscIde line 119, column 10 - line 120, column 3: " + [ moduleCompletion.constructor.name ]);
                      })();
  ...
  var abbrevType = (function () {
      var r = Data_String_Regex.regex("(?:\\w+\\.)+(\\w+)")((function () {
          var $48 = {};
          for (var $49 in Data_String_Regex.noFlags) {
              if (Data_String_Regex.noFlags.hasOwnProperty($49)) {
                  $48[$49] = Data_String_Regex.noFlags[$49];
              };
          };
          $48.global = true;
          return $48;
  ...
  var getTypeA = function (text) {
      return function (modulePrefix) {
          return function (unqualModules) {
              return function (getQualifiedModule) {
                  var mods = moduleFilterModules(modulePrefix)(unqualModules)(getQualifiedModule);
                  var conv = function (r) {
                      var $52 = Data_Array.head(Prelude.map(Prelude.functorArray)(convCompletion)(r));
                      if ($52 instanceof Data_Maybe.Just) {
                          return abbrevType($52.value0.type);
                      };
                      if ($52 instanceof Data_Maybe.Nothing) {
                          return "";
                      };
                      throw new Error("Failed pattern match at IdePurescript.PscIde line 100, column 14 - line 104, column 1: " + [ $52.constructor.name ]);
                  };
                  return resultA(conv)(PscIde["type'"](text)(moduleFilters(mods)));
              };
          };
      };
  };
  ...
  exports["convPursuitModuleCompletion"] = convPursuitModuleCompletion;
  exports["convPursuitCompletion"] = convPursuitCompletion;
  exports["getPursuitCompletion"] = getPursuitCompletion;
  exports["loadDepsA"] = loadDepsA;
  exports["convCompletion"] = convCompletion;
  exports["getCompletion"] = getCompletion;
  exports["getTypeA"] = getTypeA;
  exports["abbrevType"] = abbrevType;
  exports["moduleFilters"] = moduleFilters;
  exports["moduleFilterModules"] = moduleFilterModules;
  exports["runMsg"] = runMsg;
  exports["cwd"] = cwd;
  exports["cwdA"] = cwdA;
  exports["resultA"] = resultA;
  exports["eitherToErr"] = eitherToErr;
  exports["result"] = result;
  exports["decodeModuleCompletion"] = decodeModuleCompletion;;
...
(function(exports) {
  ...
  var getSuggestions = function (v) {
      var suggestionTypeAtomValue = function (s) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 65, column 33 - line 71, column 5: " + [ s.constructor.name ]);
      };
          ...
          return function (v1) {
              var suggestType = (function () {
                  ...
                  if (!$12) {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 91, column 16 - line 92, column 16: " + [ $13.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 90, column 11 - line 92, column 16: " + [ $12.constructor.name ]);
              })();
              return {
                  text: v1.identifier, 
                  displayText: (function () {
                      if (suggestType instanceof Type) {
                          return v1.identifier + (" " + v1.type);
                      };
                      return v1.identifier + (": " + v1.type);
                  })(), 
      ...
      var parsed = (function () {
          var $17 = Data_String_Regex_1.match(moduleRegex)(v.line);
          if ($17 instanceof Data_Maybe.Just && ($17.value0.length === 3 && ($17.value0[0] instanceof Data_Maybe.Just && (Prelude["/="](Data_Maybe.eqMaybe(Prelude.eqString))($17.value0[1])(Data_Maybe.Nothing.value) || Prelude["/="](Data_Maybe.eqMaybe(Prelude.eqString))($17.value0[2])(Data_Maybe.Nothing.value))))) {
              return new Data_Maybe.Just({
                  mod: Data_Maybe.fromMaybe("")($17.value0[1]), 
                  token: Data_Maybe.fromMaybe("")($17.value0[2])
              });
          };
          return Data_Maybe.Nothing.value;
      })();
      ...
      if (parsed instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 47, column 7 - line 54, column 5: " + [ moduleCompletion.constructor.name ]);
      };
      if (parsed instanceof Data_Maybe.Nothing) {
          return Prelude["return"](Control_Monad_Aff.applicativeAff)([  ]);
      };
      throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 45, column 6 - line 55, column 3: " + [ parsed.constructor.name ]);
  };
...
(function(exports) {
  ...
  var exists = function (file) {
      return Prelude["return"](Control_Monad_Eff.applicativeEff)(fs.existsSync(file));
  };
          ...
          return function (linter) {
              ...
              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffA(Atom_Atom.getAtom))(function (v) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEffA(Atom_Config.getConfig(config)("ide-purescript.buildCommand")))(function (v1) {
                      var buildCommand = Data_Either.either(Prelude["const"]([  ]))(function ($32) {
                          return Data_String_Regex.split(Data_String_Regex.regex("\\s+")(Data_String_Regex.noFlags))(Data_String.trim($32));
                      })(Data_Foreign.readString(v1));
                      var $11 = Data_Array.uncons(buildCommand);
                      if ($11 instanceof Data_Maybe.Just) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_NotificationManager.addInfo(v.notifications)("Building PureScript")))(function () {
                              return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_Build.linterBuild({
                                  command: $11.value0.head, 
                                  args: $11.value0.tail, 
                                  directory: projdir
                              }))(function (v2) {
                                  return liftEffA(Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(function __do() {
                                      ...
                                      (function () {
                                          var $14 = v2.result === "success";
                                          if ($14) {
                                              return Atom_NotificationManager.addSuccess(v.notifications)("PureScript build succeeded");
                                          };
                                          if (!$14) {
                                              return Atom_NotificationManager.addWarning(v.notifications)("PureScript build completed with errors");
                                          };
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 89, column 11 - line 91, column 11: " + [ $14.constructor.name ]);
                                      })()();
                                      return v2.messages;
                                  }));
                              });
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 81, column 3 - line 95, column 3: " + [ $11.constructor.name ]);
                  });
              });
          };
      };
      ...
      var getRoot = function (path) {
          ...
          if (!$20) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 68, column 7 - line 70, column 3: " + [ v.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 64, column 5 - line 70, column 3: " + [ $20.constructor.name ]);
      };
      return function __do() {
          ...
          if ($27 instanceof Data_Maybe.Just) {
              Control_Monad.when(Control_Monad_Eff.monadEff)(!Data_Array["null"]($27.value0.tail))(Atom_NotificationManager.addWarning(v.notifications)("Multiple project roots, using first: " + $27.value0.head))();
              Control_Monad.when(Control_Monad_Eff.monadEff)(Data_Array["null"]($27.value0.tail) && Data_Array.length(v2) > 1)(Atom_NotificationManager.addWarning(v.notifications)("Multiple project roots but only 1 looks valid: " + $27.value0.head))();
              var output = Node_Path.concat([ $27.value0.head, "output" ]);
              ...
              return new Data_Maybe.Just($27.value0.head);
          };
          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 38, column 3 - line 49, column 3: " + [ $27.constructor.name ]);
      };
  })();
  exports["lint"] = lint;
...
(function(exports) {
  ...
  var getModuleName = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Modules line 22, column 1 - line 23, column 1: " + [ v.constructor.name ]);
  };
  ...
  var getUnqualActiveModules = function (v) {
      return Prelude.map(Prelude.functorArray)(getModuleName)(Prelude["++"](Prelude.semigroupArray)(Data_Maybe.maybe([  ])(function ($43) {
          return Data_Array.singleton(Unqualified.create($43));
      })(v.main))(v.modules));
  };
  var getMainModule = function (text) {
      ...
      var $27 = Data_String_Regex.match(regex)(text);
      if ($27 instanceof Data_Maybe.Just && ($27.value0.length === 2 && $27.value0[1] instanceof Data_Maybe.Just)) {
          return new Data_Maybe.Just(($27.value0[1]).value0);
      };
      return Data_Maybe.Nothing.value;
  };
  var getModulesForFile = function (file) {
      return function (fullText) {
          var mod = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Modules line 47, column 3 - line 48, column 3: " + [ v.constructor.name ]);
          };
      ...
      return function (pos) {
          ...
          return function __do() {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Promise.fromAff(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.getTypeA(word)("")(IdePurescript_Modules.getUnqualActiveModules(state))(Prelude.flip(IdePurescript_Modules.getQualModule)(state)))(function (v4) {
                      return Prelude.pure(Control_Monad_Aff.applicativeAff)({
          ...
          return function (rootPath) {
              var launchServer = Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Starting psc-ide-server")))(function () {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Node_ChildProcess.spawn(exe)([ "-p", Prelude.show(Prelude.showInt)(port) ])((function () {
                      var $4 = {};
                      for (var $5 in Node_ChildProcess.defaultSpawnOptions) {
                          if (Node_ChildProcess.defaultSpawnOptions.hasOwnProperty($5)) {
                              $4[$5] = Node_ChildProcess.defaultSpawnOptions[$5];
                          };
                      };
                      $4.cwd = new Data_Maybe.Just(rootPath);
                      return $4;
                  })())))(function (v) {
              ...
              var gotPath = function (workingDir) {
                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 45, column 15 - line 52, column 28: " + [ $12.constructor.name ]);
                  })());
              };
              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(IdePurescript_PscIde.cwdA))(function (v) {
                      ...
                      if ($10.portRaw instanceof Data_Either.Right && ($10.serverRaw instanceof Data_Either.Right && $10.path instanceof Data_Maybe.Just)) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIdeServer.startServer($10.serverRaw.value0)($10.portRaw.value0)($10.path.value0))(function (v4) {
                              return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 43, column 32 - line 49, column 9: " + [ v4.constructor.name ]);
                              })()))(function (v5) {
                                  ...
                                  if (v5 instanceof Data_Maybe.Just) {
                                      return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude["void"](Control_Monad_Eff.functorEff)(Node_ChildProcess.kill(Data_Posix_Signal.SIGKILL.value)(v5.value0)));
                                  };
                                  throw new Error("Failed pattern match at IdePurescript.Atom.PscIdeServer line 49, column 9 - line 52, column 5: " + [ v5.constructor.name ]);
                              });
                          });
                      };
                      return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit));
...
})(PS["IdePurescript.Atom.Pursuit"] = PS["IdePurescript.Atom.Pursuit"] || {});
(function(exports) {
  // Generated by psc version 0.8.0.0
  "use strict";
  var $foreign = PS["IdePurescript.Atom.Pursuit"];
  var Prelude = PS["Prelude"];
  var Data_Function_Eff = PS["Data.Function.Eff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Promise = PS["Control.Promise"];     
  var pursuitSearchModules = function (searchFn) {
      return function (importFn) {
          return Data_Function_Eff.runEffFn2($foreign.pursuitSearchModulesImpl)(Data_Function_Eff.mkEffFn1(searchFn))(Data_Function_Eff.mkEffFn1(importFn));
      };
  };
  var pursuitSearch = function (searchFn) {
      return Data_Function_Eff.runEffFn1($foreign.pursuitSearchImpl)(Data_Function_Eff.mkEffFn1(searchFn));
  };
  exports["pursuitSearchModules"] = pursuitSearchModules;
...
(function(exports) {
  ...
  var IdePurescript_Atom_Pursuit = PS["IdePurescript.Atom.Pursuit"];     
      ...
      return function (editor) {
          return function __do() {
              ...
              if (mainModule instanceof Data_Maybe.Just) {
                  return Control_Monad_Aff.runAff(ignoreError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_PscIde.loadDepsA(mainModule.value0))(function () {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 62, column 3 - line 70, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  var getSuggestions = function (state) {
      return function (v) {
          ...
          return function __do() {
              ...
              return Control_Promise.fromAff(IdePurescript_Atom_Completion.getSuggestions({
                  line: v1, 
                  moduleInfo: {
                      modules: modules, 
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          var v8 = Control_Monad_Eff_Ref.readRef(v4)();
          var $46 = {
              editor: v7, 
              linter: v8, 
              n: Data_Array.length(v6)
          };
          if ($46.editor instanceof Data_Maybe.Just && ($46.linter instanceof Data_Maybe.Just && $46.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($46.editor.value0)($46.linter.value0)(v6)();
          };
          return Prelude.unit;
      };
      var pursuitSearchModule = IdePurescript_Atom_Pursuit.pursuitSearchModules(IdePurescript_PscIde.getPursuitModuleCompletion)(Prelude["const"](Control_Monad_Eff_Console.log("Selected module")));
      var pursuitSearch = IdePurescript_Atom_Pursuit.pursuitSearch(IdePurescript_PscIde.getPursuitCompletion);
      var doLint = function __do() {
          var v6 = IdePurescript_Atom_LinterBuild.getProjectRoot();
          var v7 = Control_Monad_Eff_Ref.readRef(v1)();
          var $54 = {
              root: v6, 
              linterIndie: v7
          };
          if ($54.root instanceof Data_Maybe.Just && $54.linterIndie instanceof Data_Maybe.Just) {
              return Control_Monad_Aff.runAff(ignoreError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($54.root.value0)($54.linterIndie.value0))(function (v8) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(Control_Monad_Eff_Ref.writeRef(v3))(v8)))(function () {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Atom_Workspace.getActiveTextEditor(v.workspace)))(function (v9) {
                          return Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(useEditor(v2))(v9)))(function () {
                              return Prelude.pure(Control_Monad_Aff.applicativeAff)(Prelude.unit);
                          });
                      });
                  });
      ...
      var activate = function __do() {
          Atom_CommandRegistry.addCommand(v.commands)("atom-workspace")("purescript:build")(Prelude["const"](doLint))();
          Atom_CommandRegistry.addCommand(v.commands)("atom-workspace")("purescript:show-quick-fixes")(Prelude["const"](quickFix))();
          Atom_CommandRegistry.addCommand(v.commands)("atom-workspace")("purescript:pursuit-search")(Prelude["const"](pursuitSearch))();
          Atom_CommandRegistry.addCommand(v.commands)("atom-workspace")("purescript:pursuit-search-modules")(Prelude["const"](pursuitSearchModule))();
          Atom_Workspace.observeTextEditors(v.workspace)(function (editor) {
              return function __do() {
                  useEditor(v2)(editor)();
                  return Atom_Editor.onDidSave(editor)(function (v6) {
                      return function __do() {
                          var v7 = Atom_Config.getConfig(v.config)("ide-purescript.buildOnSave")();
                          return Control_Monad.when(Control_Monad_Eff.monadEff)(Data_Either.either(Prelude["const"](false))(Prelude.id(Prelude.categoryFn))(Data_Foreign.readBoolean(v7)))(doLint)();
                      };
                  })();
              };
          })();
          ...
          Control_Monad_Aff.runAff(function (v6) {
              return Control_Monad_Eff_Console.log("Error starting server");
          })(function (deact) {
              return Control_Monad_Eff_Ref.writeRef(v5)(deact);
      ...
      return {
          ...
          consumeLinterIndie: Data_Function_Eff.mkEffFn1(function (registry) {
              return function __do() {
                  var v6 = IdePurescript_Atom_Hooks_Linter.register(registry)({
                      name: "PureScript"
                  })();
                  return Control_Monad_Eff_Ref.writeRef(v1)(new Data_Maybe.Just(v6))();
              };
          }), 
          ...
          provideAutocomplete: function (v6) {
              return {
                  ...
                  getSuggestions: Data_Function_Eff.mkEffFn1(function (x) {
                      return function __do() {
                          var v7 = Control_Monad_Eff_Ref.readRef(v2)();
                          return getSuggestions(v7)(x)();
                      };
                  })
              };
          }
