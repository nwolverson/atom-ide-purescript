...
(function(exports) {
  ...
  var encodeImportCommand = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      ...
      throw new Error("Failed pattern match at PscIde.Command line 154, column 3 - line 157, column 23: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      ...
      return function ($87) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function.apply(Data_Function["const"])(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($87));
      };
  })();
                              ...
                              return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Aff.monadAff))(Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(IdePurescript_PscIde.getTypeInfo(port)(v3.word)(v4.main)(prefix)(Data_Function.apply(IdePurescript_Modules.getUnqualActiveModules(v4))(new Data_Maybe.Just(v3.word)))(Data_Function.apply(Data_Function.flip(IdePurescript_Modules.getQualModule))(v4))))(function (v5) {
                                  if (v5 instanceof Data_Maybe.Just && v5.value0.position instanceof Data_Maybe.Just) {
                                      return Data_Function.apply(Control_Monad_Trans.lift(Control_Monad_Maybe_Trans.monadTransMaybeT)(Control_Monad_Aff.monadAff))(Data_Function.apply(liftEff$prime$prime)(Atom_Workspace.open(v.workspace)(v5.value0.position.value0.name)((function () {
                                          var $35 = {};
                                          for (var $36 in Atom_Workspace.defaultOpenOptions) {
                                              if (Atom_Workspace.defaultOpenOptions.hasOwnProperty($36)) {
                                                  $35[$36] = Atom_Workspace.defaultOpenOptions[$36];
                                              };
                                          };
                                          $35.initialLine = v5.value0.position.value0.start.line - 1;
                                          $35.initialColumn = v5.value0.position.value0.start.column - 1;
                                          return $35;
                      ...
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Maybe_Trans.MaybeT)(Atom_Editor.getPath(v8)))(function (v9) {
                          return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))(getPort(v9)))(function (v10) {
                              return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff)))((function () {
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 249, column 9 - line 253, column 39: " + [ v10.constructor.name ]);
                              })());
                          });
                      });
                  })));
