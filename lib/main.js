  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($102.editor instanceof Data_Maybe.Just && ($102.linter instanceof Data_Maybe.Just && $102.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($102.editor.value0)($102.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      ...
      var doLint = function __do() {
          ...
          if ($124.root instanceof Data_Maybe.Just && ($124.linterIndie instanceof Data_Maybe.Just && $124.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($124.root.value0)($124.linterIndie.value0)($124.statusElt.value0))(function (v10) {
          ...
          return function __do() {
              ...
              if (v7 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v8)(v10)(v9)(moduleName))(function (v11) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($231) {
