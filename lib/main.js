...
(function(exports) {
  ...
  var translateConfig = function (config1) {
      return Data_Either.either(Data_Function["const"](Data_Foreign.toForeign({})))(Control_Category.id(Control_Category.categoryFn))(Control_Monad_Except.runExcept((function () {
          var unchanged = [ "pursExe", "useCombinedExe", "pscIdeServerExe", "addNpmPath", "buildCommand", "fastRebuild", "censorWarnings", "editorMode", "polling", "pscIdelogLevel", "autoStartPscIde", "addPscPackageSources", "addSpagoSources", "pscIdePort" ];
...
})(PS["IdePurescript.Atom.Main"] = PS["IdePurescript.Atom.Main"] || {});module.exports = PS["IdePurescript.Atom.Main"].main()
