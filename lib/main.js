                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime((function () {
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($140) {
                                      ...
                                      return liftEff$prime$prime(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (proc) {
                                          return Control_Monad_Eff_Exception.catchException(Data_Function["const"](Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))(function __do() {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 282, column 5 - line 293, column 27: " + [ v5.constructor.name ]);
                                          });
                                      })(v4));
                                  });
                              });
  ...
  var activate = function __do() {
      ...
      var close = function __do() {
          ...
          if (v3 instanceof Data_Maybe.Just && v4 instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 314, column 13 - line 316, column 35: " + [ v5.constructor.name ]);
          };
          return Data_Unit.unit;
      };
          ...
          return function (name) {
              return function (action) {
                  var scope = (function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 337, column 23 - line 338, column 3: " + [ isEditor.constructor.name ]);
                  })();
                                          ...
                                          action: (function () {
                                              ...
                                              return function __do() {
                                                  ...
                                                  Atom_Editor.setTextInBufferRange(editor)(range1)(replacement$prime + (function () {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.QuickFixes line 79, column 50 - line 79, column 97: " + [ addNewline.constructor.name ]);
                                                  })())();
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Atom_Editor.getPath(v9)))(function (v10) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(getPort(v10)))(function (v11) {
                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))((function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 285, column 9 - line 289, column 39: " + [ v11.constructor.name ]);
                          })());
                      });
                  });
              })));
