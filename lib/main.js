...
(function(exports) {
  ...
  var decodeJsonInt = new DecodeJson(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function ($34) {
      return Data_Maybe.maybe(new Data_Either.Left("Value is not an integer"))(Data_Either.Right.create)(Data_Int.fromNumber($34));
  })(decodeJson(decodeJsonNumber)));
  var decodeJObject = function ($35) {
      return Data_Maybe.maybe(new Data_Either.Left("Value is not an Object"))(Data_Either.Right.create)(Data_Argonaut_Core.toObject($35));
  };
  var decodeJsonMaybe = function (dictDecodeJson) {
      return new DecodeJson(function (j) {
          var lookupJust = function ($36) {
              return Data_Maybe.maybe(new Data_Either.Left("Missing property 'just'"))(Data_Either.Right.create)(Data_StrMap.lookup("just")($36));
          };
  ...
  var decodeStrMap = function (dictDecodeJson) {
      return new DecodeJson(function ($37) {
          ...
          })(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(Data_Traversable.traverse(Data_StrMap.traversableStrMap)(Data_Either.applicativeEither)(decodeJson(dictDecodeJson)))(decodeJObject)($37));
      });
  };
  var decodeJArray = function ($38) {
      return Data_Maybe.maybe(new Data_Either.Left("Value is not an Array"))(Data_Either.Right.create)(Data_Argonaut_Core.toArray($38));
  };
  var decodeArray = function (dictDecodeJson) {
      return new DecodeJson(function ($41) {
          return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(function (v) {
              return "Couldn't decode Array: " + v;
          })(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(decodeJson(dictDecodeJson)))(decodeJArray)($41));
      });
  };
  ...
  var getSuggestions = function (port) {
      return function (info) {
          ...
          var convert = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Completion line 33, column 28 - line 68, column 16: " + [ v.constructor.name ]);
          };
          ...
          return Control_Monad_Aff.makeAff(function (err) {
              return function (succ) {
                  return function __do() {
                      ...
                      return Control_Monad_Eff_Unsafe.unsafeCoerceEff(DOM_Event_EventTarget.addEventListener(DOM_HTML_Event_EventTypes.blur)(DOM_Event_EventTarget.eventListener(close(false)))(true)(DOM_Node_Types.elementToEventTarget(v5)))();
                  };
              };
          });
      };
...
(function(exports) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(tmpFile)(text))(function () {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(action(tmpFile))(function (v1) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)((function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Node_FS_Aff.unlink(tmpFile))(function () {
  ...
  var getUnqualActiveModules = function (v) {
      return function (ident) {
          ...
          return Data_Functor.map(Data_Functor.functorArray)(getModuleName)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function ($103) {
              return Data_Array.singleton(mkImplicit($103));
                          ...
                          if (shouldAdd) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(withTempFile(fileName)(text)(addImport))(function (v) {
                                  var state$prime = (function () {
                                      if (v instanceof UpdatedImports) {
                                          var $99 = {};
                                          for (var $100 in state) {
                                              if ({}.hasOwnProperty.call(state, $100)) {
                                                  $99[$100] = state[$100];
                                              };
                                          };
                                          $99.identifiers = Data_Array.cons(identifier)(state.identifiers);
                                          return $99;
                                      };
                                      return state;
                                  })();
...
(function(exports) {
  ...
  var launchAffAndRaise = (function () {
      ...
      return function ($112) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Aff.runAff(raiseError)(Data_Function["const"](Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit)))($112));
      };
  })();
...
(function(exports) {
  ...
  var toActualStdIOOptions = Data_Functor.map(Data_Functor.functorArray)(function ($32) {
      return Data_Nullable.toNullable(Data_Functor.map(Data_Maybe.functorMaybe)(toActualStdIOBehaviour)($32));
  });
  var spawn = function (cmd) {
      return function (args) {
          ...
          return function ($33) {
              return $foreign.spawnImpl(cmd)(args)(convertOpts($33));
          };
      };
  }; 
  ...
  var mkExit = function (code) {
      return function (signal) {
          var fromSignal = Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Data_Nullable.toMaybe)(function ($35) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(BySignal.create)(Data_Posix_Signal.fromString($35));
          });
          var fromCode = function ($36) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(Normally.create)(Data_Nullable.toMaybe($36));
          };
...
(function(exports) {
  ...
  var resultToString = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 60, column 1 - line 61, column 1: " + [ v.constructor.name ]);
  };
  ...
  var fixPosition = function (v) {
      ...
      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 64, column 1 - line 66, column 20: " + [ v.constructor.name ]);
  };
                          ...
                          var result = function (errorType) {
                              return function (v) {
                                  var fixes = function (v1) {
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.Atom.Build line 125, column 5 - line 125, column 137: " + [ v1.constructor.name ]);
                                  };
                          ...
                          return function (logCb) {
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(IdePurescript_Exec.getPathVar(addNpmBin)(path)))(function (v) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v)(server))(function (v1) {
                                      ...
                                      if (v2 instanceof Data_Maybe.Just) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Resolved psc-ide-server paths (1st is used):")))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v3) {
                                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log(v3.value0 + (": " + Data_Maybe.fromMaybe("ERROR")(v3.value1))));
                                              })(v1))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v1) > 1)(cb(Warning.value)("Found multiple psc-ide-server executables; using " + v2.value0.value0))))(function () {
                                                      ...
                                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(startServer(v2.value0.value0)(path)(glob$prime)(usePurs))(function (v3) {
                                                          ...
                                                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                                              ...
                                                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 101, column 17 - line 115, column 142: " + [ v3.constructor.name ]);
                                                          })());
                                                      });
                                                  });
                                              });
                                      ...
                                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 88, column 3 - line 115, column 142: " + [ v2.constructor.name ]);
                                  });
                              });
                          };
                      };
...
(function(exports) {
      ...
      return function (cb) {
          return function __do() {
              ...
              return Atom_Workspace.open(v.workspace)(paneUri)((function () {
                  var $82 = {};
                  for (var $83 in Atom_Workspace.defaultOpenOptions) {
                      if ({}.hasOwnProperty.call(Atom_Workspace.defaultOpenOptions, $83)) {
                          $82[$83] = Atom_Workspace["defaultOpenOptions"][$83];
                      };
                  };
                  $82.split = "right";
                  $82.activatePane = false;
                  return $82;
  ...
  var replaceAnsiColor = function (text) {
      ...
      var colorCss = function (n) {
          return "color: " + Data_Maybe.maybe("black")(function ($161) {
              return renderRgbCss(xtermColor($161));
          })(colorForCode(n));
      };
  ...
  var clearText = function (v) {
      ...
      return Control_Monad_Eff.whileE(DOM_Node_Node.hasChildNodes(node))(function __do() {
          ...
          return Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($162) {
              return Data_Functor["void"](Control_Monad_Eff.functorEff)(Data_Function.flip(DOM_Node_Node.removeChild)(node)($162));
          })(v1)();
      });
  };
          ...
          return function __do() {
              ...
              return Data_Maybe.maybe(Control_Monad_Eff_Console.log("appendText failed"))(function (lines$prime) {
                  return function __do() {
                      ...
                      var v4 = DOM_Util.getScrollHeight(lines$prime)();
                      return DOM_Util.setScrollTop(lines$prime)(v4)();
                  };
              })(v2)();
          };
      };
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime((function () {
                                  ...
                                  if (v3 instanceof Data_Maybe.Just && v4 instanceof Data_Maybe.Just) {
                                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Node_ChildProcess.spawn(v4.value0.head)(v4.value0.tail)((function () {
                                          var $125 = {};
                                          for (var $126 in Node_ChildProcess.defaultSpawnOptions) {
                                              if ({}.hasOwnProperty.call(Node_ChildProcess.defaultSpawnOptions, $126)) {
                                                  $125[$126] = Node_ChildProcess["defaultSpawnOptions"][$126];
                                              };
                                          };
                                          $125.cwd = v3;
                                          return $125;
                                  ...
                                  throw new Error("Failed pattern match at IdePurescript.Atom.Psci line 272, column 30 - line 276, column 91: " + [ v3.constructor.name, v4.constructor.name ]);
                              })()))(function (v4) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function ($163) {
                                      return Control_Monad_Eff_Ref.writeRef(psciRef)(Data_Maybe.Just.create($163));
                                  })(v4)))(function () {
                                      return liftEff$prime$prime(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))(function (proc) {
                                          return Control_Monad_Eff_Exception.catchException(function (e) {
                                              ...
                                              Node_ChildProcess.onError(proc)(function ($164) {
                                                  return notifyErr(Data_Show.show(Control_Monad_Eff_Exception.showError)(Node_ChildProcess.toStandardError($164)));
                                              })();
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var startPscIdeServer$prime = function (path) {
          var retry = function (a) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(a))(function (v6) {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 216, column 11 - line 221, column 16: " + [ v6.constructor.name ]);
              });
          };
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_AVar.takeVar(v6))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(PscIde_Project.getRoot(path)))(function (v7) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)((function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Applicative.when(Control_Monad_Aff.applicativeAff)(Data_Maybe.isJust(Data_StrMap.lookup(v7.value0)(v8)))(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Not starting server - already started: " + path))))(function () {
                                      return Control_Applicative.unless(Control_Monad_Aff.applicativeAff)(Data_Maybe.isJust(Data_StrMap.lookup(v7.value0)(v8)))(Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_PscIdeServer.startServer(v7.value0))(function (v9) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("Loading modules: " + path)))(function () {
                                              return retry(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Data_Maybe.maybe(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function (p) {
                                                  ...
                                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                                                      ...
                                                      throw new Error("Failed pattern match at IdePurescript.Atom.Main line 207, column 17 - line 209, column 95: " + [ v9.port.constructor.name ]);
                                                  });
                                              }));
                                          });
                                      }));
                          ...
                          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 193, column 7 - line 209, column 95: " + [ v7.constructor.name ]);
                      })())(function () {
      ...
      var startPscIdeServer = Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(getPathActiveEditor)(function (v6) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(Control_Monad_Eff_Console.log("Starting psc-ide-server for path: " + v6)))(function () {
      ...
      var doLint = function (file) {
          return function __do() {
              ...
              var v9 = (function () {
                  ...
                  throw new Error("Failed pattern match at IdePurescript.Atom.Main line 150, column 16 - line 152, column 74: " + [ v8.constructor.name ]);
              })()();
      ...
      var deactivate = function __do() {
          ...
          Data_Foldable.sequence_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(function (v7) {
              return v7.quit;
                  ...
                  return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Maybe_Trans.MaybeT(Atom_Editor.getPath(v6)))(function (v7) {
                      return Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))(getPort(v7)))(function (v8) {
                          return Control_Monad_Eff_Class.liftEff(Control_Monad_Maybe_Trans.monadEffMaybe(Control_Monad_Eff_Class.monadEffEff))((function () {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 275, column 19 - line 279, column 39: " + [ v8.constructor.name ]);
                          })());
                      });
                  });
              })));
