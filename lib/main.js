  ...
  var rebuild = function (port) {
      return function (file) {
          var wrapError = function (v) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Build line 72, column 3 - line 80, column 6: " + [ v.constructor.name ]);
          };
                  ...
                  return Node_ChildProcess.onClose(v1)(function (exit) {
                      if (exit instanceof Node_ChildProcess.Normally && (exit.value0 === 0 || exit.value0 === 1)) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Build line 57, column 7 - line 61, column 5: " + [ $17.constructor.name ]);
                          };
                      };
