  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 76, column 3 - line 84, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
  var getSuggestions = function (state) {
      return function (v) {
          ...
          return function __do() {
              ...
              return Control_Promise_1.fromAff(Prelude.flip(Control_Monad_Error_Class.catchError(Control_Monad_Aff.monadErrorAff))(raiseError$prime([  ]))(IdePurescript_Atom_Completion.getSuggestions({
                  line: v1, 
                  moduleInfo: {
                      modules: modules, 
  ...
  var main = function __do() {
      ...
      var addImport = function (moduleName) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 169, column 7 - line 177, column 5: " + [ v7.constructor.name ]);
          };
      };
