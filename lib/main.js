...
(function(exports) {
  ...
  var parseVersion = function (s) {
      var $24 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Data_Int.fromNumber)(Data_Functor.map(Data_Functor.functorArray)(Global.readInt(10))(Data_String.split(".")(s)));
      if ($24 instanceof Data_Maybe.Just && $24.value0.length === 3) {
          return Data_Maybe.Just.create(new Version($24["value0"][0], $24["value0"][1], $24["value0"][2]));
      };
      return Data_Maybe.Nothing.value;
  };
  var liftEff$prime$prime = Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff);
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(PscIde_Server.pickFreshPort))(function (v) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
                          ...
                          return Data_Functor.map(Control_Monad_Aff.functorAff)(r(v))(PscIde_Server.startServer((function () {
                              var $34 = {};
                              for (var $35 in PscIde_Server.defaultServerArgs) {
                                  if ({}.hasOwnProperty.call(PscIde_Server.defaultServerArgs, $35)) {
                                      $34[$35] = PscIde_Server["defaultServerArgs"][$35];
                                  };
                              };
                              $34.exe = exe;
                              $34.cwd = new Data_Maybe.Just(rootPath);
                              $34.port = new Data_Maybe.Just(v);
                              $34.source = glob;
                              return $34;
                          })()));
                      });
              ...
              var gotPath = function (port) {
                  return function (workingDir) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                          ...
                          throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 139, column 15 - line 146, column 43: " + [ $37.constructor.name ]);
                      })());
                  };
              };
                  ...
                  return function (cb) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(IdePurescript_Exec.getPathVar(addNpmBin)(path)))(function (v) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(IdePurescript_Exec.findBins(v)(server))(function (v1) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableArray)(function (v2) {
                                          ...
                                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Array.length(v1) > 1)(cb(Warning.value)("Found multiple psc-ide-server executables; using " + $60.value0.value0))))(function () {
                                              var glob$prime = (function () {
                                                  ...
                                                  throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 94, column 19 - line 94, column 104: " + [ $64.constructor.name ]);
                                              })();
                              ...
                              throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 84, column 3 - line 110, column 142: " + [ $60.constructor.name ]);
                          });
                      });
                  };
              };
