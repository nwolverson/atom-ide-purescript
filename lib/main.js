                              ...
                              return function (msg) {
                                  return function __do() {
                                      ...
                                      return Data_Function.apply((function () {
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 108, column 8 - line 108, column 43: " + [ $14.constructor.name ]);
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Functor.map(Control_Monad_Aff.functorAff)(IdePurescript_Atom_Build.toLintResult)(buildCmd))(function (v) {
                                      return Data_Function.apply(liftEffA)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(function __do() {
                                          ...
                                          status((function () {
                                              ...
                                              throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 93, column 21 - line 93, column 68: " + [ $18.constructor.name ]);
                              ...
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Atom_Config.getConfig(config)("ide-purescript.buildCommand")))(function (v1) {
                                  ...
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(liftEffA)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foreign.readBoolean)(Atom_Config.getConfig(config)("ide-purescript.fastRebuild"))))(function (v2) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit))(function () {
                                          var $36 = Data_Array.uncons(buildCommand);
                                          ...
                                          throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 76, column 3 - line 81, column 20: " + [ fastBuild.constructor.name, $36.constructor.name ]);
                                      });
                                  });
                              });
                          });
  ...
  var getRoot = function (path) {
      ...
      if (!$41) {
          return function __do() {
              ...
              var v1 = Node_FS_Sync.exists(bower)();
              var $44 = v || v1;
              if ($44) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 44, column 5 - line 44, column 68: " + [ $44.constructor.name ]);
          };
      };
      throw new Error("Failed pattern match at IdePurescript.Atom.LinterBuild line 39, column 3 - line 44, column 68: " + [ $41.constructor.name ]);
  };
  var getProjectRoot = function (v) {
      return function __do() {
          var v1 = Atom_Atom.getAtom();
          var v2 = Atom_Project.getPaths(v1.project)();
          var v3 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Array.catMaybes)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(getRoot)(v2))();
          ...
          var gotPath = function (port) {
              return function (workingDir) {
                  return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                      ...
                      throw new Error("Failed pattern match at IdePurescript.PscIdeServer line 57, column 5 - line 64, column 43: " + [ $13.constructor.name ]);
                  })());
              };
          };
