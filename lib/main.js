  ...
  var useEditor = function (modulesStateRef) {
      return function (editor) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 85, column 3 - line 92, column 1: " + [ mainModule.constructor.name ]);
          };
      };
  };
              ...
              return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Editor.getTextInRange(v.editor)(range)))(function (v1) {
                  return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Atom.getAtom))(function (v2) {
                      return Prelude.bind(Control_Monad_Aff.bindAff)(liftEff$prime$prime(Atom_Config.getConfig(v2.config)("ide-purescript.autocomplete.allModules")))(function (v3) {
                          ...
                          return Prelude.bind(Control_Monad_Aff.bindAff)((function () {
                              var $96 = v.activatedManually || autoCompleteAllModules;
                              if ($96) {
                              ...
                              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 68, column 14 - line 69, column 3: " + [ $96.constructor.name ]);
                          })())(function (v4) {
  ...
  var main = function __do() {
      ...
      var quickFix = function __do() {
          ...
          if ($111.editor instanceof Data_Maybe.Just && ($111.linter instanceof Data_Maybe.Just && $111.n > 0)) {
              return IdePurescript_Atom_QuickFixes.showQuickFixes($111.editor.value0)($111.linter.value0)(v7)();
          };
          return Prelude.unit;
      };
      ...
      var doLint = function __do() {
          ...
          if ($142.root instanceof Data_Maybe.Just && ($142.linterIndie instanceof Data_Maybe.Just && $142.statusElt instanceof Data_Maybe.Just)) {
              return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Atom_LinterBuild.lint(v.config)($142.root.value0)($142.linterIndie.value0)($142.statusElt.value0))(function (v10) {
          ...
          return function __do() {
              ...
              if (v7 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Monad_Aff.runAff(raiseError)(ignoreError)(Prelude.bind(Control_Monad_Aff.bindAff)(IdePurescript_Modules.addModuleImport(v8)(v10)(v9)(moduleName))(function (v11) {
                      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Data_Maybe.maybe(Prelude.pure(Control_Monad_Eff.applicativeEff)(Prelude.unit))(function ($251) {
              ...
              throw new Error("Failed pattern match at IdePurescript.Atom.Main line 232, column 7 - line 241, column 5: " + [ v7.constructor.name ]);
          };
      };
      ...
      var addClause = function __do() {
          ...
          throw new Error("Failed pattern match at IdePurescript.Atom.Main line 280, column 7 - line 288, column 5: " + [ v7.constructor.name ]);
      };
